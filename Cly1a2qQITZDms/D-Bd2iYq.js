...
import { Q as getLunaBornText, X as getBaseText, R as getSexText, C as CHI, T as TKN, g as LTHG_HH, A as AREA_NAME, S as SMI, s as SM } from './BCZoTaEz.js';
...
const PageContentStatic = ({ ls }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto mb-10", children: [
      "Đồ hình Tử Vi cư ",
...
const pageContent = React.memo(PageContentStatic);
