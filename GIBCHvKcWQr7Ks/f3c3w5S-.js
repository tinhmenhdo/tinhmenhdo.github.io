...
import { f as VALID_INPUT_FORMATS, h as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, i as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './Du4CJw7g.js';
import { A as AstroError, C as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, D as renderUniqueStylesheet, G as renderScriptElement, H as createHeadAndContent, r as renderComponent } from './F_Fel0yb.js';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./DWMfoa93.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "BUILD_VERSION": "1772032219807", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tinhmenhdo.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./Cq406m8d.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./Cy5NzwmL.js');
