...
import BatQuaiMenhTungBo from './AU5mVKwQ.js';
import PageContentStatic from './c74iIprd.js';
/* empty css         */
...
const MapPicker = lazy(
  () => import('./Bk1OPqcX.js').then(n => n.a).then((module) => ({ default: module.MapPicker }))
);
...
function MainContentGps({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-2 mb-4 px-3 2xl:absolute 2xl:top-12 2xl:left-5 2xl:z-20 2xl:w-[320px] 2xl:bg-white 2xl:rounded-xl 2xl:shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "group relative mx-auto flex max-w-2xl flex-col items-center justify-center p-4 md:p-5 xl:max-w-7xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "gap-2", children: /* @__PURE__ */ jsx(
        "button",
        {
          ...
          className: "flex cursor-pointer items-center justify-center rounded-md border border-amber-500/50 bg-transparent px-6 py-1 text-xs font-bold text-amber-600 transition-all hover:border-amber-500 hover:bg-amber-50/50",
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 my-4 text-sm max-lg:m-0 max-lg:mb-5 max-lg:p-0", children: [
      ...
      hasLsData(lsObj) && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "w-full overflow-hidden px-2 sm:px-6 pt-10", children: [
        /* @__PURE__ */ jsx("div", { className: "relative z-10 mt-2 mb-4 text-sm max-lg:m-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-2 sm:gap-3 px-2 pb-6 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => setShowNewConfigPanel(true),
              className: "flex cursor-pointer w-[calc(50%-0.25rem)] sm:w-[136px] items-center justify-center gap-1.5 rounded-md border border-amber-200/80 bg-amber-50/50 py-2 text-[13px] sm:text-sm font-medium text-amber-900 shadow-sm hover:bg-amber-100/80 transition-colors",
              children: [
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              className: "flex cursor-pointer w-[calc(50%-0.25rem)] sm:w-[136px] items-center justify-center gap-1.5 rounded-md border border-stone-200 bg-white py-2 text-[13px] sm:text-sm font-medium text-stone-700 shadow-sm hover:bg-stone-50 transition-colors",
              children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: "flex cursor-pointer w-[calc(50%-0.25rem)] sm:w-[136px] items-center justify-center gap-1.5 rounded-md border border-stone-200 bg-white py-2 text-[13px] sm:text-sm font-medium text-stone-700 shadow-sm hover:bg-stone-50 transition-colors",
              children: isCopying ? "Đang copy..." : "Copy"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
          ...
          /* @__PURE__ */ jsx(
            "a",
            {
              href: "/hoc-tu-vi",
              target: "_blank",
              className: "flex cursor-pointer w-[calc(50%-0.25rem)] sm:w-[136px] items-center justify-center gap-1.5 rounded-md border border-stone-200 bg-white py-2 text-[13px] sm:text-sm font-medium text-stone-700 shadow-sm hover:bg-stone-50 transition-colors no-underline",
              children: "Học tử vi"
            }
          )
        ] }) }),
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full px-2 sm:px-6 mb-10 mt-8", children: /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden border-4 rounded-xl border-double border-amber-900/20 bg-[#FCFBF8] p-4 sm:p-6 lg:p-8 w-full", style: { minHeight: "300px" }, children: [
        /* @__PURE__ */ jsx("h2", { className: "mb-6 border-b-2 border-dotted border-amber-900/20 pb-4 text-center text-2xl md:text-3xl font-bold font-serif text-amber-900 flex items-center justify-center gap-3", children: "Chế Độ AI Tư Vấn" }),
        /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
          /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl mb-8 text-sm md:text-[15px] italic text-stone-700 leading-relaxed font-serif text-justify md:text-center", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mb-8 flex w-full justify-center", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: tmdAppThumb.src,
              className: "h-auto w-[70%] sm:w-[50%] md:w-[40%] rounded-xl border-2 border-amber-900/20 shadow-[0_0px_0px_rgb(0,0,0,0.12)] transition-all hover:shadow-[0_8px_25px_rgba(180,83,9,0.3)]",
              alt: "App Tinh Mệnh Đồ trên Gemini",
              loading: "lazy"
            }
          ) }),
          /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl mb-8 text-sm md:text-[15px] font-serif text-stone-800 leading-relaxed", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white/50 p-4 border border-amber-900/10", children: [
              /* @__PURE__ */ jsx("p", { className: "mb-2", children: "Mặc định khi copy vào dán dữ liệu dưới vào AI sẽ chỉ phân tích tổng quát" }),
              /* @__PURE__ */ jsx("p", { className: "font-bold text-amber-900 mb-2", children: "Gợi ý cách đặt câu hỏi cho AI:" }),
              /* @__PURE__ */ jsxs("ul", { className: "list-inside list-disc space-y-1.5 text-stone-700 italic pl-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mb-8 w-full rounded-lg shadow-sm overflow-x-auto", children: lsObj && /* @__PURE__ */ jsx(CSVTable, { ls: lsObj }) }),
          /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-5xl flex flex-col items-center justify-center pt-4 border-t border-dashed border-amber-900/20", children: [
            ...
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                className: "fire-btn group flex w-full sm:w-auto items-center justify-center gap-2 rounded-md px-8 py-3.5 font-bold font-serif text-white transition-all hover:scale-105 shadow-md shadow-orange-900/20 text-sm sm:text-base text-center",
      ...
      descSeo && /* @__PURE__ */ jsx("h2", { className: "px-4 mt-8 mb-4 text-center text-lg italic text-amber-900/80 font-serif", children: descSeo }),
      /* @__PURE__ */ jsx("div", { className: "mb-30 pt-20 px-2 sm:px-4 xl:px-8 w-full", children: /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden border-4 border-double p-6 lg:p-10", children: [
        /* @__PURE__ */ jsx("h2", { className: "mb-8 border-b-2 border-dotted border-amber-900/20 pb-4 text-center text-2xl md:text-3xl font-bold text-amber-900 font-serif flex items-center justify-center gap-3", children: "Hướng Dẫn Luận Giải" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-8 text-stone-800 leading-relaxed text-sm sm:text-[15px] font-serif max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h3", { className: "mb-3 font-bold text-amber-900 text-lg md:text-xl flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-red-700 border border-red-700/30 rounded-full w-8 h-8 flex items-center justify-center text-sm", children: "1" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h3", { className: "mb-3 font-bold text-amber-900 text-lg md:text-xl flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-red-700 border border-red-700/30 rounded-full w-8 h-8 flex items-center justify-center text-sm", children: "2" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h3", { className: "mb-3 font-bold text-amber-900 text-lg md:text-xl flex items-center gap-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-red-700 border border-red-700/30 rounded-full w-8 h-8 flex items-center justify-center text-sm", children: "3" }),
            ...
            /* @__PURE__ */ jsxs("p", { className: "pl-10", children: [
              ...
              " ",
              /* @__PURE__ */ jsx("a", { href: "/la-so-tu-vi/la-so-tu-vi-viet-nam", className: "font-semibold text-red-700 hover:text-red-800 underline decoration-red-700/30 underline-offset-4 transition-colors", children: "lá số Tử Vi Việt Nam" }),
              " ",
...
function SettingsPanel({
  ...
  const getConfigsBySection = () => {
    switch (activeSection) {
      case "dateTime":
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 max-lg:pb-20", children: [
      ...
      case "display":
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      ref: panelRef,
      className: "config-panel fixed top-0 right-0 z-20 h-full 2xl:w-100 max-w-full overflow-hidden border-l border-gray-200 bg-white shadow-lg",
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-50 flex items-center justify-between border-b border-gray-200 bg-linear-to-b from-gray-50 to-white px-3 py-1", children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                onClick: onHidePanel,
                className: "touch-manipulation rounded-full p-2 transition-colors select-none hover:bg-gray-100",
          ...
          /* @__PURE__ */ jsx("div", { className: "sticky top-10 z-10 flex overflow-x-auto border-b border-gray-200 bg-white", children: sections.map((section) => /* @__PURE__ */ jsxs(
            "button",
            {
              className: `group relative flex min-h-[56px] min-w-[80px] flex-1 flex-col items-center justify-center overflow-hidden px-4 py-3 text-xs font-medium transition-all duration-300 ease-out ${activeSection === section.id ? "text-orange-500" : "text-gray-500 hover:text-gray-700"} touch-manipulation select-none`,
              onClick: () => setActiveSection(section.id),
              children: [
                /* @__PURE__ */ jsx("span", { className: "mb-1 transform text-[22px] transition-transform duration-300 ease-out will-change-transform group-hover:scale-110", children: section.icon }),
