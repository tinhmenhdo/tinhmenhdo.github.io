...
import { L as LocalLunarCalendar, T as TrueSolarBaziEngine } from './BODF8xcG.js';
import { C as CitySearch } from './DiprJFgG.js';
import { M as MapPicker } from './Bk1OPqcX.js';
...
const STAR_SCORES = {
  ...
  [THAN_SAT_ENUM.ThienCuong]: {
    base: -25,
    type: "bad",
    actions: { CONSTRUCTION: -40, WEDDING: -20 },
    advice: { avoid: ["DONG_THO", "CUOI_HOI"] }
  },
  ...
  [THAN_SAT_ENUM.NguyetDuc]: {
    ...
    type: "good",
    actions: { ALL: 15 },
    advice: { do: ["XUAT_HANH", "KY_KET", "TRI_BENH"] }
  },
  [THAN_SAT_ENUM.ThienXa]: {
    base: 20,
    type: "good",
    actions: { ALL: 20 },
    advice: { do: ["TO_TUNG", "KHAI_TRUONG", "DONG_THO"] }
  },
  ...
  [THAN_SAT_ENUM.ThienDucHop]: {
    base: 5,
    type: "good",
    actions: { DAU_TU: 15, TE_LE: 15 },
    advice: { do: ["DAU_TU", "TE_LE"] }
  },
  ...
  [THAN_SAT_ENUM.ThienPhu]: {
    base: 8,
    type: "good",
    actions: { BUSINESS: 15, CONSTRUCTION: 10 },
  ...
  [THAN_SAT_ENUM.KimQuy]: {
    base: 15,
    type: "good",
    actions: { WEDDING: 20, BUSINESS: 20 },
    advice: { do: ["CUOI_HOI", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.ThienDuc]: { base: 20, type: "good", actions: { ALL: 15 }, advice: { do: ["TO_TUNG", "TE_LE"] } },
  [THAN_SAT_ENUM.NgocDuong]: {
    base: 15,
    type: "good",
    actions: { EDUCATION: 20 },
    advice: { do: ["NHAP_HOC", "TO_TUNG"] }
  },
  [THAN_SAT_ENUM.TuMenh]: { base: 15, type: "good", actions: { BUSINESS: 20 }, advice: { do: ["KHAI_TRUONG"] } },
  // 2. Hắc Đạo (Xấu)
  ...
  [THAN_SAT_ENUM.ThoOn]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -50, SPIRITUAL: -40 },
    advice: { avoid: ["DONG_THO", "NHAP_TRACH", "TE_LE"] }
  },
  ...
  [THAN_SAT_ENUM.ThienQuy]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 20, EDUCATION: 20 },
    advice: { do: ["KHAI_TRUONG", "NHAP_HOC"] }
  },
  [THAN_SAT_ENUM.ThienThanh]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 15 },
    advice: { do: ["KHAI_TRUONG", "KY_KET"] }
  },
  [THAN_SAT_ENUM.TieuHongSa]: {
    base: -10,
    type: "bad",
    actions: { XUAT_HANH: -25, BUSINESS: -20 },
    advice: { avoid: ["XUAT_HANH", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.DaiHao]: {
    base: -15,
    type: "bad",
    actions: { BUSINESS: -40, RISKY_BUSINESS: -40 },
    advice: { avoid: ["DAU_TU", "KHAI_TRUONG"] }
  },
  // TÂM LINH (SPIRITUAL)
  ...
  [THAN_SAT_ENUM.ThienMa]: {
    base: 10,
    type: "good",
    actions: { DAILY: 20, BUSINESS: 15 },
    advice: { do: ["XUAT_HANH", "KHAI_TRUONG"] }
  },
  ...
  [THAN_SAT_ENUM.ThienAn]: { base: 10, type: "good", actions: { SPIRITUAL: 20 }, advice: { do: ["TE_LE"] } },
  ...
  [THAN_SAT_ENUM.DaiHongSa]: { base: 15, type: "good", actions: { ALL: 15 } },
  ...
  [THAN_SAT_ENUM.ThienCau]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -20, WEDDING: -20 },
    advice: { avoid: ["NHAP_TRACH", "CUOI_HOI"] }
  },
  ...
  [THAN_SAT_ENUM.HuyetChi]: { base: -15, type: "bad", actions: { TREATMENT: -40 }, advice: { avoid: ["TRI_BENH"] } },
  ...
  [THAN_SAT_ENUM.NguHu]: { base: -10, type: "bad", actions: { CONSTRUCTION: -20 }, advice: { avoid: ["DONG_THO"] } },
...
const TRUC_SCORES = {
  ...
  [TRUC_ENUM.Kien]: {
    ...
    advice: { do: ["XUAT_HANH", "KHAI_TRUONG"], avoid: ["DONG_THO", "AN_TANG"] }
  },
  [TRUC_ENUM.Chap]: {
    base: -5,
    type: "bad",
  ...
  [TRUC_ENUM.Thu]: {
    ...
    advice: { do: ["THU_NO", "TE_LE", "AN_TANG"], avoid: ["DAU_TU", "KHAI_TRUONG"] }
  },
  [TRUC_ENUM.Tru]: {
    base: 5,
    type: "good",
...
const TU_SCORES = {
  [NHI_THAP_BAT_TU_ENUM.Giac]: {
    base: 10,
    type: "good",
    actions: { EDUCATION: 20, BUSINESS: 15, AN_TANG: -10 },
    advice: { do: ["NHAP_HOC", "KHAI_TRUONG"], avoid: ["AN_TANG"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.De]: {
    ...
    remedies: [{ star: THAN_SAT_ENUM.ThienDuc, factor: 1 }],
    advice: { avoid: ["DONG_THO", "XUAT_HANH", "CUOI_HOI"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.Co]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 15, EDUCATION: 15 },
    advice: { do: ["NHAP_HOC", "KHAI_TRUONG"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Dau]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 15 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.Lau]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 15, WEDDING: 15 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Vi_D]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 20, AN_TANG: 20 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO", "AN_TANG"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.Sam]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 15, EDUCATION: 15, XUAT_HANH: 15 },
    advice: { do: ["NHAP_HOC", "KHAI_TRUONG", "XUAT_HANH"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.Truong]: {
    base: 15,
    type: "good",
    actions: { WEDDING: 20, BUSINESS: 15, DAU_TU: 15 },
    advice: { do: ["KHAI_TRUONG", "CUOI_HOI", "DAU_TU"] }
  },
  ...
  static getRecommendations(dayAttrs, dayScoreResult) {
    ...
    ACTIONS_CONFIG.forEach((action) => {
      ...
      if (shouldInclude) {
        ...
        impacts.filter(
          (i) => i.contextScore < 0 && (i.isCritical || i.hasSpecificAdvice || i.isSpecific || i.contextScore <= -20)
        ).map((i) => i.factorName);
        ...
        const badFactors = Array.from(
          new Set(
            impacts.filter((i) => i.contextScore < 0).sort((a, b) => Math.abs(b.contextScore) - Math.abs(a.contextScore)).map((i) => {
...
const MonthlyScoreCalendar = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-8 overflow-hidden rounded-2xl border border-stone-200 bg-white font-serif shadow-sm", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "hidden grid-cols-7 border-b border-stone-100 bg-stone-50 md:grid", children: ["Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7", "Chủ Nhật"].map((d) => /* @__PURE__ */ jsx(
      "div",
      {
        className: "py-3 text-center font-sans text-[10px] font-bold tracking-wider text-stone-500 uppercase",
        children: d
      },
      d
    )) }),
      ...
      days.map((day) => {
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            style: cellStyle,
            className: `group relative flex min-h-[90px] cursor-pointer flex-col justify-between p-2 transition-all hover:brightness-95 md:min-h-[110px] md:p-3`,
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex w-full items-start justify-between", children: [
                ...
                /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `text-xs font-bold md:hidden ${dateObj.day() === 0 ? "text-[#b91c1c]" : "text-stone-400"}`,
                    children: dowStr
                  }
                )
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "my-1 flex w-full flex-1 flex-col items-center justify-center gap-1 px-0.5", children: [
                holiday && /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `w-full text-center text-[8px] font-bold break-words md:text-[9px] ${holiday.important ? "text-[#b91c1c]" : "text-stone-500"}`,
