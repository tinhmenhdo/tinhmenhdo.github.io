...
dayjs.locale("vi");
const BatQuaiMenhTungBoLazy = lazy(() => import('./CBVw5dJn.js'));
const NewConfigPanelLazy = lazy(() => import('./Cm9a06SM.js'));
const PageContentStaticLazy = lazy(() => import('./aHe5CjSg.js'));
