...
import { I as ICHING, a as ICHING_NUMBER } from './Dn_1HrqL.js';
...
function createSmoothAnimation(groups, targetAngle, bienTargetAngle, duration = 6e3, onComplete) {
  ...
  const animate = (timestamp) => {
    ...
    if (elapsedOuter > 0) {
      ...
      if (tOuter < 0.4) {
        targetOuterSpeed = -3600;
      } else {
        targetOuterSpeed = -3600 * easeOutQuart$1(1 - (tOuter - 0.4) / 0.6);
      }
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("div", { className: "min-h-[200px] md:min-h-[400px]", children: showResult && result ? /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "mb-2 text-4xl md:mb-4 md:text-7xl", children: result.queIcon }),
...
const IChingDiagram = ({ prefixContent, theme = "default" }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen flex-col items-center", children: /* @__PURE__ */ jsxs("div", { className: "flex min-h-[calc(100vh-4rem)] w-full max-w-[1200px] flex-col items-center justify-start p-4 max-md:p-0 md:p-8", children: [
