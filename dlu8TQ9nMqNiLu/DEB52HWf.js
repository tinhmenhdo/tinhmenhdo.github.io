...
import { t as tkHND } from './FfiMWBnv.js';
import { T as TKN } from './BCZoTaEz.js';
...
const NgayGioSocCP = ({ dt }) => {
  ...
  const generateYearLinks = (yearCheck2) => {
    ...
    return years.map((year, index) => /* @__PURE__ */ jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          className: `mx-1 inline-block ${year === yearCheck2 ? "bg-orange-100 font-medium text-black" : "text-black dark:text-white"} rounded border border-gray-200 px-2 py-1 text-sm hover:text-[#c0635c] dark:border-gray-700`,
  ...
  const generateLongRangeYearLinks = (yearCheck2) => {
    ...
    return validYearJumps.map((jump, index) => /* @__PURE__ */ jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
          className: `mx-1 inline-block ${jump.year === yearCheck2 ? "bg-orange-100 font-medium text-black" : "text-black dark:text-white"} rounded border border-gray-200 px-2 py-1 text-sm hover:text-[#c0635c] dark:border-gray-700`,
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 my-8 mt-4 mb-10 px-4 text-sm", children: [
      ...
      hasThirteenMoons && /* @__PURE__ */ jsxs("div", { className: "mb-6 rounded-lg bg-amber-100 p-4 text-amber-800 dark:bg-amber-800/30 dark:text-amber-200", children: [
        /* @__PURE__ */ jsxs("h3", { className: "font-bold text-amber-900 dark:text-amber-100", children: [
          "Lưu ý: Năm",
          yearCheck,
          " có 13 lần trăng mới"
        ] }),
      ...
      lunarNewYear && /* @__PURE__ */ jsxs("div", { className: "mb-6 rounded-lg bg-emerald-100 p-3 text-emerald-800 dark:bg-emerald-800/20 dark:text-emerald-200", children: [
      ...
      tkHND[yearCheck] !== null && /* @__PURE__ */ jsx("div", { className: "-mx-4 overflow-x-auto px-4", children: /* @__PURE__ */ jsxs("table", { className: "mx-auto w-full table-auto", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { children: sc?.map((timeUnix, monthIdx) => {
          ...
          let rowClass = "odd:bg-white dark:odd:bg-gray-800 even:bg-gray-50 dark:even:bg-gray-800 hover:bg-orange-200 dark:hover:bg-orange-200";
          if (isLunarNewYear) rowClass += " bg-amber-50 dark:bg-amber-900/30";
          else if (isDongChi) rowClass += " bg-blue-50 dark:bg-blue-900/30";
          else if (isDaiHan) rowClass += " bg-purple-50 dark:bg-purple-900/30";
          else if (firstAfterDongChi && !isLunarNewYear) rowClass += " bg-indigo-50 dark:bg-indigo-900/30";
          return /* @__PURE__ */ jsxs("tr", { className: rowClass, children: [
            /* @__PURE__ */ jsx("td", { className: "min-w-[100px] border px-4 py-2 dark:border-gray-700", children: /* @__PURE__ */ jsxs("span", { className: "font-medium", children: [
              "Giờ Sóc lần ",
              monthIdx + 1
            ] }) }),
            /* @__PURE__ */ jsxs("td", { className: "min-w-[160px] border px-4 py-2 whitespace-nowrap dark:border-gray-700", children: [
              /* @__PURE__ */ jsx("time", { dateTime: djTime.format("YYYY-MM-DD HH:mm"), children: djTime.format("HH:mm - DD/MM/YYYY") }),
              /* @__PURE__ */ jsx("div", { className: "text-sm italic", children: isLunarNewYear ? /* @__PURE__ */ jsx("span", { className: "text-green-700 dark:text-amber-300", children: "Tháng 1 âm lịch" }) : isBeforeCurrDaiHan ? /* @__PURE__ */ jsx("span", { className: "text-red-700 dark:text-purple-300", children: "Giờ Sóc trước trung khí Đại Hàn" }) : /* @__PURE__ */ jsx(Fragment, {}) })
            ] }),
            /* @__PURE__ */ jsx("td", { className: "min-w-[100px] border px-4 py-2 dark:border-gray-700", children: /* @__PURE__ */ jsx(
              "b",
              {
                className: `${isLunarNewYear ? "text-amber-700 dark:text-amber-300" : "text-[#555] dark:text-white"}`,
            ...
            /* @__PURE__ */ jsx("td", { className: "min-w-[180px] border px-4 py-2 dark:border-gray-700", children: tietKhiInMonth.length > 0 ? /* @__PURE__ */ jsx("div", { className: "flex flex-col space-y-2", children: tietKhiInMonth.map((tietKhi, idx) => /* @__PURE__ */ jsxs(
              "div",
              {
                className: "text-blue-800 last:border-t last:border-dashed last:pt-[5px] dark:text-blue-300",
                children: [
                  /* @__PURE__ */ jsx("span", { className: "inline-block w-[100px] font-medium", children: TKN[tietKhi.index] }),
                  /* @__PURE__ */ jsx("span", { className: "ml-1 text-sm whitespace-nowrap text-gray-600 dark:text-gray-300", children: dayjs.unix(tietKhi.time).format("HH:mm - DD/MM/YYYY") })
                ]
              },
              `tk-${monthIdx}-${idx}`
            )) }) : /* @__PURE__ */ jsx("span", { className: "text-gray-400 dark:text-gray-500", children: "-" }) })
          ] }, `sc${monthIdx}`);
        }) })
      ] }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 pb-2", children: [
        /* @__PURE__ */ jsx(
          "a",
          {
            className: "text-orange mx-1 inline-block rounded border border-gray-200 bg-green-100 px-2 py-1 text-sm hover:text-[#c0635c] dark:border-gray-700 dark:text-white",
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-5 mb-4 rounded-lg bg-gray-100 p-4 text-gray-800 dark:bg-gray-800/30 dark:text-gray-200", children: [
