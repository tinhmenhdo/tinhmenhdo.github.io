...
</div> </div> </div> </header> <aside id="mobile-sidebar"${addAttribute(cn("fixed inset-y-0 left-0 w-64 bg-[var(--sidebar-bg)] z-50 transform transition-transform ease-in-out -translate-x-full","flex flex-col"),"class")}> <div class="flex items-center justify-between h-16 px-4"> <div class="flex items-center"> <img${addAttribute(logo.src,"src")} alt="Tinh Mệnh Đồ Logo" class="h-8"> <div class="font-normal leading-none opacity-55 text-[#ffffff] text-xs font-weight-[400] ml-2">
