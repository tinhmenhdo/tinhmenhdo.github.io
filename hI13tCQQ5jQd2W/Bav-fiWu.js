        ...
        /* @__PURE__ */ jsxs("tbody", { children: [
          tk.map((timeUnix, hndId) => {
            ...
            return /* @__PURE__ */ jsxs(
              "tr",
              {
                className: "odd:bg-white even:bg-gray-50 hover:bg-orange-200 dark:odd:bg-gray-800 dark:even:bg-gray-800 dark:hover:bg-orange-200",
                children: [
                  /* @__PURE__ */ jsx("td", { className: "border px-4 py-2 dark:border-gray-700", children: /* @__PURE__ */ jsx("b", { className: "text-[#555] dark:text-white", children: TKN[hndId] }) }),
                  /* @__PURE__ */ jsx("td", { className: "border px-4 py-2 dark:border-gray-700", children: /* @__PURE__ */ jsx("time", { dateTime: djTime.format("YYYY-MM-DD HH:mm"), children: djTime.format("HH:mm - DD/MM/YYYY") }) })
                ]
              },
              `hnd2${hndId}`
            );
          }),
          yearCheck <= 1581 && /* @__PURE__ */ jsxs("tr", { className: "odd:bg-white even:bg-gray-50 hover:bg-orange-200 dark:odd:bg-gray-800 dark:even:bg-gray-800 dark:hover:bg-orange-200", children: [
            /* @__PURE__ */ jsx("td", { className: "border px-4 py-2 dark:border-gray-700", children: /* @__PURE__ */ jsx("b", { className: "text-[#555] dark:text-white", children: TKN[0] }) }),
            /* @__PURE__ */ jsx("td", { className: "border px-4 py-2 dark:border-gray-700", children: /* @__PURE__ */ jsx("time", { dateTime: dayjs.unix(tk[0]).format("YYYY-MM-DD HH:mm"), children: dayjs.unix(tk[0]).format("dddd HH:mm - DD/MM/YYYY") }) })
          ] })
        ] })
      ] }),
