...
import { f as AstroUserError, A as AstroError } from './sfYYkhPc/DEWHgkAV.js';
import { A as AstroJSX, l as renderJSX, n as createVNode } from './sfYYkhPc/4CUkstck.js';
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
	...
	if (children && opts.experimentalReactChildren) {
		...
		const convert = await import('./sfYYkhPc/BkR_XoPb.js').then((mod) => mod.default);
