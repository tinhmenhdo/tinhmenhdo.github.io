...
import { g as getDefaultInfo, a as getHoroDataServerFromApi, c as configDefault, b as getSexText, d as getLunaBornText, e as getBaseText, L as LsTypeSlug, C as CfgValue, V as VERSION_HORO } from '../../sfYYkhPc/xLi9c1wg.js';
...
function getStaticPaths() {
  return [{ params: { slug: "la-so-tu-vi-viet-nam" } }, ...LsTypeSlug.map((slug) => ({ params: { slug } }))];
}
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let defaultType = 0;
  if (slug === "la-so-tu-vi-viet-nam") {
    defaultType = 0;
  } else if (slug) {
    const slugIndex = LsTypeSlug.indexOf(slug);
    if (slugIndex !== -1) {
      defaultType = slugIndex;
    }
  }
  ...
  const metadata = {
    ...
    canonical: slug ? `/tuvi/${slug}` : "/tuvi",
    openGraph: {
      title: titleOg,
      description: destOG,
      url: slug ? `/tuvi/${slug}` : "/tuvi"
    }
  };
...
}, "/root/code/tmd_astro/src/pages/tu-vi/[...slug].astro", void 0);

const $$file = "/root/code/tmd_astro/src/pages/tu-vi/[...slug].astro";
const $$url = "/tu-vi/[...slug]";
