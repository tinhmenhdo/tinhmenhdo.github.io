...
import { C as CitySearch } from './CGfRn2eR.js';
import { M as MapPicker } from './Dx4Z7B4D.js';
...
const STAR_SCORES = {
  ...
  [THAN_SAT_ENUM.NguyetDuc]: { base: 20, type: "good", actions: { ALL: 15 }, advice: { do: ["XUAT_HANH", "KY_KET", "TRI_BENH"] } },
...
const TRUC_SCORES = {
  ...
  [TRUC_ENUM.Thu]: {
    ...
    actions: { BUSINESS: -20, CONSTRUCTION: -25, WEDDING: -25, THU_NO: 20, AN_TANG: -50, KHAI_TRUONG: -20, DAU_TU: -20, TE_LE: 15 },
  ...
  static getRecommendations(dayAttrs, dayScoreResult) {
    ...
    ACTIONS_CONFIG.forEach((action) => {
      ...
      if (shouldInclude) {
        ...
        impacts.filter((i) => i.contextScore < 0 && (i.isCritical || i.hasSpecificAdvice || i.isSpecific || i.contextScore <= -20)).map((i) => i.factorName);
...
const RecommendationCard = ({ rec, type }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `group relative flex flex-col gap-3 p-4 rounded-lg border border-transparent ${borderColor} transition-colors hover:bg-gray-50/50`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-baseline justify-between border-b border-[#e7e5e4] pb-2 mb-1 border-dashed", children: [
      /* @__PURE__ */ jsx("h3", { className: `text-xl font-serif font-bold ${mainColor}`, children: rec.label }),
      /* @__PURE__ */ jsxs("span", { className: `text-xs font-serif uppercase tracking-widest font-bold opacity-70 ${mainColor}`, children: [
        rec.score,
        "%"
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-sm leading-relaxed space-y-2", children: [
      rec.goodReason && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "font-bold text-[#15803d] min-w-[70px] shrink-0", children: "Cát Thần:" }),
      ...
      rec.badReason && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "font-bold text-[#b91c1c] min-w-[70px] shrink-0", children: "Hung Thần:" }),
        /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: rec.badReason })
      ] })
    ] }),
    rec.remedies && rec.remedies.length > 0 && /* @__PURE__ */ jsxs("div", { className: "text-sm mt-1 font-sans italic bg-green-50/80 p-2 rounded border border-green-100/50 text-green-800", children: [
      /* @__PURE__ */ jsx("span", { className: "font-bold mr-1 not-italic", children: "Hóa giải:" }),
      rec.remedies.map((r) => r.remedy).join(". ")
    ] }),
    isGood && rec.bestHours && rec.bestHours.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-1 text-sm font-serif text-gray-600 bg-amber-50/50 p-2 rounded border border-amber-100/50", children: [
  ...
  return /* @__PURE__ */ jsx("div", { className: "mt-8 flex justify-center px-4 bg-white py-10 shadow-lg rounded-xl border border-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-12", children: [
      goodRecs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsx("h4", { className: "font-serif text-lg font-bold text-[#15803d] uppercase tracking-widest border-b border-green-100 pb-2 flex items-center gap-2", children: "Việc Nên Làm" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10", children: goodRecs.slice(0, 8).map((rec) => /* @__PURE__ */ jsx(RecommendationCard, { rec, type: "good" }, rec.id)) })
      ] }),
      badRecs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsx("h4", { className: "font-serif text-lg font-bold text-[#b91c1c] uppercase tracking-widest border-b border-red-100 pb-2 flex items-center gap-2", children: "Việc Cần Tránh" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10", children: badRecs.slice(0, 6).map((rec) => /* @__PURE__ */ jsx(RecommendationCard, { rec, type: "bad" }, rec.id)) })
      ] })
    ] })
  ] }) });
};
...
const LocationPanel = ({
  ...
  return /* @__PURE__ */ jsx("aside", { className: "fixed inset-y-0 left-0 z-50 w-full transform border-r border-gray-200 bg-white shadow-xl transition-transform ease-in-out md:w-[400px] dark:bg-slate-800", children: /* @__PURE__ */ jsxs("div", { className: "max-h-screen overflow-y-auto p-4 sm:p-6", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative mb-4 z-[10]", children: /* @__PURE__ */ jsx(
      MapPicker,
      {
        mapCenter,
        zoom,
...
function NgayTotXauApp({ initialDateStr, baseUrlPattern, showHeader = false } = {}) {
  ...
  return /* @__PURE__ */ jsxs(MantineProvider, { children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto min-h-screen w-full", children: [
      showHeader && /* @__PURE__ */ jsxs("div", { className: "mb-10 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600", children: "Tra cứu ngày giờ tốt xấu, giờ hoàng đạo, nhị thập bát tú, trực, và các sao tốt xấu theo thuật toán chính xác, có tính đến địa điểm và tiết khí thực." }),
        /* @__PURE__ */ jsxs("p", { className: "text-lg text-gray-600", children: [
          ...
          /* @__PURE__ */ jsx(
            "strong",
            {
              className: "text-md text-amber-800/80 italic",
              children: "Ngày tốt nhất là ngày bạn có sự chuẩn bị tốt nhất. Tuy nhiên, nếu biết kết hợp giữa nỗ lực cá nhân và nhịp điệu tự nhiên, bạn sẽ có thêm một luồng gió hỗ trợ."
            }
          )
        ] })
      ] }),
