...
import { z } from 'zod';
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './DTYIW6kp.js';
import { f as VALID_INPUT_FORMATS, h as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, i as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './CS4DDvGF.js';
import { A as AstroError, D as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, G as renderUniqueStylesheet, H as renderScriptElement, J as createHeadAndContent, r as renderComponent } from './3oDUBBJB.js';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./0PdruXMe.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "BUILD_VERSION": "1770984973676", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tinhmenhdo.github.io", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./DleWbedO.js');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./C_qj9URY.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./Kj9XX9H4.js');
