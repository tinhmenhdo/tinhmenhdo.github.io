...
import React, { lazy, Suspense, useEffect, useRef, useState, useMemo, memo, useCallback } from 'react';
import { c as configDefault, a as HoroscopeBuildGps, b as HoroHelp, n as numbStringToArr, C as CfgValue, H as HOROSCOPE_CONFIG, A as APP_ROUTES, v as validateAllConfig, u as updateConfig, Z as ZolkName, d as AREA_NAME, e as CHI_3HH, L as LTHG_HH, f as CAN, g as CHI, h as CHI_HH, T as THAP, i as HH_THAP, j as CAN_HH, k as CAN_AD, S as SM, l as containsNumber, m as STARSTRONG, o as STAR_SIGN, p as CR_TS, F as FAILURE6, q as STARLOOP1, r as HH, s as ADTN, t as SKB, w as TKN, x as TKN_MONTH, y as TKN_PN, z as idxTHAP, B as TSNAME, D as LTHG_NA, G as GETHOA, E as withReactContent, I as Swal, J as HoroscopeHtmlClient, K as getLunaBornText, M as TrungChauWarning, N as IconSettings, O as tmdAppThumb, P as CSVTable, Q as ExplainLS, R as arrH1, U as getSexText, V as IconSchedule, W as IconAutoStories, X as IconVisibility, Y as typeLsName, _ as typeBanTCP, a0 as PHIHOA_COLOR, a1 as levelPhiHoaMsg, a2 as changeCanTypeMsg, a3 as yearLoopStarMsg, a4 as hideStarMsg, a5 as PHIHOA_SYMBOL1, a6 as AppUI } from './B_8m_d-e.js';
import { S as SolarCalculator } from './BODF8xcG.js';
import debounce from 'lodash/debounce.js';
import { map, atom } from 'nanostores';
import { i as initFuse, f as findNearestCity, C as CitySearch } from './DxH6TUwF.js';
...
import { n as CfgValue$1 } from './Dc1Oa40J.js';
import { G as GEMINI_AI_LINKS } from './C-2XUs_Y.js';
import BatQuaiMenhTungBo from './ByRiIpM2.js';
import PageContentStatic from './CBdRAqWl.js';
/* empty css         */
...
function getDefaultInfoGps() {
  return {
    dtBornUTC: dayjs().utc(false),
    sex: 1,
    strBorn: dayjs().utc(false).format("YYYY-MM-DD HH:mm:ss"),
    tkccBorn: "giap-thin-tan-mui-mau-ty-nham-tuat",
    dtViewUTC: dayjs().utc(false),
    strView: dayjs().utc(false).format("YYYY-MM-DD HH:mm:ss"),
    cfg: [...configDefault],
    key: "err",
    keyUrl: "err",
    lat: 21.0285,
...
function buildUrlForGpsMinimal(vBornUTC, vViewUTC, sex, cfg, lat, lon) {
  const dtBornUTC = vBornUTC ?? dayjs().utc(false);
  const dtViewUTC = vViewUTC ?? dayjs().utc(false);
...
const $horoscope = map({
  sex: 1,
  vBornUTC: dayjs().utc(false),
  vViewUTC: dayjs().utc(false),
  lon: 105.8333,
  lat: 21.0285,
  cfgLs: [1],
  first: false,
...
const MapPicker = lazy(
  () => import('./CHheibNO.js').then(n => n.a).then((module) => ({ default: module.MapPicker }))
);
...
const LoadingMessage = ({ message }) => /* @__PURE__ */ jsx(
  "div",
  {
    className: "flex h-full w-full items-center justify-center bg-slate-100/50 p-4 text-center",
...
function MainContentGps({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-2 mb-4 px-3 2xl:absolute 2xl:top-12 2xl:left-5 2xl:z-20 2xl:w-[320px] 2xl:bg-white 2xl:rounded-xl 2xl:shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "group relative mx-auto flex max-w-2xl flex-col items-center justify-center p-4 md:p-5 xl:max-w-7xl", children: [
      /* @__PURE__ */ jsxs("span", { className: "mb-2 flex items-center gap-1 text-xs font-bold tracking-widest text-amber-600 uppercase dark:text-amber-500", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mb-3 text-center text-lg font-bold text-amber-700 transition-all duration-300 hover:text-amber-600 md:text-2xl dark:text-amber-400", children: geoData?.name || "Hà Nội, Việt Nam" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "gap-2", children: /* @__PURE__ */ jsx(
        "button",
        {
          ...
          className: "flex cursor-pointer items-center justify-center rounded-md border border-amber-500/50 bg-transparent px-6 py-1 text-xs font-bold text-amber-600 transition-all hover:border-amber-500 hover:bg-amber-50/50 dark:text-amber-500 dark:hover:bg-amber-900/20",
          children: "Sửa Nơi Sinh"
        }
      ) }),
      /* @__PURE__ */ jsxs("details", { className: "mt-4 w-full text-center text-[11px] text-gray-950", children: [
        /* @__PURE__ */ jsx("summary", { className: "cursor-pointer font-medium text-amber-700/80 select-none hover:text-amber-800 dark:text-amber-500/80", children: "Tại sao cần Tọa độ chính xác?" }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-10 my-4 text-sm max-lg:m-0 max-lg:mb-5 max-lg:p-0", children: [
      ...
      hasLsData(lsObj) && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "w-full overflow-hidden px-2 sm:px-6", children: [
        /* @__PURE__ */ jsx("div", { className: "relative z-10 mt-2 mb-4 text-sm max-lg:m-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-3 px-2 pb-3", children: [
          /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => setShowNewConfigPanel(true),
              className: "fire-btn btnLsAction flex h-full cursor-pointer items-center justify-center font-bold whitespace-nowrap text-white transition-all hover:scale-105 max-md:text-[11px]",
              children: [
                /* @__PURE__ */ jsx(IconSettings, { className: "mr-1 h-3.5 w-3.5" }),
                " Sửa lá số"
              ]
            }
          ) }),
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("button", { className: "fire-btn btnLsAction flex h-full items-center justify-center gap-1.5 font-bold whitespace-nowrap text-white transition-all hover:scale-105 max-md:text-[11px]", children: [
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("button", { className: "fire-btn btnLsAction flex h-full items-center justify-center font-bold whitespace-nowrap text-white transition-all hover:scale-105 max-md:text-[11px]", children: "Lưu ảnh" })
            }
          ),
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("button", { className: "fire-btn btnLsAction flex h-full items-center justify-center font-bold whitespace-nowrap text-white transition-all hover:scale-105 max-md:text-[11px]", children: isCopying ? "Đang copy..." : "Copy" })
            }
          ),
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("span", { className: "fire-btn btnLsAction flex h-full cursor-pointer items-center justify-center font-bold whitespace-nowrap text-white transition-all hover:scale-105 max-md:text-[11px]", children: "Ghi chú" })
            }
          ),
          /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
            ...
            {
              href: "/hoc-tu-vi",
              className: "fire-btn btnLsAction flex h-full items-center justify-center font-bold whitespace-nowrap text-white transition-all hover:scale-105 max-md:text-[11px]",
              target: "_blank",
              children: "Học tử vi"
            }
          ) })
        ...
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all duration-300 ease-out ${sex === option.value ? "scale-[1.02] transform font-medium shadow-xs" : "bg-gray-50 text-gray-600 hover:bg-gray-100"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            /* @__PURE__ */ jsx("div", { className: "relative mb-4 grid grid-cols-2 border-b border-gray-300", children: [
              ...
              "button",
              {
                className: `relative px-6 py-2 text-sm font-medium transition-all duration-300 ease-out ${activeTimeTab === tab.id ? "text-orange-500" : "text-gray-500 hover:text-gray-700"} touch-manipulation select-none`,
        ...
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all duration-300 ease-out ${cfgLs[CfgValue.showSun] === option.value ? "selected font-medium shadow-xs" : "bg-gray-50 text-gray-600 hover:bg-gray-100"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: yearLoopStarMsg.map((label, idx) => /* @__PURE__ */ jsxs(
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.currentStar] === idx ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: hideStarMsg.map((label, idx) => /* @__PURE__ */ jsxs(
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.showHideStar] === idx ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.dvStar] === option.value ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
        ...
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: typeLsName.map((name, idx) => /* @__PURE__ */ jsxs(
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.typeLs] === idx ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          [6, 7, 8].includes(cfgLs[CfgValue.typeLs]) && /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: typeBanTCP.map((name, idx) => /* @__PURE__ */ jsxs(
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${selectedTcpType === idx ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.typePhiHoa] === option.value ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: levelPhiHoaMsg.map((msg, idx) => /* @__PURE__ */ jsxs(
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.showHoaIcon] === idx ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: changeCanTypeMsg.map((msg, idx) => /* @__PURE__ */ jsxs(
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.lsCanType] === idx ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
        ...
        return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.tuanHoanZone] === option.value ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.rotateZone] === option.value ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.locKiToanDo] === option.value ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg bg-white p-3 shadow-xs", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2", children: [
              ...
              "button",
              {
                className: `flex items-center justify-start gap-2 rounded-md px-3 py-2 text-sm transition-all ${cfgLs[CfgValue.batTuCung] === option.value ? "font-medium shadow-xs" : "bg-gray-50 text-gray-600"} touch-manipulation select-none`,
                style: {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-50 flex items-center justify-between border-b border-gray-200 bg-linear-to-b from-gray-50 to-white px-3 py-1 dark:border-gray-700", children: [
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                onClick: onHidePanel,
                className: "touch-manipulation rounded-full p-2 transition-colors select-none hover:bg-gray-100 dark:hover:bg-gray-700",
          ...
          /* @__PURE__ */ jsx("div", { className: "sticky top-10 z-10 flex overflow-x-auto border-b border-gray-200 bg-white dark:border-gray-700", children: sections.map((section) => /* @__PURE__ */ jsxs(
            "button",
            {
              className: `relative flex min-w-[80px] flex-1 flex-col items-center justify-center overflow-hidden px-4 py-2 text-xs font-medium transition-all duration-300 ease-out ${activeSection === section.id ? "text-orange-500" : "text-gray-500 hover:text-gray-700"} touch-manipulation select-none`,
        ...
        .config-panel .grid button:hover:before {
          width: 100%;
        }
        
        .config-panel .grid button:active {
          transform: scale(0.97);
        }
        
        .config-panel .grid button span {
          position: relative;
          z-index: 1;
        }
        ...
        .config-panel .grid button.selected span:first-child {
          transform: scale(1.1);
        }
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(Fragment, { children: lsObj && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          className: `fixed top-3 left-3 z-50 transition-all duration-300 ease-out ${showLocationPanel || showNewConfigPanel ? "pointer-events-none -translate-y-10 opacity-0" : "translate-y-0 opacity-100"}`,
          children: /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setShowLocationPanel(true),
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          className: `fixed top-3 right-3 z-50 transition-all duration-300 ease-out ${showLocationPanel || showNewConfigPanel ? "pointer-events-none -translate-y-10 opacity-0" : "translate-y-0 opacity-100"}`,
          children: /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setShowNewConfigPanel(true),
