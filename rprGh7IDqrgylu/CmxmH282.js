...
`;
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate(_a || (_a = __template(["  ", '<main class="relative mx-auto min-h-screen overflow-hidden bg-linear-to-b from-transparent via-amber-50 to-transparent font-serif dark:from-transparent dark:via-gray-950 dark:to-transparent"> <div class="relative z-10 mx-auto w-full pt-20 pb-10"> <h1 class="mb-6 text-center text-3xl font-bold text-amber-800 md:text-4xl dark:text-amber-400">\nGieo Qu\u1EBB Kinh D\u1ECBch T\xE0i L\u1ED9c ', ' <span class="mt-2 block text-lg font-normal text-amber-600 dark:text-amber-300">\n\u262F Xem V\u1EADn Ti\u1EC1n T\xE0i, \u0110\u1EA7u T\u01B0 & L\xE0m \u0102n\n</span> </h1> <div class="mb-10 rounded-xl p-6 text-justify text-lg leading-relaxed text-gray-700 backdrop-blur-sm md:p-8 md:text-center"> <p class="mb-4"> <strong class="text-amber-700 dark:text-amber-400">Trong b\u1ED1i c\u1EA3nh kinh t\u1EBF bi\u1EBFn \u0111\u1ED9ng, gieo qu\u1EBB xem t\xE0i l\u1ED9c gi\xFAp b\u1EA1n nh\u1EADn di\u1EC7n xu h\u01B0\u1EDBng t\xE0i ch\xEDnh v\xE0 \u0111\u01B0a ra\n            quy\u1EBFt \u0111\u1ECBnh s\xE1ng su\u1ED1t.</strong> D\xF9 b\u1EA1n \u0111ang c\xE2n nh\u1EAFc \u0111\u1EA7u t\u01B0, h\u1EE3p t\xE1c kinh doanh hay m\u1EDF r\u1ED9ng quy m\xF4 \u2013 Kinh D\u1ECBch s\u1EBD cho b\u1EA1n g\xF3c nh\xECn chi\u1EBFn l\u01B0\u1EE3c.\n</p> <p class="mb-4">\nH\xE3y t\u1EADp trung suy ngh\u0129 v\u1EC1 v\u1EA5n \u0111\u1EC1 t\xE0i ch\xEDnh c\u1EE5 th\u1EC3 \u0111ang tr\u0103n tr\u1EDF: C\xF3 n\xEAn xu\u1ED1ng ti\u1EC1n \u0111\u1EA7u t\u01B0? H\u1EE3p t\xE1c v\u1EDBi \u0111\u1ED1i t\xE1c\n          n\xE0y c\xF3 thu\u1EADn l\u1EE3i? N\u0103m nay l\xE0m \u0103n ra sao? R\u1ED3i tung qu\u1EBB \u0111\u1EC3 nh\u1EADn ch\u1EC9 d\u1EABn.\n</p> <p>\nAI s\u1EBD ph\xE2n t\xEDch qu\u1EBB trong b\u1ED1i c\u1EA3nh t\xE0i l\u1ED9c v\xE0 kinh doanh, gi\xFAp b\u1EA1n hi\u1EC3u r\xF5 th\u1EDDi \u0111i\u1EC3m thu\u1EADn l\u1EE3i, r\u1EE7i ro c\u1EA7n\n          tr\xE1nh v\xE0 chi\u1EBFn l\u01B0\u1EE3c t\u1ED1i \u01B0u.\n</p> </div> </div> ', ' <!-- Decorative elements --> <div class="pointer-events-none absolute top-0 left-0 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-yellow-200/30 blur-3xl dark:bg-yellow-900/20"></div> <div class="pointer-events-none absolute right-0 bottom-0 h-96 w-96 translate-x-1/2 translate-y-1/2 rounded-full bg-amber-200/30 blur-3xl dark:bg-amber-900/20"></div> </main> <script type="application/ld+json">', "<\/script> "])), maybeRenderHead(), currentYear, renderComponent($$result2, "GieoQueKinhDich", GieoQueKinhDich, { "client:load": true, "lang": "vi", "themeColor": "amber", "prefixContent": prefixContent, "languageUrls": languageUrls, "client:component-hydration": "load", "client:component-path": "~/components/horo/tuvi/UI/GieoQueKinhDich", "client:component-export": "default" }), unescapeHTML(JSON.stringify({
