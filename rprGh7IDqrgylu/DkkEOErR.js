...
const NORMAL_STYLE = "bg-linear-to-r from-slate-900 via-slate-700 to-slate-900 shadow-[inset_0_2px_4px_rgba(255,255,255,0.2),inset_0_-2px_4px_rgba(0,0,0,0.4)] dark:from-slate-500 dark:via-slate-300 dark:to-slate-500";
    ...
    "div",
    {
      ...
      children: sortedHaoResults.map((hao) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 py-0.5 md:gap-3", children: [
        /* @__PURE__ */ jsx(
          ...
          {
            className: cx(
              "min-w-[40px] shrink-0 font-serif text-xs font-bold tracking-wider text-amber-800 md:min-w-[50px] md:text-sm dark:text-amber-400"
            ),
...
const CopySection = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "mt-6 px-3 md:mt-8", children: /* @__PURE__ */ jsxs(
    ...
    {
      className: cx(
        "overflow-hidden rounded-xl border border-amber-300 bg-white shadow-sm dark:border-amber-700 dark:bg-gray-900"
      ),
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: cx(
              "flex h-12 items-center justify-between bg-linear-to-r from-amber-100 via-amber-50 to-amber-100 px-6 py-3 font-serif text-sm font-medium text-amber-900 select-none dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 dark:text-amber-400"
            ),
            children: [
              ...
              /* @__PURE__ */ jsxs(
                ...
                {
                  className: cx(
                    "flex items-center gap-2 rounded-lg border border-amber-400 bg-white px-3 py-1.5 shadow-sm transition-all hover:scale-105 hover:border-amber-500 hover:shadow-md active:scale-95 dark:border-amber-700 dark:bg-gray-900 dark:hover:bg-gray-800"
                  ),
        ...
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
          ...
          {
            className: cx(
              "h-30 w-full resize-none overflow-y-auto border-none bg-white p-5 text-left font-mono text-xs leading-relaxed text-gray-700 focus:bg-amber-50/30 focus:outline-none md:h-35 dark:bg-gray-900 dark:text-gray-300 dark:focus:bg-gray-800/80"
            ),
            readOnly: true,
            value: content
          }
...
const HexagramResultDisplay = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto mt-8 w-full bg-white/50", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: cx("relative mt-6 w-full bg-amber-50/30 px-6 pt-8 pb-6 dark:bg-gray-900/30"), children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs(
            ...
            {
              className: cx(
                "relative overflow-hidden rounded-xl border border-amber-300 bg-linear-to-br from-amber-50 via-white to-amber-50 p-8 text-center shadow-sm transition-all hover:shadow-md dark:border-amber-700 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800"
              ),
              children: [
                ...
                /* @__PURE__ */ jsx(
                  ...
                  {
                    className: cx(
                      "relative z-10 mb-2 font-serif text-xs font-bold tracking-[0.3em] text-amber-800 uppercase dark:text-amber-400"
                    ),
                    children: t.queChu
                  }
                ),
                /* @__PURE__ */ jsx("div", { className: "relative z-10 mb-6", children: /* @__PURE__ */ jsx(
                  ...
                  {
                    className: cx(
                      "mb-4 font-serif text-6xl font-bold text-amber-900 md:text-8xl lg:text-9xl dark:text-amber-500"
                    ),
                ...
                /* @__PURE__ */ jsx(
                  ...
                  {
                    className: cx(
                      "relative z-10 mb-4 font-serif text-2xl font-bold tracking-wider text-amber-800 uppercase dark:text-amber-400"
                    ),
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-xl border border-red-300 bg-linear-to-br from-red-50 via-white to-red-50 p-6 shadow-sm dark:border-red-700 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "relative z-10 mx-auto mb-3 flex w-full flex-col gap-3 md:w-auto", children: (() => {
              ...
              if (sortedHaoDong.length > 0) {
                return /* @__PURE__ */ jsx("div", { className: "w-full space-y-3", children: sortedHaoDong.map((hao) => /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: "rounded-lg border border-red-200 bg-white p-3 shadow-sm sm:p-4 dark:border-red-900 dark:bg-gray-800",
                    children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between font-serif text-sm font-medium text-gray-800 sm:text-base dark:text-gray-200", children: [
          ...
          queResult.queBien && /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden rounded-xl border border-orange-300 bg-linear-to-br from-orange-50 via-white to-orange-50 p-8 text-center shadow-sm transition-all hover:shadow-md dark:border-orange-700 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "relative z-10 mb-6", children: /* @__PURE__ */ jsx("div", { className: "mb-4 font-serif text-6xl font-bold text-orange-900 md:text-8xl lg:text-9xl dark:text-orange-500", children: queResult.queBien.queIcon }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto mt-6 w-full px-3 text-center font-serif", children: [
      /* @__PURE__ */ jsxs("p", { className: "mb-3 text-sm leading-relaxed text-gray-700 dark:text-gray-300", children: [
        t.aiInstruction1,
        " ",
        /* @__PURE__ */ jsx("strong", { className: cx("text-amber-800 dark:text-amber-400"), children: t.aiInstruction2 }),
        " ",
        t.aiInstruction3
      ] }),
      /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsxs("p", { className: "mt-3 text-sm leading-relaxed text-gray-700 dark:text-gray-300", children: [
        t.aiInstruction4,
        " ",
        /* @__PURE__ */ jsx("strong", { className: cx("text-amber-800 dark:text-amber-400"), children: t.aiInstruction5 }),
        " ",
        t.aiInstruction6
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "mt-2 text-xs text-gray-500 italic dark:text-gray-400", children: [
        t.aiFallback,
        " ",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative z-10 my-8 mt-4 mb-96 pt-10 font-serif", children: [
    ...
    showIntro && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs(
        ...
        {
          className: cx(
            "relative mt-10 mb-5 text-center font-serif text-4xl font-bold text-amber-800 uppercase md:text-4xl dark:text-amber-500"
          ),
          children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-10 mb-5", children: /* @__PURE__ */ jsxs(
        ...
        {
          className: cx(
            "mx-auto w-full bg-amber-50/30 p-3 text-justify text-lg leading-relaxed text-gray-700 italic md:text-center dark:bg-gray-900/30 dark:text-gray-300"
          ),
          children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "my-2", children: [
              t.intro2,
              " ",
              /* @__PURE__ */ jsx("strong", { className: cx("text-amber-800 dark:text-amber-400"), children: t.intro2Strong }),
              t.intro2Continue
            ] }),
            /* @__PURE__ */ jsxs("p", { children: [
              t.intro3,
              " ",
              /* @__PURE__ */ jsx("strong", { className: cx("text-amber-800 dark:text-amber-400"), children: t.intro3Strong }),
              t.intro3Continue
            ] })
          ]
        }
    ...
    /* @__PURE__ */ jsx(
      ...
      {
        className: cx(
          "relative mx-3 my-6 max-w-lg border border-amber-900/40 bg-[#faf7f2] p-1 md:mx-auto md:my-10 dark:border-amber-700/40 dark:bg-[#17130f]"
        ),
        children: /* @__PURE__ */ jsxs("div", { className: "relative border border-amber-800/25 px-4 py-5 md:px-8 md:py-7 dark:border-amber-600/25", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute -top-px -left-px h-4 w-4 border-t border-l border-amber-900/60 dark:border-amber-500/50" }),
          /* @__PURE__ */ jsx("div", { className: "absolute -top-px -right-px h-4 w-4 border-t border-r border-amber-900/60 dark:border-amber-500/50" }),
          /* @__PURE__ */ jsx("div", { className: "absolute -bottom-px -left-px h-4 w-4 border-b border-l border-amber-900/60 dark:border-amber-500/50" }),
          /* @__PURE__ */ jsx("div", { className: "absolute -right-px -bottom-px h-4 w-4 border-r border-b border-amber-900/60 dark:border-amber-500/50" }),
          /* @__PURE__ */ jsxs("div", { className: "mb-4 text-center md:mb-5", children: [
            /* @__PURE__ */ jsx(
              "p",
              {
                className: cx(
                  "font-serif text-base font-bold tracking-wider text-amber-950 md:text-lg dark:text-amber-200"
                ),
            ...
            /* @__PURE__ */ jsx(
              ...
              {
                className: cx(
                  "mt-0.5 font-serif text-xs tracking-widest text-amber-800/60 md:text-sm dark:text-amber-400/60"
                ),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-5 md:gap-10", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  className: cx(
                    "font-serif text-xs font-bold tracking-wider text-amber-950/80 md:text-sm dark:text-amber-200/80"
                  ),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
              /* @__PURE__ */ jsx("div", { className: "h-px w-3.5 bg-amber-900/30 dark:bg-amber-500/30" }),
              /* @__PURE__ */ jsxs("div", { className: "flex gap-0.5", children: [
                /* @__PURE__ */ jsx("div", { className: "h-px w-1.5 bg-amber-900/30 dark:bg-amber-500/30" }),
                /* @__PURE__ */ jsx("div", { className: "h-px w-1.5 bg-amber-900/30 dark:bg-amber-500/30" })
              ] }),
              /* @__PURE__ */ jsx("div", { className: "h-px w-3.5 bg-amber-900/30 dark:bg-amber-500/30" })
            ] }),
      ...
      !queResult && /* @__PURE__ */ jsx("div", { className: "mx-auto mt-6 w-full", children: /* @__PURE__ */ jsx("div", { className: cx("mx-auto flex w-full flex-col-reverse gap-0.5 px-3 py-4 md:w-auto md:px-6 md:py-6"), children: [6, 5, 4, 3, 2, 1].map((haoNum) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 py-0.5 md:gap-3", children: [
          /* @__PURE__ */ jsx(
            ...
            {
              className: cx(
                `min-w-[40px] shrink-0 font-serif text-xs font-bold tracking-wider md:min-w-[50px] md:text-sm ${hao ? "text-amber-800 dark:text-amber-400" : "text-gray-300 dark:text-gray-600"}`
              ),
              children: label
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "flex w-[110px] shrink-0 items-center justify-center md:w-[180px]", children: hao ? (
            ...
            /* @__PURE__ */ jsx("div", { className: "h-5 w-full rounded-sm bg-gray-200/60 md:h-7 dark:bg-gray-700/40" })
          ) }),
          /* @__PURE__ */ jsx("div", { className: "flex shrink-0 items-center gap-0.5 md:gap-1.5", children: hao ? hao.coins.map((coin, idc) => /* @__PURE__ */ jsx(CoinFace, { type: coin, size: 22 }, `${hao.id}-${idc}-${coin}`)) : (
            ...
            [0, 1, 2].map((i) => /* @__PURE__ */ jsx(
              "div",
              {
                className: "h-[22px] w-[22px] rounded-full bg-gray-200/60 dark:bg-gray-700/40"
              },
              i
            ))
          ) })
    ...
    /* @__PURE__ */ jsx(
      ...
      {
        id: "coin-ani",
        className: `relative mx-auto flex w-full items-center justify-center overflow-hidden transition-[height,opacity] duration-300 ${isFlipping && currentKetQua ? "h-[400px] opacity-100" : "h-0 opacity-0"}`,
        children: isFlipping && currentKetQua && /* @__PURE__ */ jsx(
          CoinFlipAnimation,
          {
            isFlipping,
    ...
    /* @__PURE__ */ jsx("div", { className: cx("relative mx-3 mt-16 mb-8 max-w-lg overflow-hidden text-center xl:mx-auto"), children: /* @__PURE__ */ jsx(
      "a",
      {
        ...
        className: cx(
          "relative z-10 font-serif text-lg font-medium tracking-wide text-amber-700 transition-all hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-300"
        ),
        target: "_blank",
        children: t.helpLink
      }
    ...
    haoResults.length < 6 ? /* @__PURE__ */ jsxs("div", { className: "pointer-events-none fixed right-0 bottom-0 left-0 z-50 flex items-center justify-center pt-6 pb-20", children: [
      /* @__PURE__ */ jsx("div", { className: "pointer-events-auto absolute inset-0 bg-gradient-to-t from-white/90 via-white/40 to-transparent dark:from-gray-950/90 dark:via-gray-950/40" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsx("div", { className: "relative flex h-[96px] w-[96px] items-center justify-center rounded-full border border-amber-500/40 bg-gradient-to-br from-amber-300 via-amber-500 to-amber-700 shadow-[0_0_25px_rgba(217,119,6,0.3),inset_0_4px_10px_rgba(255,255,255,0.5)] dark:border-amber-600/30 dark:from-amber-700 dark:via-amber-800 dark:to-amber-950 dark:shadow-[0_0_25px_rgba(180,83,9,0.4),inset_0_4px_10px_rgba(255,255,255,0.1)]", children: /* @__PURE__ */ jsxs("div", { className: "relative flex h-[82px] w-[82px] items-center justify-center rounded-full bg-gradient-to-tr from-[#fffdf8] via-[#fbf3e0] to-[#fceabe] shadow-[inset_0_3px_12px_rgba(180,83,9,0.4)] dark:from-[#2e2014] dark:via-[#3d2716] dark:to-[#2e2014] dark:shadow-[inset_0_3px_12px_rgba(0,0,0,0.8)]", children: [
            /* @__PURE__ */ jsx("div", { className: "absolute inset-1.5 rounded-full border-[1px] border-amber-700/20 dark:border-amber-500/20" }),
            /* @__PURE__ */ jsx("div", { className: "absolute inset-[10px] rounded-full border-[1.5px] border-dashed border-amber-700/30 dark:border-amber-500/30" }),
            /* @__PURE__ */ jsx("div", { className: "relative z-10 flex flex-col items-center justify-center transition-transform duration-300 group-hover:scale-110", children: isFlipping ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs("span", { className: "block text-[10px] font-medium tracking-widest text-amber-800/80 dark:text-amber-400/80", children: [
                "...",
                t.copyHao,
                " ",
                haoResults.length + 1,
              ...
              /* @__PURE__ */ jsx("span", { className: "mt-0.5 block text-xs font-bold tracking-[0.1em] text-amber-950 drop-shadow-sm dark:text-amber-200", children: t.buttonTungActive })
              ...
              /* @__PURE__ */ jsx("span", { className: "mt-0.5 block text-xs font-bold tracking-[0.1em] text-amber-950 drop-shadow-sm dark:text-amber-200", children: t.buttonTung })
            ] }) })
          ] }) })
        }
      )
      ...
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "relative flex h-[68px] w-[68px] items-center justify-center rounded-full border border-orange-500/40 bg-gradient-to-br from-orange-300 via-orange-500 to-orange-700 shadow-[0_0_15px_rgba(234,88,12,0.3),inset_0_3px_8px_rgba(255,255,255,0.5)] dark:border-orange-600/30 dark:from-orange-700 dark:via-orange-800 dark:to-orange-950 dark:shadow-[0_0_15px_rgba(194,65,12,0.4),inset_0_3px_8px_rgba(255,255,255,0.1)]", children: /* @__PURE__ */ jsxs("div", { className: "relative flex h-[58px] w-[58px] items-center justify-center rounded-full bg-gradient-to-tr from-[#fff8f5] via-[#ffecd6] to-[#ffe0bc] shadow-[inset_0_2px_8px_rgba(194,65,12,0.4)] dark:from-[#331c15] dark:via-[#422216] dark:to-[#331c15] dark:shadow-[inset_0_2px_8px_rgba(0,0,0,0.8)]", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute inset-1.5 rounded-full border-[1px] border-orange-700/20 dark:border-orange-500/20" }),
          /* @__PURE__ */ jsx("div", { className: "absolute inset-2.5 rounded-full border-[1.5px] border-dashed border-orange-700/30 dark:border-orange-500/30" }),
          /* @__PURE__ */ jsx("div", { className: "relative z-10 flex flex-col items-center justify-center transition-transform duration-300 group-hover:scale-110", children: lang === "zh" ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("span", { className: "block text-sm font-bold tracking-wider text-orange-950 drop-shadow-sm dark:text-orange-200", children: "新卦" }),
            /* @__PURE__ */ jsx("span", { className: "block text-[8px] font-medium tracking-widest text-orange-800/80 dark:text-orange-400/80", children: t.buttonNew })
          ] }) : lang === "en" ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("span", { className: "block text-sm font-bold tracking-wider text-orange-950 drop-shadow-sm dark:text-orange-200", children: "New" }),
            /* @__PURE__ */ jsx("span", { className: "block text-[8px] font-medium tracking-widest text-orange-800/80 dark:text-orange-400/80", children: "Hexagram" })
          ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("span", { className: "block text-sm font-bold tracking-wider text-orange-950 drop-shadow-sm dark:text-orange-200", children: t.buttonNew }),
            /* @__PURE__ */ jsx("span", { className: "block pr-0.5 text-[8px] font-medium tracking-widest text-orange-800/80 dark:text-orange-400/80", children: "Gieo lại" })
          ] }) })
        ] }) })
      }
    ),
