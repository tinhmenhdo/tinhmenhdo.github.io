...
import { C as CitySearch } from './DxH6TUwF.js';
import { M as MapPicker } from './CHheibNO.js';
...
const LocationPanel = ({
  ...
  return /* @__PURE__ */ jsx("aside", { className: "fixed inset-y-0 left-0 z-50 w-full transform border-r border-gray-200 bg-white shadow-xl transition-transform ease-in-out md:w-[400px] dark:bg-slate-800", children: /* @__PURE__ */ jsxs("div", { className: "max-h-screen overflow-y-auto p-4 sm:p-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-[99] mb-4", children: [
      /* @__PURE__ */ jsx("label", { className: "text-md mb-2 block font-medium text-gray-700 dark:text-gray-300", children: "Tìm thành phố" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex justify-end", children: [
    ...
    /* @__PURE__ */ jsxs("aside", { className: "relative z-10 w-full max-w-md transform overflow-y-auto bg-white p-6 shadow-2xl transition-transform dark:bg-slate-800", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "text-md mb-2 block font-bold text-gray-700 dark:text-gray-300", children: "Giới tính" }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "text-md mb-2 block font-bold text-gray-700 dark:text-gray-300", children: "Nơi sinh (Quan trọng để tính Bát Tự)" }),
