...
import { f as VALID_INPUT_FORMATS, h as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, i as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './D5X8WKes.js';
import { A as AstroError, D as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, G as renderUniqueStylesheet, H as renderScriptElement, J as createHeadAndContent, r as renderComponent } from './uu9o3mPN.js';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./CUgcZ_lr.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "BUILD_VERSION": "1771997057980", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tinhmenhdo.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./je4qbpvC.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./CwyAY0YJ.js');
