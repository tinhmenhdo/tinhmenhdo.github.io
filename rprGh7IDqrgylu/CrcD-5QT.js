...
`;
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate(_a || (_a = __template(["  ", '<main class="relative mx-auto min-h-screen overflow-hidden bg-linear-to-b from-transparent via-lime-50 to-transparent font-serif dark:from-transparent dark:via-gray-950 dark:to-transparent"> <div class="relative z-10 mx-auto w-full pt-20 pb-10"> <h1 class="mb-6 text-center text-3xl font-bold text-green-800 md:text-4xl dark:text-green-400">\nGieo Qu\u1EBB Kinh D\u1ECBch S\u1EE9c Kh\u1ECFe ', ' <span class="mt-2 block text-lg font-normal text-green-600 dark:text-green-300">\n\u262F C\u1EA7u An, Xem B\u1EC7nh & B\xECnh An Gia \u0110\u1EA1o\n</span> </h1> <div class="mb-10 rounded-xl p-6 text-justify text-lg leading-relaxed text-gray-700 backdrop-blur-sm md:p-8 md:text-center"> <p class="mb-4"> <strong class="text-green-700 dark:text-green-400">S\u1EE9c kh\u1ECFe v\xE0 b\xECnh an l\xE0 \u0111i\u1EC1u qu\xFD gi\xE1 nh\u1EA5t.</strong> Khi b\u1EA3n th\xE2n\n          ho\u1EB7c ng\u01B0\u1EDDi th\xE2n g\u1EB7p v\u1EA5n \u0111\u1EC1 s\u1EE9c kh\u1ECFe, ho\u1EB7c tr\u01B0\u1EDBc chuy\u1EBFn \u0111i xa, gieo qu\u1EBB Kinh D\u1ECBch c\xF3 th\u1EC3 mang l\u1EA1i s\u1EF1 an t\xE2m v\xE0 ch\u1EC9\n          d\u1EABn.\n</p> <p class="mb-4">\nH\xE3y t\u0129nh t\xE2m, c\u1EA7u nguy\u1EC7n b\xECnh an v\xE0 tung qu\u1EBB. Qu\u1EBB d\u1ECBch kh\xF4ng ch\u1EC9 ph\u1EA3n \xE1nh t\xECnh tr\u1EA1ng hi\u1EC7n t\u1EA1i m\xE0 c\xF2n g\u1EE3i \xFD\n          h\u01B0\u1EDBng ch\u0103m s\xF3c, ngh\u1EC9 chuy\xEAn ph\xF9 h\u1EE3p.\n</p> <p>\nAI s\u1EBD lu\u1EADn gi\u1EA3i nh\u1EB9 nh\xE0ng, t\u1EADp trung v\xE0o kh\xEDa c\u1EA1nh s\u1EE9c kh\u1ECFe, \u0111\u01B0a ra l\u1EDDi khuy\xEAn mang t\xEDnh an \u1EE7i v\xE0 \u0111\u1ECBnh h\u01B0\u1EDBng\n          t\xEDch c\u1EF1c.\n</p> </div> </div> ', ' <!-- Decorative elements --> <div class="pointer-events-none absolute top-0 left-0 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-200/30 blur-3xl dark:bg-green-900/20"></div> <div class="pointer-events-none absolute right-0 bottom-0 h-96 w-96 translate-x-1/2 translate-y-1/2 rounded-full bg-lime-200/30 blur-3xl dark:bg-lime-900/20"></div> </main> <script type="application/ld+json">', "<\/script> "])), maybeRenderHead(), currentYear, renderComponent($$result2, "GieoQueKinhDich", GieoQueKinhDich, { "client:load": true, "lang": "vi", "themeColor": "green", "prefixContent": prefixContent, "languageUrls": languageUrls, "client:component-hydration": "load", "client:component-path": "~/components/horo/tuvi/UI/GieoQueKinhDich", "client:component-export": "default" }), unescapeHTML(JSON.stringify({
