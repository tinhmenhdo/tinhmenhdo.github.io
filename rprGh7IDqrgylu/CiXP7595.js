...
`;
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate(_a || (_a = __template(["  ", '<main class="relative mx-auto min-h-screen overflow-hidden bg-linear-to-b from-transparent via-teal-50 to-transparent font-serif dark:from-transparent"> <div class="relative z-10 mx-auto w-full pt-20 pb-10"> <h1 class="mb-6 text-center text-3xl font-bold text-teal-800 md:text-4xl dark:text-teal-400">\nGieo Qu\u1EBB Kinh D\u1ECBch H\xE0ng Ng\xE0y\n<span class="mt-2 block text-lg font-normal text-teal-600 dark:text-teal-300">\n\u262F Xem V\u1EADn H\u1EA1n H\xF4m Nay $', "/$", "/$", ' </span> </h1> <div class="mb-10 rounded-xl p-6 text-justify text-lg leading-relaxed text-gray-700 backdrop-blur-sm md:p-8 md:text-center"> <p class="mb-4"> <strong class="text-teal-700 dark:text-teal-400">M\u1ED7i ng\xE0y mang m\u1ED9t n\u0103ng l\u01B0\u1EE3ng ri\xEAng.</strong> Gieo qu\u1EBB h\xE0ng ng\xE0y\n          gi\xFAp b\u1EA1n n\u1EAFm b\u1EAFt xu h\u01B0\u1EDBng c\u1EE7a ng\xE0y h\xF4m nay, bi\u1EBFt \u0111i\u1EC1u n\xEAn l\xE0m v\xE0 tr\xE1nh.\n</p> <p class="mb-4">\nH\xE3y b\xECnh t\xE2m v\xE0o m\u1ED7i bu\u1ED5i s\xE1ng, d\xE0nh m\u1ED9t ph\xFAt t\u0129nh l\u1EB7ng v\xE0 tung qu\u1EBB. Qu\u1EBB h\xF4m nay l\xE0 ch\u1EC9 d\u1EABn nh\u1ECF nh\u01B0ng \xFD ngh\u0129a,\n          gi\xFAp b\u1EA1n \u0111i \u0111\xFAng nh\u1ECBp v\u1EDBi t\u1EF1 nhi\xEAn.\n</p> <p>\nAI s\u1EBD ph\xE2n t\xEDch qu\u1EBB trong b\u1ED1i c\u1EA3nh v\u1EADn h\u1EA1n ng\xE0y, \u0111\u01B0a ra l\u1EDDi khuy\xEAn ng\u1EAFn g\u1ECDn, th\u1EF1c ti\u1EC5n m\xE0 b\u1EA1n c\xF3 th\u1EC3 \xE1p d\u1EE5ng\n          ngay l\u1EADp t\u1EE9c.\n</p> </div> </div> ', ' <!-- Decorative elements --> <div class="pointer-events-none absolute top-0 left-0 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-200/30 blur-3xl dark:bg-emerald-900/20"></div> <div class="pointer-events-none absolute right-0 bottom-0 h-96 w-96 translate-x-1/2 translate-y-1/2 rounded-full bg-teal-200/30 blur-3xl dark:bg-teal-900/20"></div> </main> <script type="application/ld+json">', "<\/script> "])), maybeRenderHead(), day, month, currentYear, renderComponent($$result2, "GieoQueKinhDich", GieoQueKinhDich, { "client:load": true, "lang": "vi", "themeColor": "teal", "prefixContent": prefixContent, "languageUrls": languageUrls, "client:component-hydration": "load", "client:component-path": "~/components/horo/tuvi/UI/GieoQueKinhDich", "client:component-export": "default" }), unescapeHTML(JSON.stringify({
