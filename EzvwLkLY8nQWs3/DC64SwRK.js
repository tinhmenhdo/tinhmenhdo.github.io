...
import { C as CHI$1, a as CAN$1, k as CfgValue$1, R as getSexText, Q as getLunaBornText$1, s as SM$1 } from './DHWZEsDM.js';
...
const MapPicker = lazy(
  () => import('./IPuAKmdK.js').then(n => n.a).then((module) => ({ default: module.MapPicker }))
);
...
dayjs.extend(utc);
dayjs.locale("vi");
const NewConfigPanelGpsLazy = lazy(() => import('./CpoY2Pej.js'));
