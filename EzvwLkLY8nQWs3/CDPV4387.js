...
import { e as cn } from './Cai4ZUSU.js';
...
const initFuse = async () => {
  ...
  fetchPromise = (async () => {
    try {
      const dataUrl2 = atob("LzY0NjE3NDYxMmU2YTczNmYvNjM2OTc0Njk2NTczMmU2YTczNmY2ZS5qc29u");
      ...
      console.error("Error loading city data from " + (dataUrl || "unknown"), error);
      throw error;
    } finally {
      fetchPromise = null;
    }
