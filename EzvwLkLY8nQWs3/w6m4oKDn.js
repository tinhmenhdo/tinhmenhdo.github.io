...
import { f as VALID_INPUT_FORMATS, h as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, i as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './Cai4ZUSU.js';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./DxpO44o-.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "BUILD_VERSION": "1769786125742", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tinhmenhdo.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./nGoHX81s.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./CbKy0DFP.js');
