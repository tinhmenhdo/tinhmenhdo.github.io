import{d as createAstro,c as createComponent,m as maybeRenderHead,r as renderComponent,a as renderTemplate,b as addAttribute,f as Fragment$1,u as unescapeHTML,e as renderSlot,k as renderScript}from"./BjbOJe_V.js";import"kleur/colors";import*as LucideIcons from"lucide-react";import{Menu,X}from"lucide-react";import{jsx,Fragment}from"react/jsx-runtime";import{S as SITE,e as getHomePermalink,f as getAsset,a as getPermalink}from"./BXYjXa5f.js";import{$ as $$Layout}from"./BSSLWWEU.js";import{clsx}from"clsx";import{twMerge}from"tailwind-merge";function LucideIconCp({name:e,...t}){if(void 0===LucideIcons[e])return jsx(Fragment,{});const i=LucideIcons[e]||LucideIcons.Home;return jsx(i,{...t})}const $$Astro$2=createAstro("https://tinhmenhdo.com"),$$Sidebar=createComponent(((e,t,i)=>(e.createAstro($$Astro$2,t,i).self=$$Sidebar,renderTemplate`${maybeRenderHead()}<header class="relative h-12 bg-[var(--sidebar-bg)] z-40 flex items-center px-4 w-full shadow-[0_4px_16px_rgba(0,0,0,0.25),_0_2px_4px_rgba(0,0,0,0.15)]"> <div class="bgInset h-full absolute top-0 left-0 w-full z-[-1]"> <div class="bgInsetInner h-full! w-full"></div> </div> <button id="mobile-menu-toggle" class="text-[hsl(var(--sidebar-fg))]"> ${renderComponent(e,"Menu",Menu,{className:"w-6 h-6"})} </button> <div class="flex justify-center flex-1"> <!-- <a href='/' title='Tinh Mệnh Đồ - Công cụ lấy lá số nhanh, chuẩn, hàng đầu!'>
...
</div> </div> </div> </header>`)),"/root/code/tmd_astro/src/components/Sidebar.astro",void 0),$$Astro$1=createAstro("https://tinhmenhdo.com"),$$Footer=createComponent(((e,t,i)=>{const n=e.createAstro($$Astro$1,t,i);n.self=$$Footer;const{socialLinks:a=[],links:r=[],theme:o="light"}=n.props;return renderTemplate`${maybeRenderHead()}<footer${addAttribute([{dark:"dark"===o},"relative border-t border-gray-200 dark:border-slate-800 not-prose"],"class:list")}> <div class="absolute inset-0 pointer-events-none dark:bg-dark" aria-hidden="true"></div> <div class="w-full mx-auto"> <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-7 xl:px-8 px-6 py-6 xl:py-8 xl:grid-cols-7"> ${r.map((({title:t,items:i})=>renderTemplate`<div class="border border-gray-100 dark:border-slate-800 p-4 rounded-lg shadow-xl"> <h2 class="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white ">${t}</h2> ${i&&Array.isArray(i)&&i.length>0&&renderTemplate`<ul class="text-sm text-gray-500 dark:text-gray-400"> ${i.map((({title:t,href:i,ariaLabel:n})=>renderTemplate`<li class="mb-2"> <a class="transition duration-150 ease-in-out text-muted dark:text-gray-400 hover:text-orange-500 hover:underline"${addAttribute(i,"href")}${addAttribute(n,"aria-label")} target="_blank"${addAttribute(t,"title")}> ${renderComponent(e,"Fragment",Fragment$1,{},{default:e=>renderTemplate`${unescapeHTML(t)}`})} </a> </li>`))} </ul>`} </div>`))} <!-- <div>
