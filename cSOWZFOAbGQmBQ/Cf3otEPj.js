...
import { b as HoroHelp, f as createShareUrl, R as AppUI, T as TrungChauWarning, U as tmdAppThumb, h as CSVTable, E as ExplainLS, I as IconSettings } from './BIaGjqnI.js';
import { o as configDefault, p as numbStringToArr, L as LTHG, a as CAN, C as CHI, j as AREA_NAME, q as TH, g as LTHG_HH, i as CfgValue, d as CHI_AD, r as StlkName, Z as ZolkName, s as hoa2IchingIdx, x as xtngl, t as CAN_HOA, u as buildDateInfo, G as GETHOA, v as StarToHoaCan, w as StarUseHoa, n as SM, y as STARSTRONG, z as STAR_SIGN, B as CR_TS, F as FAILURE6, D as idxTHAP, E as CHI_CAN, I as idxTSTutru, J as CHI_3HH, e as CHI_HH, K as THAP, M as HH_THAP, c as CAN_HH, b as CAN_AD, O as containsNumber, Q as STARLOOP1, H as HH, R as ADTN, U as SKB, T as TKN, V as TKN_MONTH, h as TKN_PN, W as TSNAME, f as LTHG_NA, k as getLunaBornText, X as arrH1, m as getSexText, Y as validateAllConfig, _ as updateConfig, $ as LsTypeSlug } from './CpcYxhgG.js';
import { c as convertSolar2Lunar } from './DtBB0w0U.js';
...
import HoroscopeHtmlClient from './CeQDcD_k.js';
import './CpgQb43x.js';
...
const LoadingMessage = ({ message }) => /* @__PURE__ */ jsx(
  "div",
  {
    className: "flex h-full w-full items-center justify-center bg-slate-100 p-4 text-center",
...
dayjs.locale("vi");
const BatQuaiMenhTungBoLazy = lazy(() => import('./DRo8N7sk.js'));
const NewConfigPanelLazy = lazy(() => import('./CvSgcIxh.js'));
const PageContentStaticLazy = lazy(() => import('./sceLOtPC.js'));
const SkeletonLoader = () => /* @__PURE__ */ jsxs("div", { className: "animate-pulse rounded-md bg-gray-50 p-4", style: { minHeight: "200px" }, children: [
  /* @__PURE__ */ jsx("div", { className: "mb-2 h-6 w-3/4 rounded-md bg-gray-200" }),
  /* @__PURE__ */ jsx("div", { className: "mb-2 h-4 w-1/2 rounded-md bg-gray-200" }),
  /* @__PURE__ */ jsx("div", { className: "mb-2 h-4 w-2/3 rounded-md bg-gray-200" })
] });
...
function PersonInfoClient({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 my-4 text-sm max-lg:m-0 max-lg:mb-5 max-lg:p-0", children: [
            ...
            /* @__PURE__ */ jsxs("section", { className: "mb-20 px-2 sm:px-6", style: { minHeight: "300px" }, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mb-10", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "flex w-full justify-center gap-2 py-5 [&>img]:w-1/3", children: /* @__PURE__ */ jsx(
                  ...
                  {
                    src: tmdAppThumb.src,
                    className: "h-auto rounded-xl border border-black/40 shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all hover:shadow-[0_8px_25px_rgba(255,104,0,0.3)]",
            ...
            /* @__PURE__ */ jsx(
              Suspense,
              {
                fallback: /* @__PURE__ */ jsxs("div", { className: "rounded-md bg-gray-50 p-4", style: { height: "200px", width: "100%" }, children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-2 h-6 w-3/4 rounded-md bg-gray-200" }),
                  /* @__PURE__ */ jsx("div", { className: "mb-2 h-4 w-1/2 rounded-md bg-gray-200" })
                ] }),
            ...
            /* @__PURE__ */ jsx("h2", { className: "px-4 mt-8 mb-4 text-center text-lg italic text-amber-900/80 font-serif", children: descSeo }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-8 text-stone-800 leading-relaxed text-sm sm:text-[15px] font-serif max-w-5xl mx-auto", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxs("p", { className: "pl-10", children: [
                    ...
                    " ",
                    /* @__PURE__ */ jsx("a", { href: "/tu-vi/la-so-tu-vi-viet-nam", className: "font-semibold text-red-700 hover:text-red-800 underline decoration-red-700/30 underline-offset-4 transition-colors", children: "lá số Tử Vi Việt Nam" }),
                    " ",
    ...
    /* @__PURE__ */ jsx(
      Suspense,
      {
        fallback: /* @__PURE__ */ jsx("div", { className: "fixed top-0 right-0 z-50 h-full w-85 translate-x-full transform overflow-y-auto bg-white shadow-xl", children: /* @__PURE__ */ jsxs("div", { className: "p-4", children: [
        ...
        children: hasLsData(lsObj) && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(
            "aside",
            {
              className: `fixed inset-y-0 right-0 z-50 w-full transform bg-white/0 shadow-xl transition-transform ease-in-out md:w-85 ${showNewConfigPanel ? "translate-x-0" : "translate-x-full"} overflow-y-auto`,
