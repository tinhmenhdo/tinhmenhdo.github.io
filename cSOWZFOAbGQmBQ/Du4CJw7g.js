...
const SITE = {"name":"Tinh Mệnh Đồ","site":"https://tinhmenhdo.github.io","base":"/","trailingSlash":false,"googleSiteVerificationId":"orcPx1I47GSa-cRvY11tUe6iGg2IO_RsPvnA1q95iEM3M_111"};
                    ...
                    const METADATA = {"title":{"default":"Tinh Mệnh Đồ - Lá số tử vi Khâm Thiên Tứ Hóa, tử vi Việt Nam, xem vận hạn 2026, lập lá số tử vi, Kì Môn, Thái Ất, Kinh Dịch, Lục Hào trọn bộ.","template":"%s — Tinh Mệnh Đồ"},"description":"Lập lá số Tử Vi Việt Nam, xem vận hạn 2026, hệ thống tool hỗ trợ Kì Môn, Thái Ất, Kinh Dịch trọn bộ","openGraph":{"type":"website","site_name":"TinhMenhDo","images":[{"url":"~/assets/images/TinhMenhDoLogo.webp","width":1200,"height":628}]},"twitter":{"handle":"@tinhmenhdo","site":"@tinhmenhdo","cardType":"summary_large_image"}};
...
export { ANALYTICS as A, BLOG_BASE as B, CATEGORY_BASE as C, DEFAULT_OUTPUT_FORMAT as D, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, VALID_SUPPORTED_FORMATS as V, getHomePermalink as a, getAsset as b, cn as c, getPermalink as d, DEFAULT_HASH_PROPS as e, VALID_INPUT_FORMATS as f, getCanonical as g, cleanSlug as h, APP_BLOG as i, getFormattedDate as j, getBlogPermalink as k, getCategoryUrl as l, sanitize as s, trimSlash as t };
