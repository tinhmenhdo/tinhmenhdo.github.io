...
`;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative z-10 my-8 mt-4 mb-96 pt-10 font-serif", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto flex w-full flex-col", children: [
      ...
      !queResult && /* @__PURE__ */ jsx("div", { className: "mx-auto mt-6 w-full", children: /* @__PURE__ */ jsx("div", { className: cx("mx-auto flex w-full flex-col-reverse gap-0.5 px-3 py-4 md:w-auto md:px-6 md:py-6"), children: [1, 2, 3, 4, 5, 6].map((haoNum) => {
