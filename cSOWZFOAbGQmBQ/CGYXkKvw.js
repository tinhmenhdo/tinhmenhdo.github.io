...
import { C as CitySearch, I as Input } from './DiprJFgG.js';
import { S as SolarCalculator } from './CpgQb43x.js';
import { M as MapPicker } from './zPSr96Kh.js';
import { B as Button } from './B1-baUnW.js';
...
const messages = {
  description: "Công cụ chuyển đổi giờ Mặt Trời thực và tính toán Điểm Sóc (New Moon).",
...
function SolarNoonViewer() {
  ...
  const calculateSolarData = (lat, lon, inputDate, inOffset, tgtOffset, tgtTzName) => {
    try {
      console.log("inputDate", inputDate);
      const inputTimeBase = dayjs(inputDate);
      if (!inputTimeBase.isValid()) {
        throw new Error("Ngày giờ không hợp lệ");
      }
      const properDate = inputTimeBase.toDate();
      const calculatedData = SolarCalculator.getSolarDataForDate(properDate, lon, lat, tgtOffset);
      const dataFormatted = {
        date: properDate,
        // Original Input
        utc: SolarCalculator.formatDateTime(calculatedData.utc),
        localTime: SolarCalculator.formatDateTime(calculatedData.localTime),
        trueSolarTime: SolarCalculator.formatDateTime(calculatedData.trueSolarTime),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto w-full space-y-8", children: [
    ...
    geoData && /* @__PURE__ */ jsxs("div", { ref: resultsRef, className: "rounded-lg", children: [
      ...
      solarData && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        solarData.trueSolarBazi && /* @__PURE__ */ jsxs("div", { className: "col-span-1 mt-6 rounded-sm border border-gray-200 bg-linear-to-br from-amber-50 to-amber-100 p-6 shadow-sm md:col-span-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-6 flex justify-center gap-5", children: (() => {
            ...
            return /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(
                "a",
                {
                  href: `/tu-vi-tu-tru/the-gioi-theo-vi-tri-sinh?s=1&b=${dateParam}&v=${dateParam}&cf=7bmqz-2t-lfrc&lat=${geoData.lat.toFixed(4)}&lon=${geoData.lon.toFixed(4)}`,
              ...
              /* @__PURE__ */ jsx(
                "a",
                {
                  href: `/tu-vi-tu-tru/the-gioi-theo-vi-tri-sinh?s=0&b=${dateParam}&v=${dateParam}&cf=7bmqz-2t-lfrc&lat=${geoData.lat.toFixed(4)}&lon=${geoData.lon.toFixed(4)}`,
