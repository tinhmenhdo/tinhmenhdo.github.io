import { b as createAstro, c as createComponent, m as maybeRenderHead, e as addAttribute, a as renderTemplate, r as renderComponent, d as Fragment$1, u as unescapeHTML, j as renderScript, k as defineScriptVars, s as spreadAttributes, l as renderSlot, n as renderHead } from './F_Fel0yb.js';
import 'piccolore';
import * as LucideIcons from 'lucide-react';
import { Compass, MessageCircleQuestion, Menu } from 'lucide-react';
import { c as cn, S as SITE, a as getHomePermalink, A as ANALYTICS, U as UI, b as getAsset, g as getCanonical, I as I18N, M as METADATA, d as getPermalink } from './Du4CJw7g.js';
import { jsx, Fragment } from 'react/jsx-runtime';
import 'clsx';
/* empty css         */
import { escape } from 'html-escaper';
import merge from 'lodash.merge';
import { g as getImage } from './Cq406m8d.js';
import { parseUrl, transformUrl } from 'unpic';

const $$Astro$9 = createAstro("https://tinhmenhdo.github.io");
const $$BottomNav = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$9, $$props, $$slots);
  Astro2.self = $$BottomNav;
  const FAVICON_DATA_URI = "data:image/png;base64,";
  const pathname = Astro2.url.pathname;
  const navItems = [
    {
      label: "Trang ch\u1EE7",
      href: "/",
      imageSrc: FAVICON_DATA_URI,
      isActive: pathname === "/"
    },
    {
      label: "Xem m\u1EC7nh",
      ...
      icon: Compass,
      isActive: pathname.includes("/tu-vi")
    },
    {
      label: "Gieo Qu\u1EBB",
      href: "/gieo-que-kinh-dich",
      icon: MessageCircleQuestion,
      isActive: pathname.includes("/gieo-que")
    },
    {
      label: "Menu",
      href: "#",
  ...
  return renderTemplate`${maybeRenderHead()}<div class="pointer-events-none fixed right-0 bottom-4 left-0 z-50 flex justify-center px-4"> <nav class="liquid-glass-bg px-0.7 pointer-events-auto relative flex h-14 w-fit min-w-80 items-center justify-around gap-1 rounded-full backdrop-blur-md"> ${navItems.map((item) => {
    const Icon = item.icon;
    return renderTemplate`<a${addAttribute(item.isMenu ? "javascript:void(0)" : item.href, "href")}${addAttribute(cn(
      "group relative flex h-full items-center justify-center transition-all duration-300",
      item.isMenu && "js-mobile-menu-trigger",
      item.isActive ? "z-10 w-20" : "z-0 w-16"
    ), "class")}> ${item.isActive ? renderTemplate`<div class="liquid-glass-active absolute top-1/2 left-1/2 flex h-15 min-w-24 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-[1.75rem]"> ${item.imageSrc ? renderTemplate`<img${addAttribute(item.imageSrc, "src")}${addAttribute(item.label, "alt")} width="19" height="19" loading="lazy" fetchpriority="low" class="mb-0.5 h-[19px] w-[19px] object-contain drop-shadow-[0_0_10px_rgba(239,68,68,0.8)]">` : Icon && renderTemplate`${renderComponent($$result, "Icon", Icon, { "className": "mb-0.5 h-5 w-5 text-red-600 drop-shadow-[0_0_6px_rgba(239,68,68,0.5)]" })}`} <span class="text-[10px] font-bold text-red-600">${item.label}</span> </div>` : renderTemplate`<div class="flex flex-col items-center justify-center text-orange-400/80 transition-colors group-hover:text-red-600"> ${item.imageSrc ? renderTemplate`<img${addAttribute(item.imageSrc, "src")}${addAttribute(item.label, "alt")} width="19" height="19" loading="lazy" fetchpriority="low" class="mb-0.5 h-[19px] w-[19px] object-contain opacity-70 transition-all group-hover:opacity-100">` : Icon && renderTemplate`${renderComponent($$result, "Icon", Icon, { "className": "mb-0.5 h-5 w-5" })}`} <span class="text-[10px] font-medium text-orange-500 transition-colors group-hover:text-red-600"> ${item.label} </span> </div>`} </a>`;
  })} </nav> </div>`;
}, "/root/code/tmd_astro/src/components/BottomNav.astro", void 0);
...
const $$Sidebar = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Sidebar;
  return renderTemplate`${Astro2.url.pathname !== "/" && renderTemplate`${maybeRenderHead()}<div class="fixed top-3 right-0 left-0 z-50 flex justify-center px-4"><header class="flex h-10 items-center justify-center rounded-full border border-white/40 bg-white/30 px-6 shadow-sm backdrop-blur-md transition-all hover:bg-white/40"><a class="text-mystic text-[17px] leading-tight font-semibold transition-all hover:text-red-600" href="/" title="Tinh Mệnh Đồ - Lấy lá số nhanh chuẩn">
Tinh Mệnh Đồ
</a></header></div>`}`;
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer${addAttribute([
    { dark: theme === "dark" },
    "relative border-t border-red-900/10 pb-18 font-serif"
  ], "class:list")}> <div class="mx-auto w-full max-w-5xl"> <div class="px-6 py-10 text-center xl:px-8"> <div class="flex flex-col gap-10"> ${links.map(({ title, items }) => renderTemplate`<div class="flex flex-col items-center"> <h2 class="mb-4 text-sm font-bold tracking-widest text-stone-500 uppercase"> ${title} <div class="mx-auto mt-2 h-px w-10 bg-red-400/50"></div> </h2> ${items && Array.isArray(items) && items.length > 0 && renderTemplate`<div class="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-[13px]"> ${items.map(({ title: text, href, ariaLabel }, index) => renderTemplate`${renderComponent($$result, "Fragment", Fragment$1, {}, { "default": ($$result2) => renderTemplate` <a class="text-stone-600 transition-colors hover:text-red-600"${addAttribute(href, "href")}${addAttribute(ariaLabel, "aria-label")}${addAttribute(text, "title")}> ${renderComponent($$result2, "Fragment", Fragment$1, {}, { "default": ($$result3) => renderTemplate`${unescapeHTML(text)}` })} </a> ${index < items.length - 1 && renderTemplate`<span class="text-red-400/40">·</span>`}` })}`)} </div>`} </div>`)} </div> </div> <!-- Decorative Divider between links and copyright --> <div class="mb-4 flex items-center justify-center gap-4"> <div class="h-px w-16 bg-linear-to-r from-transparent via-red-400/40 to-transparent md:w-32"></div> <div class="h-1.5 w-1.5 rotate-45 border border-red-400/50 bg-red-500/15"></div> <div class="h-px w-16 bg-linear-to-r from-transparent via-red-400/40 to-transparent md:w-32"></div> </div> <div class="px-4 py-6 text-center text-xs font-medium text-stone-500"> <div class="mx-auto flex flex-col items-center justify-center gap-4"> <div class="flex flex-wrap items-center justify-center gap-x-2 gap-y-1"> <span>© 2023</span> <svg class="h-2 w-2 text-red-400/40" viewBox="0 0 24 24" fill="currentColor"> <path d="M12 2L14.4 9.6L22 12L14.4 14.4L12 22L9.6 14.4L2 12L9.6 9.6L12 2Z"></path> </svg> <a class="font-bold text-red-600 transition-colors hover:text-red-500"${addAttribute(getHomePermalink(), "href")}>${SITE?.name}</a> <span class="text-red-400/40">|</span> <a class="tracking-widest uppercase transition-colors hover:text-red-500" href="/phien-ban-cap-nhat">
v${VERSION_HORO} </a> <span class="text-red-400/40">|</span> ${renderComponent($$result, "OnlineView", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/root/code/tmd_astro/src/components/common/OnlineView", "client:component-export": "OnlineView" })} </div> ${socialLinks && socialLinks.length > 0 && renderTemplate`<div class="flex items-center justify-center gap-4"> ${socialLinks.map(({ ariaLabel, href, title: text, icon }) => renderTemplate`<a class="text-stone-400 transition-colors hover:text-red-500"${addAttribute(ariaLabel, "aria-label")}${addAttribute(href, "href")} target="_blank"${addAttribute(text, "title")}> ${renderComponent($$result, "LucideIconCp", LucideIconCp, { "name": icon, "className": "h-4 w-4" })} <span class="sr-only"> ${renderComponent($$result, "Fragment", Fragment$1, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(text)}` })} </span> </a>`)} </div>`} </div> </div> </div> </footer>`;
...
const $$AstroSeo = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Fragment", Fragment$1, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(buildTags({
    title,
    titleTemplate,
    noindex,
    nofollow,
  ...
  const seoProps = merge(
    {
      ...
      openGraph: {
        ...
        images: [
          {
            url: "https://tinhmenhdo.com/images/TinhMenhDoLogo.webp",
            width: 1200,
            height: 630
          }
        ],
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")}${addAttribute(initialLayout, "data-layout")}> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}${renderComponent($$result, "ClientRouter", $$ClientRouter, { "fallback": "animate" })}${renderSlot($$result, $$slots["head"])}${renderHead()}</head> <body${addAttribute(`min-h-screen bg-background font-sans antialiased overflow-x-hidden bg-body relative ${isHome ? "is-home" : "not-home"}`, "class")}> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})} ${renderComponent($$result, "VersionChecker", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "~/components/common/VersionChecker", "client:component-export": "default" })}  </body> </html>`;
}, "/root/code/tmd_astro/src/layouts/Layout.astro", void 0);

const headerData = {
  links: [
    {
      title: 'Lá số tử vi & tứ trụ',
      icon: 'CircleDotDashed',
      items: [
        {
          title: 'Tử vi & tứ trụ theo nơi sinh',
          href: '/tu-vi-tu-tru/the-gioi-theo-vi-tri-sinh',
          icon: 'MapPin'
        },
        { title: 'Tử vi việt nam', href: '/la-so-tu-vi/la-so-tu-vi-viet-nam', icon: 'Star' },
        { title: 'Phi tinh lương phái', href: '/la-so-tu-vi/tu-vi-phi-tinh-luong-phai', icon: 'Sparkles' },
        { title: 'Khâm thiên tứ hóa', href: '/la-so-tu-vi/kham-thien-tu-hoa-nam-phai', icon: 'Grid2x2' },
        { title: 'Trung châu phái', href: '/la-so-tu-vi/tu-vi-trung-chau-phai', icon: 'Compass' },
        { title: 'Nam phái', href: '/la-so-tu-vi/tu-vi-nam-phai', icon: 'Shield' }
      ]
    },

    {
      ...
      icon: 'Hexagon',
      items: [
        { title: 'Gieo quẻ đầu năm 2026', href: '/gieo-que-dau-nam', icon: 'PartyPopper' },
        { title: 'Xin quẻ đầu năm 2026', href: '/xin-que-dau-nam', icon: 'Sparkle' },
        { title: 'Gieo quẻ hỏi việc', href: '/gieo-que-hoi-viec', icon: 'MessageCircleQuestion' },
        { title: 'Gieo quẻ kinh dịch', href: '/gieo-que-kinh-dich', icon: 'Dices' },
        { title: 'Gieo quẻ hàng ngày', href: '/gieo-que-hang-ngay', icon: 'Sunrise' },
        { title: 'Gieo quẻ tình duyên', href: '/gieo-que-tinh-duyen', icon: 'HeartHandshake' },
        { title: 'Gieo quẻ sự nghiệp', href: '/gieo-que-cong-danh-su-nghiep', icon: 'TrendingUp' },
        { title: 'Gieo quẻ tài lộc', href: '/gieo-que-tai-loc-kinh-doanh', icon: 'Wallet' },
        { title: 'Gieo quẻ sức khỏe', href: '/gieo-que-suc-khoe-binh-an', icon: 'ShieldPlus' },
        { title: 'Bát Tự Hà Lạc', href: '/bat-tu-ha-lac-co-truyen', icon: 'Scroll' },
        { title: 'Ý nghĩa 64 quẻ kinh dịch', href: '/y-nghia-64-que-kinh-dich', icon: 'BookOpenText' },
        {
    ...
    },
    {
      ...
      icon: 'Clock',
      items: [
        { title: 'Xem ngày tốt xấu', href: '/xem-ngay-gio-tot-xau', icon: 'CalendarCheck' },
        { title: 'Xem tuổi xông đất 2026', href: '/xem-tuoi-xong-dat-nam-2026-binh-ngo', icon: 'Flame' },
        { title: 'Tiết khí chính xác', href: '/tiet-khi-chinh-xac', icon: 'Sun' },
        { title: 'Điểm Sóc chính xác', href: '/ngay-gio-soc-chinh-xac', icon: 'Moon' },
        { title: 'Tiết khí toàn cầu', href: '/tra-cuu-tiet-khi-trong-nam-toan-cau', icon: 'Globe' },
        { title: 'Tiết khí Việt Nam 2026', href: '/tiet-khi-vietnam-2026', icon: 'MapPin' }
      ]
    },
    {
      title: 'Tự học tử vi',
      icon: 'GraduationCap',
      items: [{ title: 'Hệ thống tự học tử vi', href: '/hoc-tu-vi', icon: 'BookOpen' }]
    },
    {
      title: 'Bổ trợ',
      icon: 'Wrench',
      items: [
        ...
        { title: 'Đổi giờ âm lịch địa phương', href: '/doi-gio-am-lich-dia-phuong-online', icon: 'Clock' },
    ...
    // },
    {
      ...
      items: [
        { title: 'Nền tảng hỗ học thuật', href: 'https://www.facebook.com/alexphong.rough', icon: 'Facebook' },
        {
          ...
          href: 'https://s.shopee.vn/AUntOmPuuQ',
          icon: 'BookMarked'
        }
      ]
    },
    {
      ...
      icon: 'Settings',
      items: [
        { title: 'Về chúng tôi', href: '/about-us', icon: 'Users' },
  ...
  links: [
    {
      ...
      items: [
        {
          title: 'Tử Vi & Tứ Trụ theo nơi sinh (chính xác cao)',
          href: '/tu-vi-tu-tru/the-gioi-theo-vi-tri-sinh',
          icon: 'PackageSearch'
        },
        { title: 'Lá số tử vi việt nam tổng hợp', href: '/la-so-tu-vi/la-so-tu-vi-viet-nam', icon: 'Star' },
        { title: 'Lá số khâm thiên & Nam Phái', href: '/la-so-tu-vi/kham-thien-tu-hoa-nam-phai', icon: 'Star' },
        { title: 'Lá số phi tinh lương phái', href: '/la-so-tu-vi/tu-vi-phi-tinh-luong-phai', icon: 'Star' },
        { title: 'Lá số trung châu phái', href: '/la-so-tu-vi/tu-vi-trung-chau-phai', icon: 'Star' },
        { title: 'Lá số khâm thiên tứ hóa', href: '/la-so-tu-vi/tu-vi-kham-thien-tu-hoa', icon: 'Star' },
        { title: 'Nam phái', href: '/la-so-tu-vi/tu-vi-nam-phai', icon: 'PackageSearch' }
      ]
    },

    {
      ...
      items: [
        ...
        { title: 'Gieo quẻ hàng ngày', href: '/gieo-que-hang-ngay', icon: 'CalendarCheck' },
        { title: 'Gieo quẻ tình duyên', href: '/gieo-que-tinh-duyen', icon: 'Heart' },
        { title: 'Gieo quẻ sự nghiệp', href: '/gieo-que-cong-danh-su-nghiep', icon: 'Briefcase' },
        { title: 'Gieo quẻ tài lộc', href: '/gieo-que-tai-loc-kinh-doanh', icon: 'Coins' },
        { title: 'Gieo quẻ sức khỏe', href: '/gieo-que-suc-khoe-binh-an', icon: 'HeartPulse' },
    ...
    },
    {
      ...
      icon: 'Construction',
      items: [
        { title: 'Xem tuổi xông đất 2026', href: '/xem-tuoi-xong-dat-2026-binh-ngo', icon: 'Calculator' },
        { title: 'Xem ngày tốt xấu', href: '/xem-ngay-gio-tot-xau', icon: 'CalendarCheck' },
        { title: 'Lịch Vạn Niên', href: '/lich-van-nien', icon: 'CalendarDays' },
        { title: 'Lịch Vạn Sự', href: '/lich-van-su', icon: 'Calendar' },
        { title: 'Thần số học', href: '/than-so-hoc', icon: 'Calculator' },
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'Website dự phòng 3', href: 'https://tinhmenhdo.netlify.app', icon: 'Globe' },
        { title: 'Website dự phòng 4', href: 'https://tinhmenhdo.vercel.app', icon: 'Globe' },
        { title: 'Website dự phòng 5', href: 'https://tinhmenhdo.web.app', icon: 'Globe' },
        {
          title: 'Sách 5 Cuốn Cổ Học Kỳ Thư',
          href: 'https://s.shopee.vn/AKUTCTQYFP',
          icon: 'BookMarked'
        }
      ]
    }
...
// Made by <a class="text-blue-600 underline" href="https://onwidget.com/"> onWidget</a> · All rights reserved
...
const $$PageLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  const { metadata = {} } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<main class="flex min-h-screen flex-wrap justify-center font-serif"> ${renderComponent($$result2, "Sidebar", $$Sidebar, {})} <div id="main-content" class="w-full"> <div data-pagefind-body> ${renderSlot($$result2, $$slots["default"])} </div> ${renderSlot($$result2, $$slots["footer"], renderTemplate` ${renderComponent($$result2, "Footer", $$Footer, { "links": footerData.links, "secondaryLinks": footerData.secondaryLinks, "socialLinks": footerData.socialLinks, "footNote": footerData.footNote })} `)} </div> </main> <div id="mobile-dropdown-menu" class="pointer-events-none fixed inset-x-0 top-0 bottom-0 !z-40 flex transform flex-col overflow-y-auto bg-white/80 px-6 pt-15 pb-24 font-serif opacity-0 backdrop-blur-2xl transition-all duration-300"> <nav class="flex-1"> ${headerData.links.map((section) => renderTemplate`<div class="js-section border-b border-amber-900/10 last:border-none"> <button${addAttribute(cn(
    "flex w-full items-center justify-between py-4.5",
    "text-red-900 transition-colors hover:text-red-600",
    "js-section-toggle outline-none"
  ), "class")}> <div class="flex items-center"> ${renderComponent($$result2, "LucideIconCp", LucideIconCp, { "name": section.icon, "className": "w-4 h-4 mr-3 text-red-600" })} <span class="text-[11px] font-bold tracking-widest uppercase min-[380px]:text-[12px]"> ${section.title} </span> </div> <svg class="js-section-arrow h-4 w-4 rotate-180 text-red-500/70 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round"${addAttribute(1.5, "stroke-width")} d="M19 9l-7 7-7-7"></path> </svg> </button> <div class="js-section-items space-y-2.5 pt-1 pb-4 pl-7"> ${section.items.map((item) => renderTemplate`<a${addAttribute(item.href, "href")}${addAttribute(cn(
    "js-menu-item flex items-center py-1.5",
    "text-stone-600 transition-colors hover:text-red-600"
  ), "class")}${addAttribute(item.href, "data-href")}> ${item.icon && renderTemplate`${renderComponent($$result2, "LucideIconCp", LucideIconCp, { "name": item.icon, "className": "w-3.5 h-3.5 mr-3 text-red-500/70" })}`} <span class="text-[14px] font-medium tracking-wide min-[380px]:text-[15px]">${item.title}</span> </a>`)} </div> </div>`)} </nav> </div> ${renderComponent($$result2, "BottomNav", $$BottomNav, {})} ${renderScript($$result2, "/root/code/tmd_astro/src/layouts/PageLayout.astro?astro&type=script&index=0&lang.ts")} `, "head": ($$result2) => renderTemplate`${renderSlot($$result2, $$slots["head"])}` })}`;
}, "/root/code/tmd_astro/src/layouts/PageLayout.astro", void 0);

export { $$PageLayout as $, GEMINI_AI_LINKS as G, VERSION_HORO as V, astroAssetsOptimizer as a, findImage as f, getImagesOptimized as g, isUnpicCompatible as i, unpicOptimizer as u };
