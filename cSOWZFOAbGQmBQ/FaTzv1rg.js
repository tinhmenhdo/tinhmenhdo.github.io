...
const CopySection = ({ title, content, btnId, onCopy, theme = "default" }) => /* @__PURE__ */ jsx("div", { className: "mt-4 md:mt-6", children: /* @__PURE__ */ jsxs(
  "div",
  {
    className: `rounded-md border-[0.5px] ${theme === "tet" ? "border-red-300 bg-red-50" : "border-gray-300 bg-gray-100"}`,
    children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          className: `flex h-9 items-center justify-between rounded-t-md px-4 py-2 font-sans text-xs select-none ${theme === "tet" ? "bg-red-200 text-red-900" : "bg-gray-200 text-black/85"}`,
          children: [
      ...
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
        "textarea",
        {
          className: `h-[120px] w-full resize-none overflow-y-auto border-none p-4 text-left font-mono text-xs leading-normal focus:outline-hidden md:h-[140px] ${theme === "tet" ? "bg-red-50 text-red-800 focus:bg-yellow-50" : "bg-gray-100 text-gray-600 focus:bg-yellow-100"}`,
          readOnly: true,
          value: content
        }
      ) })
...
`;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-4 w-full md:mt-8", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: `grid min-h-[250px] grid-cols-1 gap-2 rounded-lg text-center shadow-lg md:min-h-[400px] md:grid-cols-3 md:gap-4 ${theme === "tet" ? "bg-red-50 text-red-900" : "bg-white text-gray-800"}`,
        children: [
          /* @__PURE__ */ jsx(
            "div",
            {
...
const IChingDiagram = ({ prefixContent, theme = "default" }) => {
  ...
  React.useEffect(() => {
    ...
    const newStage = new Stage({
      ...
      listening: false
      // Disable hit detection — click handled by HTML button overlay
    });
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", style: { width: canvasSize.width, height: canvasSize.height }, children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: handleSpin,
            disabled: isSpinning,
            className: `absolute top-1/2 left-1/2 z-10 flex h-32 w-32 -translate-x-1/2 -translate-y-1/2 transform items-center justify-center rounded-full border-2 border-gray-300 opacity-0 shadow-lg transition-[opacity,background-color] disabled:cursor-not-allowed max-md:size-20 md:h-48 md:w-48 ${isSpinning ? "bg-black" : "cursor-pointer bg-white hover:bg-gray-50"}`,
    ...
    /* @__PURE__ */ jsxs("div", { className: "pt-10 text-center font-sans text-xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex justify-center py-5", children: /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          target: "_blank",
          className: "fire-btn group inline-flex items-center gap-2 rounded-xl px-6 py-3 text-lg font-bold text-white shadow-lg transition-[transform,box-shadow] duration-300 hover:scale-105 hover:shadow-2xl md:text-xl",
          children: [
