...
import { ChevronLeft, ChevronRight, Loader2, Star, ArrowRight, Clock, MapPin, Zap, Pencil, User } from 'lucide-react';
import { useState, useEffect, useMemo } from 'react';
import { L as LocalLunarCalendar, T as TrueSolarBaziEngine } from './CpgQb43x.js';
import { C as CitySearch } from './DiprJFgG.js';
import { M as MapPicker } from './zPSr96Kh.js';
...
var NHI_THAP_BAT_TU_ENUM = /* @__PURE__ */ ((NHI_THAP_BAT_TU_ENUM2) => {
  ...
  NHI_THAP_BAT_TU_ENUM2[NHI_THAP_BAT_TU_ENUM2["Chuy"] = 19] = "Chuy";
  NHI_THAP_BAT_TU_ENUM2[NHI_THAP_BAT_TU_ENUM2["Sam"] = 20] = "Sam";
  NHI_THAP_BAT_TU_ENUM2[NHI_THAP_BAT_TU_ENUM2["TinhWELL"] = 21] = "TinhWELL";
  NHI_THAP_BAT_TU_ENUM2[NHI_THAP_BAT_TU_ENUM2["Quy"] = 22] = "Quy";
  NHI_THAP_BAT_TU_ENUM2[NHI_THAP_BAT_TU_ENUM2["Lieu"] = 23] = "Lieu";
  NHI_THAP_BAT_TU_ENUM2[NHI_THAP_BAT_TU_ENUM2["TinhSTAR"] = 24] = "TinhSTAR";
...
var THAN_SAT_ENUM = /* @__PURE__ */ ((THAN_SAT_ENUM2) => {
  ...
  THAN_SAT_ENUM2["ThienAn"] = "Thiên Ân";
  THAN_SAT_ENUM2["VuongNhat"] = "Vượng Nhật";
  THAN_SAT_ENUM2["DaiHongSa"] = "Đại Hồng Sa";
  THAN_SAT_ENUM2["MauThuong"] = "Mẫu Thương";
  THAN_SAT_ENUM2["DichMa"] = "Dịch Mã";
  ...
  THAN_SAT_ENUM2["VangVong"] = "Vãng Vong";
  THAN_SAT_ENUM2["DiaTac"] = "Địa Tặc";
  THAN_SAT_ENUM2["ThienCau"] = "Thiên Cẩu";
  THAN_SAT_ENUM2["HoaTang"] = "Hỏa Tang";
  THAN_SAT_ENUM2["ThanCach"] = "Thần Cách";
  THAN_SAT_ENUM2["PhuSat"] = "Phủ Sát";
  THAN_SAT_ENUM2["HuyetChi"] = "Huyết Chi";
  THAN_SAT_ENUM2["HuyetKy"] = "Huyết Kị";
  THAN_SAT_ENUM2["HinhNguc"] = "Hình Ngục";
  THAN_SAT_ENUM2["HoaTinh"] = "Hỏa Tinh";
  THAN_SAT_ENUM2["MoKhoSat"] = "Mộ Khố Sát";
  THAN_SAT_ENUM2["NguyetHu"] = "Nguyệt Hư";
  THAN_SAT_ENUM2["NguyetSat"] = "Nguyệt Sát";
  THAN_SAT_ENUM2["NguHu"] = "Ngũ Hư";
  THAN_SAT_ENUM2["ThoPhu"] = "Thổ Phù";
  THAN_SAT_ENUM2["TuBatTuong"] = "Tứ Bất Tường";
  ...
  THAN_SAT_ENUM2["ThoPhu_Residence"] = "Thổ Phủ";
...
const STAR_SCORES = {
  ...
  [THAN_SAT_ENUM.SatChu]: {
    ...
    remedies: [
      { star: THAN_SAT_ENUM.ThienDuc, factor: 0.2 },
      { star: THAN_SAT_ENUM.NguyetDuc, factor: 0.2 },
      { star: THAN_SAT_ENUM.ThienXa, factor: 0.4 },
      { star: THAN_SAT_ENUM.GiaiThan, factor: 0.3 }
    ],
    advice: { avoid: ["DONG_THO", "CUOI_HOI", "KY_KET"] }
  },
  [THAN_SAT_ENUM.ThuTu]: {
    base: -40,
    type: "bad",
    actions: { WEDDING: -60, CONSTRUCTION: -60, BUSINESS: -40, XUAT_HANH: -40 },
    remedies: [
      { star: THAN_SAT_ENUM.ThienDuc, factor: 1 },
      { star: THAN_SAT_ENUM.NguyetDuc, factor: 1 },
  ...
  [THAN_SAT_ENUM.DuongCongKy]: {
    ...
    type: "bad",
    actions: { ALL: -60 },
    advice: { avoid: ["DONG_THO", "CUOI_HOI", "KHAI_TRUONG", "XUAT_HANH", "KY_KET"] }
  },
  [THAN_SAT_ENUM.ThienKhacDiaXung]: {
    base: -30,
    type: "bad",
    actions: { ALL: -40 },
    advice: { avoid: ["XUAT_HANH", "KY_KET", "DONG_THO", "CUOI_HOI", "KHAI_TRUONG"] }
  },
  ...
  [THAN_SAT_ENUM.ThienCuong]: {
    base: -25,
    type: "bad",
    actions: { WEDDING: -30, XUAT_HANH: -30 },
  ...
  [THAN_SAT_ENUM.HoangVu]: {
    ...
    advice: { avoid: ["DONG_THO", "NHAP_TRACH", "CUOI_HOI"] }
  },
  // --- HUNG TINH KHÁC ---
  [THAN_SAT_ENUM.TamNuong]: {
    base: -15,
    type: "bad",
    actions: { ALL: -20, WEDDING: -40, CONSTRUCTION: -30 },
    remedies: [
      { star: THAN_SAT_ENUM.ThienDuc, factor: 1 },
      { star: THAN_SAT_ENUM.NguyetDuc, factor: 1 },
      { star: THAN_SAT_ENUM.ThienXa, factor: 1 }
    ],
    advice: { avoid: ["CUOI_HOI", "KHAI_TRUONG", "DONG_THO"] }
  },
  [THAN_SAT_ENUM.NguyetKy]: {
    base: -15,
    type: "bad",
    actions: { XUAT_HANH: -30, WEDDING: -20, BUSINESS: -20, CONSTRUCTION: -20 },
    remedies: [
      { star: THAN_SAT_ENUM.ThienDuc, factor: 1 },
      { star: THAN_SAT_ENUM.NguyetDuc, factor: 1 }
    ],
    advice: { avoid: ["XUAT_HANH", "KHAI_TRUONG", "DONG_THO", "CUOI_HOI", "KY_KET", "DAU_TU"] }
  },
  [THAN_SAT_ENUM.TuLy_TuTuyet]: {
    base: -15,
    type: "bad",
    actions: { ALL: -20 },
    advice: { avoid: ["CUOI_HOI", "KY_KET", "DONG_THO", "KHAI_TRUONG", "DAU_TU", "XUAT_HANH"] }
  },
  // --- CÁT TINH ---
  [THAN_SAT_ENUM.NguyetDuc]: {
    base: 20,
    type: "good",
    actions: { ALL: 15, WEDDING: 20 },
    advice: { do: ["CUOI_HOI", "XUAT_HANH", "KY_KET", "TRI_BENH"] }
  },
  [THAN_SAT_ENUM.ThienXa]: {
    base: 20,
    type: "good",
    actions: { ALL: 20, SPIRITUAL: 25, LITIGATION: 25 },
    advice: { do: ["TE_LE", "TO_TUNG"] }
  },
  [THAN_SAT_ENUM.NguyetKhong]: { base: 10, type: "good", actions: { CONSTRUCTION: 15 }, advice: { do: ["DONG_THO"] } },
  [THAN_SAT_ENUM.SinhKhi]: {
    base: 15,
    type: "good",
    actions: { CONSTRUCTION: 20 },
    advice: { do: ["DONG_THO", "NHAP_TRACH"] }
  },
  [THAN_SAT_ENUM.ThienHy]: { base: 10, type: "good", actions: { WEDDING: 25 }, advice: { do: ["CUOI_HOI"] } },
  [THAN_SAT_ENUM.ThienDucHop]: {
    base: 5,
    type: "good",
    actions: { ALL: 10 },
    advice: { do: ["KY_KET", "KHAI_TRUONG", "TE_LE"] }
  },
  [THAN_SAT_ENUM.NguyetDucHop]: {
    base: 5,
    type: "good",
    actions: { BUSINESS: 15 },
    advice: { do: ["KY_KET", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.ThienAtQuyNhan]: {
    base: 15,
    type: "good",
    actions: { ALL: 15 },
    advice: { do: ["DAU_TU", "XUAT_HANH"] }
  },
  [THAN_SAT_ENUM.ThienLoc]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 20, EDUCATION: 15 },
    advice: { do: ["KHAI_TRUONG", "DAU_TU", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.LocKho]: {
    base: 8,
    type: "good",
    actions: { BUSINESS: 15 },
    advice: { do: ["THU_NO", "DAU_TU"] }
  },
  [THAN_SAT_ENUM.ThienPhu]: {
    base: 8,
    type: "good",
    actions: { BUSINESS: 15, CONSTRUCTION: 15 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO", "DAU_TU"] }
  },
  // ==========================================
  // VÒNG 12 THẦN HOÀNG ĐẠO / HẮC ĐẠO
  // ==========================================
  // 1. Hoàng Đạo (Tốt)
  [THAN_SAT_ENUM.ThanhLong]: {
    ...
    type: "good",
    actions: { ALL: 15 },
    advice: { do: ["XUAT_HANH", "CUOI_HOI"] }
  },
  [THAN_SAT_ENUM.MinhDuong]: {
    base: 15,
    type: "good",
    actions: { LITIGATION: 20, KHAI_TRUONG: 20 },
    advice: { do: ["KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.KimQuy]: {
    base: 15,
    type: "good",
    actions: { WEDDING: 20, BUSINESS: 20, CONSTRUCTION: 15 },
    advice: { do: ["CUOI_HOI", "NHAP_TRACH", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.ThienDuc]: {
    base: 20,
    type: "good",
    actions: { ALL: 15 },
    advice: { do: ["CUOI_HOI", "KHAI_TRUONG", "TE_LE"] }
  },
  [THAN_SAT_ENUM.NgocDuong]: {
    base: 15,
    type: "good",
    actions: { EDUCATION: 20, BUSINESS: 15 },
    advice: { do: ["NHAP_HOC", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.TuMenh]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, EDUCATION: 15 },
    advice: { do: ["KHAI_TRUONG", "NHAM_CHUC"] }
  },
  // --- CÁT TINH BỔ SUNG (có meaning nhưng chưa có scoring) ---
  [THAN_SAT_ENUM.ThaiDuong]: {
    base: 15,
    type: "good",
    actions: { EDUCATION: 20, BUSINESS: 15 },
    advice: { do: ["NHAM_CHUC", "NHAP_HOC", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.NguyetAn]: {
    base: 10,
    type: "good",
    actions: { SPIRITUAL: 15, ALL: 5 },
    advice: { do: ["TE_LE"] }
  },
  [THAN_SAT_ENUM.ThienGiai]: {
    base: 10,
    type: "good",
    actions: { TREATMENT: 20, LITIGATION: 15 },
    advice: { do: ["TRI_BENH", "TO_TUNG"] }
  },
  [THAN_SAT_ENUM.GiaiThan]: {
    base: 10,
    type: "good",
    actions: { LITIGATION: 20, BUSINESS: 10 },
    advice: { do: ["TO_TUNG", "KY_KET"] }
  },
  // 2. Hắc Đạo (Xấu)
  [THAN_SAT_ENUM.ThienHinh]: {
    base: -10,
    type: "bad",
    actions: { LITIGATION: -25, BUSINESS: -10 },
    remedies: [
      { star: THAN_SAT_ENUM.NgocDuong, factor: 0.7 },
      { star: THAN_SAT_ENUM.ThaiDuong, factor: 0.7 }
    ],
    advice: { avoid: ["TO_TUNG", "KY_KET"] }
  },
  [THAN_SAT_ENUM.ChuTuoc]: {
    base: -5,
    type: "bad",
    actions: { LITIGATION: -15, WEDDING: -10, BUSINESS: -10 },
  ...
  [THAN_SAT_ENUM.BachHo]: {
    base: -10,
    type: "bad",
    actions: { AN_TANG: -30, XUAT_HANH: -20 },
    remedies: [{ star: THAN_SAT_ENUM.ThienDuc, factor: 1 }],
    advice: { avoid: ["AN_TANG", "XUAT_HANH"] }
  },
  [THAN_SAT_ENUM.ThienLao]: {
    base: -5,
    type: "bad",
    actions: { EDUCATION: -15 },
    advice: { avoid: ["NHAM_CHUC", "NHAP_HOC"] }
  },
  [THAN_SAT_ENUM.NguyenVu]: {
    base: -5,
    type: "bad",
    actions: { BUSINESS: -15, RISKY_BUSINESS: -15 },
    advice: { avoid: ["KY_KET", "DAU_TU"] }
  },
  [THAN_SAT_ENUM.CauTran]: {
    base: -5,
    type: "bad",
    actions: { BUSINESS: -15 },
    advice: { avoid: ["KHAI_TRUONG", "KY_KET"] }
  },
  // --- HUNG TINH NHỎ KHÁC ---
  [THAN_SAT_ENUM.HuyenVu]: {
    base: -5,
    type: "bad",
    actions: { BUSINESS: -15, RISKY_BUSINESS: -15 },
    advice: { avoid: ["THU_NO", "DAU_TU", "MUA_XE"] }
  },
  // --- CHUYÊN BIỆT ---
  [THAN_SAT_ENUM.ThoPhu_Residence]: {
    base: -10,
    type: "bad",
    actions: { CONSTRUCTION: -40 },
    remedies: [
      { star: THAN_SAT_ENUM.ThienDuc, factor: 1 },
      { star: THAN_SAT_ENUM.SinhKhi, factor: 0.9 }
    ],
  ...
  [THAN_SAT_ENUM.ThienTac]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -20, BUSINESS: -40, XUAT_HANH: -40 },
    advice: { avoid: ["DONG_THO", "KHAI_TRUONG", "KY_KET", "THU_NO", "XUAT_HANH"] }
  },
  ...
  [THAN_SAT_ENUM.LucHop]: {
    base: 5,
    type: "good",
    actions: { WEDDING: 15, BUSINESS: 15 },
    advice: { do: ["KY_KET", "CUOI_HOI"] }
  },
  [THAN_SAT_ENUM.TamHop]: {
    base: 5,
    type: "good",
    actions: { WEDDING: 15, BUSINESS: 15 },
    advice: { do: ["KY_KET", "CUOI_HOI", "KHAI_TRUONG"] }
  },
  // --- BỔ SUNG TỪ REFACTOR ---
  // HÔN NHÂN (WEDDING)
  [THAN_SAT_ENUM.NguyetYem]: {
    base: -10,
    type: "bad",
    actions: { WEDDING: -40, SPIRITUAL: -20 },
    advice: { avoid: ["CUOI_HOI", "TE_LE"] }
  },
  [THAN_SAT_ENUM.NhanCach]: {
    base: -10,
    type: "bad",
    actions: { WEDDING: -30, BUSINESS: -20 },
    advice: { avoid: ["CUOI_HOI", "KHAI_TRUONG", "KY_KET"] }
  },
  [THAN_SAT_ENUM.IchHau]: {
    base: 10,
    type: "good",
    actions: { WEDDING: 20, SPIRITUAL: 15 },
    advice: { do: ["CUOI_HOI", "TE_LE"] }
  },
  [THAN_SAT_ENUM.TueHop]: {
    base: 10,
    type: "good",
    actions: { WEDDING: 20, BUSINESS: 15 },
    advice: { do: ["CUOI_HOI", "KY_KET"] }
  },
  // XÂY DỰNG / KINH DOANH (CONSTRUCTION / BUSINESS)
  [THAN_SAT_ENUM.ThoOn]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -50, AN_TANG: -40 },
    advice: { avoid: ["DONG_THO", "AN_TANG"] }
  },
  [THAN_SAT_ENUM.NguPhu]: {
    base: 10,
    type: "good",
    actions: { CONSTRUCTION: 20, BUSINESS: 20 },
    advice: { do: ["DONG_THO", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.ThienQuy]: {
    base: 10,
    type: "good",
    actions: { EDUCATION: 25, BUSINESS: 15 },
    advice: { do: ["NHAP_HOC", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.ThienThanh]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 15, WEDDING: 15 },
    advice: { do: ["KY_KET", "KHAI_TRUONG", "CUOI_HOI"] }
  },
  [THAN_SAT_ENUM.TieuHongSa]: {
    base: -10,
    type: "bad",
    actions: { XUAT_HANH: -25, BUSINESS: -20, TREATMENT: -25 },
    advice: { avoid: ["XUAT_HANH", "KHAI_TRUONG", "TRI_BENH"] }
  },
  [THAN_SAT_ENUM.DaiHao]: {
    base: -15,
    type: "bad",
    actions: { BUSINESS: -40, RISKY_BUSINESS: -40 },
    advice: { avoid: ["DAU_TU", "KHAI_TRUONG", "THU_NO"] }
  },
  // TÂM LINH (SPIRITUAL)
  [THAN_SAT_ENUM.ThienPhuc]: {
    base: 10,
    type: "good",
    actions: { SPIRITUAL: 20, EDUCATION: 15 },
    advice: { do: ["TE_LE", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.PhucSinh]: {
    base: 10,
    type: "good",
    actions: { SPIRITUAL: 20, AN_TANG: 15 },
    advice: { do: ["TE_LE", "AN_TANG"] }
  },
  [THAN_SAT_ENUM.QuyKhoc]: {
    base: -15,
    type: "bad",
    actions: { SPIRITUAL: -30, AN_TANG: -30 },
    advice: { avoid: ["TE_LE", "AN_TANG"] }
  },
  // KHÁC
  [THAN_SAT_ENUM.ThienMa]: {
    base: 10,
    type: "good",
    actions: { DAILY: 25, BUSINESS: 15, EDUCATION: 15 },
    advice: { do: ["XUAT_HANH", "MUA_XE", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.QuanNhat]: {
    base: 10,
    type: "good",
    actions: { EDUCATION: 20, BUSINESS: 15 },
    advice: { do: ["NHAM_CHUC", "NHAP_HOC"] }
  },
  [THAN_SAT_ENUM.MinhTinh]: {
    base: 10,
    type: "good",
    actions: { LITIGATION: 20, EDUCATION: 15 },
    advice: { do: ["TO_TUNG", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.NguyetHinh]: {
    base: -15,
    type: "bad",
    actions: { LITIGATION: -40, BUSINESS: -15 },
    advice: { avoid: ["TO_TUNG", "KY_KET"] }
  },
  // --- BỔ SUNG MỚI YÊU CẦU CÁC SAO ---
  [THAN_SAT_ENUM.ThienAn]: {
    base: 10,
    type: "good",
    actions: { SPIRITUAL: 20, EDUCATION: 15, BUSINESS: 15 },
    advice: { do: ["TE_LE", "NHAP_HOC", "DAU_TU"] }
  },
  [THAN_SAT_ENUM.VuongNhat]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 20 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO"] }
  },
  [THAN_SAT_ENUM.DaiHongSa]: {
    base: 15,
    type: "good",
    actions: { ALL: 15 },
    advice: { do: ["KHAI_TRUONG", "CUOI_HOI", "DONG_THO"] }
  },
  [THAN_SAT_ENUM.MauThuong]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 10 },
    advice: { do: ["KHAI_TRUONG", "DAU_TU"] }
  },
  [THAN_SAT_ENUM.DichMa]: {
    base: 15,
    type: "good",
    actions: { DAILY: 30, BUSINESS: 10 },
    advice: { do: ["XUAT_HANH", "MUA_XE"] }
  },
  [THAN_SAT_ENUM.VangVong]: {
    base: -25,
    type: "bad",
    actions: { DAILY: -60, BUSINESS: -30, NHAM_CHUC: -60 },
    advice: { avoid: ["XUAT_HANH", "NHAM_CHUC"] }
  },
  [THAN_SAT_ENUM.DiaTac]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -40, BUSINESS: -20 },
    advice: { avoid: ["DONG_THO", "NHAP_TRACH", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.ThienCau]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -25, SPIRITUAL: -20 },
    advice: { avoid: ["NHAP_TRACH", "TE_LE"] }
  },
  [THAN_SAT_ENUM.HoaTang]: {
    base: -10,
    type: "bad",
    actions: { CONSTRUCTION: -30 },
    advice: { avoid: ["DONG_THO", "NHAP_TRACH"] }
  },
  [THAN_SAT_ENUM.ThanCach]: {
    base: -10,
    type: "bad",
    actions: { SPIRITUAL: -30 },
    advice: { avoid: ["TE_LE"] }
  },
  [THAN_SAT_ENUM.PhuSat]: {
    base: -20,
    type: "bad",
    actions: { CONSTRUCTION: -40 },
    advice: { avoid: ["DONG_THO"] }
  },
  [THAN_SAT_ENUM.HuyetChi]: {
    base: -15,
    type: "bad",
    actions: { TREATMENT: -40, XUAT_HANH: -20 },
    advice: { avoid: ["TRI_BENH", "XUAT_HANH"] }
  },
  [THAN_SAT_ENUM.HuyetKy]: { base: -15, type: "bad", actions: { TREATMENT: -40 }, advice: { avoid: ["TRI_BENH"] } },
  [THAN_SAT_ENUM.HinhNguc]: { base: -15, type: "bad", actions: { LITIGATION: -40 }, advice: { avoid: ["TO_TUNG"] } },
  [THAN_SAT_ENUM.HoaTinh]: { base: -10, type: "bad", actions: { CONSTRUCTION: -20 }, advice: { avoid: ["DONG_THO"] } },
  [THAN_SAT_ENUM.MoKhoSat]: { base: -15, type: "bad", actions: { AN_TANG: -40 }, advice: { avoid: ["AN_TANG"] } },
  [THAN_SAT_ENUM.NguyetHu]: {
    base: -10,
    type: "bad",
    actions: { BUSINESS: -20, WEDDING: -20, CONSTRUCTION: -15, XUAT_HANH: -15 },
    advice: { avoid: ["KHAI_TRUONG", "CUOI_HOI", "DONG_THO", "XUAT_HANH"] }
  },
  [THAN_SAT_ENUM.NguyetSat]: {
    base: -15,
    type: "bad",
    actions: { XUAT_HANH: -30, WEDDING: -30 },
    advice: { avoid: ["XUAT_HANH", "CUOI_HOI"] }
  },
  [THAN_SAT_ENUM.NguHu]: {
    base: -10,
    type: "bad",
    actions: { CONSTRUCTION: -20, BUSINESS: -15 },
    advice: { avoid: ["DONG_THO", "KHAI_TRUONG"] }
  },
  [THAN_SAT_ENUM.ThoPhu]: { base: -10, type: "bad", actions: { CONSTRUCTION: -30 }, advice: { avoid: ["DONG_THO"] } },
  [THAN_SAT_ENUM.TuBatTuong]: { base: -10, type: "bad", actions: { WEDDING: -30 }, advice: { avoid: ["CUOI_HOI"] } }
};
const TRUC_SCORES = {
  [TRUC_ENUM.Thanh]: {
    base: 15,
    type: "good",
    actions: { CONSTRUCTION: 20, BUSINESS: 20, WEDDING: 20 },
    advice: { do: ["CUOI_HOI", "KHAI_TRUONG", "NHAP_TRACH"] }
  },
  [TRUC_ENUM.Khai]: {
    base: 15,
    type: "good",
  ...
  [TRUC_ENUM.Man]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 15, XUAT_HANH: 15, LITIGATION: -20, AN_TANG: -20 },
    advice: { do: ["KHAI_TRUONG", "DAU_TU", "XUAT_HANH"], avoid: ["TO_TUNG", "AN_TANG"] }
  },
  [TRUC_ENUM.Dinh]: {
    base: 10,
    type: "good",
    actions: { CONSTRUCTION: 10, BUSINESS: 15, EDUCATION: 20, LITIGATION: -20, XUAT_HANH: -15 },
    advice: { do: ["NHAP_HOC", "KY_KET", "DONG_THO"], avoid: ["TO_TUNG", "XUAT_HANH"] }
  },
  [TRUC_ENUM.Binh]: {
    base: 5,
    type: "good",
  ...
  [TRUC_ENUM.Kien]: {
    base: 5,
    type: "good",
    actions: { XUAT_HANH: 15, KHAI_TRUONG: 15, WEDDING: 15, CONSTRUCTION: -20 },
    advice: { do: ["XUAT_HANH", "CUOI_HOI", "KHAI_TRUONG"], avoid: ["DONG_THO"] }
  },
  [TRUC_ENUM.Chap]: {
    base: -5,
    type: "bad",
    actions: { LITIGATION: 15, XUAT_HANH: -20, CONSTRUCTION: -15 },
    advice: { do: ["TO_TUNG"], avoid: ["XUAT_HANH", "NHAP_TRACH"] }
  },
  [TRUC_ENUM.Nguy]: {
    base: -15,
    type: "bad",
    actions: { CONSTRUCTION: -30, RISKY_BUSINESS: -30, XUAT_HANH: -30, TE_LE: 15 },
    advice: { do: ["TE_LE"], avoid: ["XUAT_HANH", "DONG_THO", "CUOI_HOI", "DAU_TU"] }
  },
  [TRUC_ENUM.Pha]: {
    base: -20,
    type: "bad",
    actions: { WEDDING: -30, BUSINESS: -25, CONSTRUCTION: -30, EDUCATION: -25 },
    advice: { avoid: ["DONG_THO", "CUOI_HOI", "KHAI_TRUONG"] }
  },
  [TRUC_ENUM.Be]: {
    base: -15,
    type: "bad",
    actions: { BUSINESS: -30, TREATMENT: -30, WEDDING: -30, CONSTRUCTION: -20, DONG_THO: 10 },
    advice: { do: ["DONG_THO"], avoid: ["KHAI_TRUONG", "TRI_BENH", "CUOI_HOI"] }
  },
  [TRUC_ENUM.Thu]: {
    base: 5,
    type: "good",
    ...
    advice: { do: ["THU_NO"], avoid: ["AN_TANG", "KHAI_TRUONG"] }
  },
  [TRUC_ENUM.Tru]: {
    base: 5,
    type: "good",
    actions: { TREATMENT: 20, TE_LE: 20, LITIGATION: 15, WEDDING: -15, XUAT_HANH: -15 },
    advice: { do: ["TRI_BENH", "TE_LE", "TO_TUNG"], avoid: ["CUOI_HOI", "XUAT_HANH"] }
  }
};
const TU_SCORES = {
  [NHI_THAP_BAT_TU_ENUM.Giac]: {
    base: 10,
    type: "good",
    actions: { EDUCATION: 20, WEDDING: 15, CONSTRUCTION: 15 },
    advice: { do: ["NHAP_HOC", "CUOI_HOI", "DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Cang]: {
    base: -15,
    type: "bad",
    actions: { WEDDING: -30, CONSTRUCTION: -25, BUSINESS: 10 },
    remedies: [{ star: THAN_SAT_ENUM.ThienHy, factor: 0.7 }],
    advice: { do: ["KY_KET"], avoid: ["CUOI_HOI", "DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.De]: {
    base: 5,
    type: "good",
    actions: { BUSINESS: 15, WEDDING: 15, XUAT_HANH: -20 },
    advice: { do: ["DAU_TU", "CUOI_HOI"], avoid: ["XUAT_HANH"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Phong]: {
    base: 20,
    type: "good",
    actions: { CONSTRUCTION: 25, WEDDING: 25, BUSINESS: 25 },
    advice: { do: ["DONG_THO", "CUOI_HOI", "KHAI_TRUONG"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.Vi]: {
    base: 20,
    type: "good",
    actions: { BUSINESS: 25, CONSTRUCTION: 25, WEDDING: 25 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO", "CUOI_HOI"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Co]: {
    base: 10,
    type: "good",
    actions: { WEDDING: 15, SPIRITUAL: 15, CONSTRUCTION: -20, AN_TANG: -25 },
    advice: { do: ["CUOI_HOI", "TE_LE"], avoid: ["DONG_THO", "AN_TANG"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Dau]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 20, EDUCATION: 15 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO", "NHAM_CHUC"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Nguu]: {
    base: -5,
    type: "bad",
    actions: { XUAT_HANH: -25 },
    remedies: [{ star: THAN_SAT_ENUM.ThienMa, factor: 0.7 }],
  ...
  [NHI_THAP_BAT_TU_ENUM.Hu]: {
    base: -20,
    type: "bad",
    actions: { CONSTRUCTION: -40, WEDDING: -40, BUSINESS: -30 },
    remedies: [{ star: THAN_SAT_ENUM.LucHop, factor: 0.7 }],
    advice: { avoid: ["DONG_THO", "CUOI_HOI", "KHAI_TRUONG"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.That]: {
    base: 15,
    type: "good",
    actions: { CONSTRUCTION: 20, BUSINESS: 20 },
    advice: { do: ["KHAI_TRUONG", "DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Bich]: {
    base: 15,
    type: "good",
    actions: { CONSTRUCTION: 20, WEDDING: 20, EDUCATION: 20 },
    advice: { do: ["KHAI_TRUONG", "CUOI_HOI", "NHAP_HOC"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Khue]: {
    base: -15,
    type: "bad",
    actions: { WEDDING: -25, BUSINESS: -20, EDUCATION: 15 },
    remedies: [{ star: THAN_SAT_ENUM.ThienHy, factor: 0.7 }],
    advice: { do: ["NHAP_HOC"], avoid: ["KHAI_TRUONG", "CUOI_HOI"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Lau]: {
    base: 10,
    type: "good",
    actions: { EDUCATION: 20, CONSTRUCTION: -20 },
    advice: { do: ["NHAP_HOC", "NHAM_CHUC"], avoid: ["DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Vi_D]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 20, XUAT_HANH: -20 },
    advice: { do: ["KHAI_TRUONG", "DAU_TU"], avoid: ["XUAT_HANH"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Mao]: {
    ...
    remedies: [{ star: THAN_SAT_ENUM.ThienDuc, factor: 1 }],
    advice: { avoid: ["CUOI_HOI", "DONG_THO", "KHAI_TRUONG"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Tat]: {
    base: 15,
    type: "good",
    actions: { CONSTRUCTION: 20, BUSINESS: 20, WEDDING: 20 },
    advice: { do: ["CUOI_HOI", "KHAI_TRUONG", "DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Chuy]: {
    base: -15,
    type: "bad",
  ...
  [NHI_THAP_BAT_TU_ENUM.Sam]: {
    base: 10,
    type: "good",
    actions: { BUSINESS: 20, WEDDING: -20 },
    advice: { do: ["KHAI_TRUONG", "DAU_TU"], avoid: ["CUOI_HOI"] }
  },
  [NHI_THAP_BAT_TU_ENUM.TinhWELL]: {
    base: 15,
    type: "good",
    actions: { EDUCATION: 25 },
    advice: { do: ["NHAP_HOC", "NHAM_CHUC"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Quy]: {
    base: -20,
    type: "bad",
    actions: { AN_TANG: -40, WEDDING: -40 },
    remedies: [{ star: THAN_SAT_ENUM.ThienDuc, factor: 1 }],
    advice: { avoid: ["AN_TANG", "CUOI_HOI"] }
  },
  ...
  [NHI_THAP_BAT_TU_ENUM.TinhSTAR]: {
    base: 10,
    type: "good",
    actions: { CONSTRUCTION: 15, WEDDING: 15, AN_TANG: -25 },
    advice: { do: ["DONG_THO", "CUOI_HOI"], avoid: ["AN_TANG"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Truong]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, RISKY_BUSINESS: 15 },
    advice: { do: ["KHAI_TRUONG", "DAU_TU", "KY_KET"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Duc]: {
    base: 5,
    type: "good",
    actions: { XUAT_HANH: 15, BUSINESS: 10, CONSTRUCTION: -20 },
    advice: { do: ["XUAT_HANH", "KY_KET"], avoid: ["DONG_THO"] }
  },
  [NHI_THAP_BAT_TU_ENUM.Chan]: {
    base: 15,
    type: "good",
    actions: { BUSINESS: 20, CONSTRUCTION: 15, WEDDING: 20, EDUCATION: 20 },
    advice: { do: ["KHAI_TRUONG", "CUOI_HOI", "DONG_THO", "NHAP_HOC"] }
  }
};
({
  GOOD: [
...
const ACTIONS_CONFIG = [
  ...
  // --- NHÓM CẦU DANH / HỌC TẬP / SỰ NGHIỆP ---
  { id: "NHAP_HOC", category: "EDUCATION", label: "Nhập học / Thi cử / Cầu danh" },
  { id: "NHAM_CHUC", category: "EDUCATION", label: "Nhậm chức / Nhận việc" }
];
...
const NHI_THAP_BAT_TU_MEANING = {
  ...
  [NHI_THAP_BAT_TU_ENUM.Chuy]: "Xấu cho việc nhận chức, đầu tư, kỵ việc tranh chấp.",
  [NHI_THAP_BAT_TU_ENUM.Sam]: "Tốt cho cầu tài, kinh doanh, nhưng kỵ việc cưới hỏi.",
  [NHI_THAP_BAT_TU_ENUM.TinhWELL]: "Đại cát, tốt cho thi cử, thăng quan tiến chức.",
  ...
  [NHI_THAP_BAT_TU_ENUM.TinhSTAR]: "Tốt cho việc xây dựng, cưới hỏi, nhưng kỵ việc tang chế.",
...
const THAN_SAT_MEANING = {
  ...
  // --- MỚI BỔ SUNG YÊU CẦU ---
  [THAN_SAT_ENUM.ThienAn]: "Ơn trời ban, tốt cho việc cầu tài, cầu phúc, thi cử.",
  [THAN_SAT_ENUM.VuongNhat]: "Ngày khí cực thịnh, tốt cho việc khởi đầu, mở mang.",
  [THAN_SAT_ENUM.DaiHongSa]: "Sao cát tường độ hung giải tai, mọi việc đều lợi.",
  [THAN_SAT_ENUM.MauThuong]: "Sao chủ về sự sinh sôi, nảy nở, cực tốt cho khai trương, cầu tài.",
  [THAN_SAT_ENUM.DichMa]: "Sao chủ về di chuyển, đại lợi cho xuất hành, mua xe.",
  // ========================================================================
  ...
  [THAN_SAT_ENUM.VangVong]: "Lục bát vãng vong, cực kỵ cho việc xuất hành, nhậm chức.",
  [THAN_SAT_ENUM.DiaTac]: "Khí xấu sinh trộm cắp, ác kỵ xây dựng động thổ.",
  [THAN_SAT_ENUM.ThienCau]: "Hung tinh kỵ nhập trạch, cầu tự.",
  [THAN_SAT_ENUM.HoaTang]: "Khuyển hỏa sát, nguy cơ hỏa hoạn, kỵ lợp nhà làm mộc.",
  [THAN_SAT_ENUM.ThanCach]: "Ngăn cách với thần linh, kỵ tế lễ cúng bái.",
  [THAN_SAT_ENUM.PhuSat]: "Dạng thổ sát, rất kỵ động thổ.",
  // --- MỚI BỔ SUNG YÊU CẦU ---
  [THAN_SAT_ENUM.HuyetChi]: "Dễ gặp tai nạn, kỵ trị bệnh, dùng kéo dao.",
  [THAN_SAT_ENUM.HuyetKy]: "Dễ bị tổn thương huyết mạch, kỵ trị bệnh, châm cứu.",
  [THAN_SAT_ENUM.HinhNguc]: "Kỵ kiện tụng, dễ vướng vòng pháp luật.",
  [THAN_SAT_ENUM.HoaTinh]: "Có nguy cơ cháy nổ, kỵ lợp nhà, nấu bếp.",
  [THAN_SAT_ENUM.MoKhoSat]: "Khai quật phần mộ kỵ, xấu cho mai táng, an táng.",
  [THAN_SAT_ENUM.NguyetHu]: "Trăm việc đều hư hao, không thành tựu.",
  [THAN_SAT_ENUM.NguyetSat]: "Sát khí nguyệt lệnh, kỵ xuất hành, cưới hỏi.",
  [THAN_SAT_ENUM.NguHu]: "Khí ngũ hành suy bại, tránh khởi tạo việc mới.",
  [THAN_SAT_ENUM.ThoPhu]: "Thổ Phù cấm kỵ động thổ, phá hoại đất đai.",
  [THAN_SAT_ENUM.TuBatTuong]: "Tứ Bất Tường kỵ việc cưới gả.",
  // ========================================================================
  ...
  // ========================================================================
  [THAN_SAT_ENUM.ThoPhu_Residence]: "Thần đất ngăn trở, kỵ động thổ, xây dựng, sửa sang mặt bằng.",
...
function get12ZodiacOfficers(branchIndex) {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    const scoreDef = STAR_SCORES[starName];
    const isHoangDao = scoreDef ? scoreDef.type === "good" : false;
    const type = isHoangDao ? 1 : -1;
    result.push({
      branchIndex: i,
      // 0=Tý, 1=Sửu...
      starName,
...
const VIETNAMESE_HOLIDAYS = [
  // --- LỄ TẾT ÂM LỊCH ---
  {
    ...
    day: 1,
    month: 1,
    description: "Ngày đầu tiên của năm mới âm lịch, lễ hội lớn nhất trong năm của người Việt.",
    important: true
  },
  {
    id: "mung_2_tet",
    ...
    day: 2,
    month: 1,
    description: "Ngày thứ hai của Tết Nguyên Đán.",
    important: true
  },
  {
    id: "mung_3_tet",
    ...
    day: 3,
    month: 1,
    description: "Ngày thứ ba của Tết Nguyên Đán, hóa vàng.",
    important: true
  },
  {
    id: "chien_thang_ngoc_hoi",
    name: "Chiến thắng Ngọc Hồi - Đống Đa",
    type: "lunar",
    day: 5,
    month: 1,
    description: "Kỷ niệm chiến thắng lừng lẫy của vua Quang Trung - Nguyễn Huệ đại phá quân Thanh (1789).",
    important: true
  },
  {
    id: "le_hoi_chua_huong",
    name: "Khai hội Chùa Hương",
    type: "lunar",
    day: 6,
    month: 1,
    description: "Lễ hội kéo dài nhất trong năm tại Mỹ Đức, Hà Nội."
  },
  {
    id: "thuong_nguyen",
    ...
    day: 15,
    month: 1,
    description: "Rằm tháng Giêng, ngày lễ quan trọng cầu an lành cho cả năm.",
    important: true
  },
  {
    id: "hai_ba_trung",
    ...
    day: 6,
    month: 2,
    description: "Kỷ niệm cuộc khởi nghĩa của Hai Bà Trưng chống quân Đông Hán (40 SCN)."
  },
  {
    id: "han_thuc",
    name: "Tết Hàn Thực",
    ...
    day: 3,
    month: 3,
    description: "Tết bánh trôi bánh chay, tưởng nhớ người đã khuất.",
    important: false
  },
  {
    id: "phu_giay",
    name: "Lễ hội Phủ Giầy",
    type: "lunar",
    day: 3,
    month: 3,
    description: "Tôn vinh Thánh Mẫu Liễu Hạnh tại Nam Định."
  },
  {
    id: "gio_to",
    ...
    day: 10,
    month: 3,
    description: "Quốc giỗ, tưởng nhớ công ơn các Vua Hùng dựng nước.",
    important: true
  },
  {
    id: "phat_dan",
    ...
    day: 15,
    month: 4,
    description: "Kỷ niệm ngày sinh, thành đạo và nhập diệt của Đức Phật Thích Ca.",
    important: true
  },
  {
    id: "doan_ngo",
    ...
    day: 5,
    month: 5,
    description: "Tết diệt sâu bọ, ăn sứa, nếp cẩm, trái cây.",
    important: false
  },
  {
    id: "vu_lan",
    ...
    day: 15,
    month: 7,
    description: "Ngày xá tội vong nhân và báo hiếu cha mẹ.",
    important: true
  },
  {
    id: "con_son_kiep_bac",
    ...
    day: 16,
    month: 8,
    description: "Tưởng nhớ Anh hùng dân tộc Hưng Đạo Đại Vương Trần Quốc Tuấn."
  },
  {
    id: "trung_thu",
    name: "Tết Trung Thu",
    ...
    day: 15,
    month: 8,
    description: "Tết trẻ em, rước đèn, phá cỗ trông trăng.",
    important: true
  },
  {
    id: "trung_cuu",
    ...
    day: 9,
    month: 9,
    description: "Tết người cao tuổi, uống rượu hoa cúc, leo núi."
  },
  {
    id: "le_hoi_kate",
    name: "Lễ hội Katê",
    ...
    day: 1,
    month: 7,
    description: "Lễ hội lớn nhất của đồng bào Chăm."
  },
  {
    id: "ong_tao",
    ...
    day: 23,
    month: 12,
    description: "Cúng đưa ông Táo về trời báo cáo ngọc hoàng.",
    important: false
  },
  // --- LỊCH SỬ VIỆT NAM ---
  ...
  // các sự kiện xa xưa nếu có ngày âm chính xác sẽ để âm)
  {
    ...
    day: 9,
    month: 4,
    description: "Ngô Quyền đánh tan quân Nam Hán (938), mở ra kỷ nguyên độc lập. (Ngày dương lịch ước tính/kỷ niệm)"
  },
  {
    id: "ly_thai_to",
    name: "Lý Thái Tổ dời đô",
    type: "solar",
    day: 10,
    month: 10,
    description: "Vua Lý Thái Tổ dời đô về Thăng Long (1010), mở đầu thời kỳ huy hoàng của Đại Việt."
  },
  ...
  // --- LỄ DƯƠNG LỊCH & SỰ KIỆN HIỆN ĐẠI ---
  {
    ...
    day: 1,
    month: 1,
    description: "Ngày đầu năm mới theo lịch Gregory.",
    important: true
  },
  {
    id: "hssv",
    name: "Ngày HSSV Việt Nam",
    type: "solar",
    day: 9,
    month: 1,
  ...
  {
    id: "thay_thuoc",
    name: "Ngày Thầy thuốc VN",
    type: "solar",
    day: 27,
    month: 2,
    description: "Tôn vinh đội ngũ Y bác sĩ và cán bộ y tế."
  },
  {
    id: "bien_phong",
    name: "Ngày Biên phòng",
    type: "solar",
    day: 3,
    month: 3,
    description: "Ngày truyền thống Bộ đội Biên phòng (1959)."
  },
  {
    id: "quoc_te_phu_nu",
    name: "Quốc tế Phụ nữ",
  ...
  },
  {
    ...
    day: 26,
    month: 3,
    description: "Ngày thành lập Đoàn TNCS Hồ Chí Minh (1931)."
  },
  {
    id: "giai_phong",
    ...
    day: 30,
    month: 4,
    description: "Chiến thắng 30/4/1975, thống nhất đất nước.",
    important: true
  },
  {
    id: "lao_dong",
    ...
    day: 1,
    month: 5,
    description: "Ngày hội của giai cấp công nhân và nhân dân lao động.",
    important: true
  },
  {
    id: "dien_bien_phu",
    name: "Chiến thắng Điện Biên",
    type: "solar",
    day: 7,
    month: 5,
    description: 'Chiến thắng Điện Biên Phủ "lừng lẫy năm châu, chấn động địa cầu" (1954).',
    important: true
  },
  {
    id: "bac_ho",
  ...
  },
  {
    ...
    day: 1,
    month: 6,
    description: "Ngày Tết dành cho trẻ em.",
    important: false
  },
  {
    id: "bao_chi",
    name: "Báo chí Cách mạng",
    type: "solar",
    day: 21,
    month: 6,
    description: "Ngày Báo chí Cách mạng Việt Nam (1925)."
  },
  {
    id: "gia_dinh",
    name: "Ngày Gia Đình VN",
    type: "solar",
    day: 28,
    month: 6,
    description: "Ngày tôn vinh mái ấm gia đình Việt Nam."
  },
  {
    id: "thuong_binh",
  ...
  },
  {
    ...
    day: 19,
    month: 8,
    description: "Ngày truyền thống Công an Nhân dân Việt Nam (1945)."
  },
  {
    id: "cach_mang_t8",
    ...
    day: 19,
    month: 8,
    description: "Kỷ niệm Cách mạng tháng Tám thành công (1945).",
    important: true
  },
  {
    id: "quoc_khanh",
    ...
    day: 2,
    month: 9,
    description: "Bác Hồ đọc Tuyên ngôn Độc lập, khai sinh nước VNDCCH (1945).",
    important: true
  },
  {
    id: "mat_tran",
    ...
    day: 10,
    month: 9,
    description: "Ngày thành lập Mặt trận Tổ quốc Việt Nam (1955)."
  },
  {
    id: "thu_do",
    ...
    day: 10,
    month: 10,
    description: "Kỷ niệm ngày Giải phóng Thủ đô Hà Nội (1954).",
    important: true
  },
  {
    id: "doanh_nhan",
  ...
  },
  {
    ...
    day: 20,
    month: 10,
    description: "Ngày thành lập Hội Liên hiệp Phụ nữ Việt Nam (1930).",
    important: false
  },
  {
    id: "dai_doan_ket",
    ...
    day: 18,
    month: 11,
    description: "Ngày hội Đại đoàn kết toàn dân tộc."
  },
  {
    id: "nha_giao",
    ...
    day: 20,
    month: 11,
    description: "Ngày Hiến chương Nhà giáo Việt Nam, tôn sư trọng đạo.",
    important: false
  },
  {
    id: "hoi_chu_thap_do",
    ...
    day: 23,
    month: 11,
    description: "Ngày thành lập Hội Chữ thập đỏ Việt Nam (1946)."
  },
  {
    ...
    day: 19,
    month: 12,
    description: "Kỷ niệm ngày Toàn quốc kháng chiến (1946)."
  },
  {
    id: "quan_doi",
    ...
    day: 22,
    month: 12,
    description: "Ngày thành lập QĐND Việt Nam (1944) & Ngày hội Quốc phòng toàn dân.",
    important: true
  },
  {
    id: "noel",
    ...
    day: 24,
    month: 12,
    description: "Lễ Giáng sinh (Noel).",
    important: false
  },
  // ===========================================================================
  ...
  // ===========================================================================
  {
    ...
    day: 13,
    month: 1,
    description: "Lễ hội dân ca Quan họ lớn nhất vùng Kinh Bắc - Bắc Ninh."
  },
  {
    id: "le_hoi_den_tran",
    ...
    day: 14,
    month: 1,
    description: "Lễ khai ấn cầu mong quốc thái dân an, thăng tiến tại Nam Định."
  },
  {
    id: "le_hoi_yen_tu",
    name: "Khai hội Yên Tử",
    type: "lunar",
    day: 10,
    month: 1,
    description: "Lễ hội hành hương về đất Phật, nơi Phật hoàng Trần Nhân Tông tu hành."
  },
  // ===========================================================================
  ...
  {
    id: "world_war_1_end",
    name: "Kết thúc Thế chiến I",
    type: "solar",
    day: 11,
    month: 11,
    description: "Lễ đình chiến kết thúc cuộc chiến tranh tàn khốc đầu tiên quy mô toàn cầu (1918)."
  },
  {
    id: "world_war_2_end_asia",
    name: "Nhật Bản đầu hàng (WW2)",
    type: "solar",
    day: 15,
    month: 8,
    description: "Kết thúc hoàn toàn Chiến tranh Thế giới thứ hai trên toàn thế giới (1945)."
  },
  {
    ...
    day: 14,
    month: 7,
    description: "Ngày phá ngục Bastille, biểu tượng của Tự do - Bình đẳng - Bác ái."
  },
  {
    ...
    day: 4,
    month: 7,
    description: "Hợp chủng quốc Hoa Kỳ tuyên bố độc lập khỏi đế quốc Anh (1776)."
  },
  {
    id: "russian_october_revolution",
    name: "Cách mạng Tháng Mười Nga",
    type: "solar",
    day: 7,
    month: 11,
    description: "Cuộc cách mạng vô sản đầu tiên thắng lợi, khai sinh Liên bang Xô Viết (1917)."
  },
  {
    id: "first_man_in_space",
    name: "Con người đầu tiên bay vào vũ trụ",
    type: "solar",
    day: 12,
    month: 4,
    description: "Yuri Gagarin thực hiện chuyến bay lịch sử trên tàu Vostok 1 (1961)."
  },
  {
    id: "discovery_of_america",
    name: "Columbus tìm ra châu Mỹ",
    type: "solar",
    day: 12,
    month: 10,
    description: "Chuyến hải hành thay đổi hoàn toàn bản đồ thế giới và lịch sử nhân loại (1492)."
  },
  {
    id: "apollo_11_landing",
    name: "Apollo 11 hạ cánh xuống Mặt Trăng",
    type: "solar",
    day: 20,
    month: 7,
    description: "Neil Armstrong đặt bước chân đầu tiên của nhân loại lên một thiên thể khác (1969)."
  },
  {
    id: "fall_of_berlin_wall",
    name: "Bức tường Berlin sụp đổ",
    type: "solar",
    day: 9,
    month: 11,
    description: "Sự kiện chấm dứt sự chia cắt Đông - Tây Đức và biểu tượng kết thúc Chiến tranh Lạnh."
  },
  {
    id: "hiroshima_day",
    name: "Thảm họa Hiroshima",
    type: "solar",
    day: 6,
    month: 8,
    description: "Ngày quả bom nguyên tử đầu tiên dội xuống dân thường, lời nhắc nhở về hòa bình thế giới."
  },
  {
    id: "magna_carta_signed",
    name: "Ký kết Đại Hiến chương (Magna Carta)",
    type: "solar",
    day: 15,
    month: 6,
    description: "Văn bản đầu tiên hạn chế quyền lực quân chủ, nền tảng của luật pháp hiện đại (1215)."
  }
];
const getVietnameseHoliday = (lunaD, lunaM, solarD, solarM) => {
  ...
  if (lunaD === 1)
    return {
      ...
      day: 1,
      month: lunaM,
      description: "Ngày Sóc (đầu tháng âm lịch), thích hợp cầu an, lễ chùa."
    };
  if (lunaD === 15)
    return {
      id: "ram",
      ...
      day: 15,
      month: lunaM,
      description: "Ngày Vọng (giữa tháng âm lịch), trăng tròn, khí trường vượng."
    };
  return null;
};
...
const normalizeInput = (latOrProfile, lon, userDob, userGender = 1, userProfileOverride) => {
  ...
  if (userProfile) {
    const bornMoment = dayjs(
      new Date(userProfile.year, userProfile.month - 1, userProfile.day, userProfile.hour, userProfile.minute || 0)
    );
...
const get28Tu = (date) => {
  ...
  const index = ((18 + diffDays) % 28 + 28) % 28;
  return index;
};
...
const calculateShenSha = (input) => {
  ...
  if (chiDay === monthIdx) {
    hungTinh.push(THAN_SAT_ENUM.ThoPhu_Residence);
  }
  if (season === 1 /* XUAN */ && chiDay === CHI_ENUM.Than) hungTinh.push(THAN_SAT_ENUM.ThoPhu);
  if (season === 2 /* HA */ && chiDay === CHI_ENUM.Hoi) hungTinh.push(THAN_SAT_ENUM.ThoPhu);
  if (season === 3 /* THU */ && chiDay === CHI_ENUM.Dan) hungTinh.push(THAN_SAT_ENUM.ThoPhu);
  if (season === 4 /* DONG */ && chiDay === CHI_ENUM.Ti) hungTinh.push(THAN_SAT_ENUM.ThoPhu);
  const thoCamMap = {
  ...
  if (thoCamMap[chiMonth]?.includes(chiDay)) hungTinh.push(THAN_SAT_ENUM.ThoCam);
  ...
  const zodiacs = get12ZodiacOfficers(chiMonth);
  const zodiacOfficer = zodiacs.find((o) => o.branchIndex === chiDay);
  if (zodiacOfficer) {
    if (zodiacOfficer.isHoangDao) {
      catTinh.push(zodiacOfficer.starName);
    } else {
      hungTinh.push(zodiacOfficer.starName);
    }
  }
  const thienAnDates = [
    { c: CAN_ENUM.Giap, ch: CHI_ENUM.Ty },
    { c: CAN_ENUM.At, ch: CHI_ENUM.Mao },
    { c: CAN_ENUM.Binh, ch: CHI_ENUM.Thin },
    { c: CAN_ENUM.Dinh, ch: CHI_ENUM.Hoi },
    { c: CAN_ENUM.Mau, ch: CHI_ENUM.Tuat },
    { c: CAN_ENUM.Ky, ch: CHI_ENUM.Dau },
    { c: CAN_ENUM.Canh, ch: CHI_ENUM.Than },
    { c: CAN_ENUM.Tan, ch: CHI_ENUM.Mui },
    { c: CAN_ENUM.Nham, ch: CHI_ENUM.Ngo },
    { c: CAN_ENUM.Quy, ch: CHI_ENUM.Ti }
  ];
  if (thienAnDates.some((d) => d.c === canDay && d.ch === chiDay)) catTinh.push(THAN_SAT_ENUM.ThienAn);
  if (monthIdx === 0 && chiDay === CHI_ENUM.Mui) {
    catTinh.push(THAN_SAT_ENUM.VuongNhat, THAN_SAT_ENUM.DaiHongSa);
    hungTinh.push(
      THAN_SAT_ENUM.HuyetChi,
      THAN_SAT_ENUM.HuyetKy,
      THAN_SAT_ENUM.HinhNguc,
      THAN_SAT_ENUM.HoaTinh,
      THAN_SAT_ENUM.MoKhoSat,
      THAN_SAT_ENUM.NguyetHu,
      THAN_SAT_ENUM.NguyetSat,
      THAN_SAT_ENUM.NguHu,
      THAN_SAT_ENUM.ThoPhu,
      THAN_SAT_ENUM.TuBatTuong
    );
  }
  const isMauThuong = () => {
    if ([CHI_ENUM.Ty, CHI_ENUM.Dan, CHI_ENUM.Mao, CHI_ENUM.Mui].includes(chiMonth))
      return [CHI_ENUM.Hoi, CHI_ENUM.Ty].includes(chiDay);
    if ([CHI_ENUM.Suu, CHI_ENUM.Than, CHI_ENUM.Dau].includes(chiMonth))
      return [CHI_ENUM.Thin, CHI_ENUM.Tuat, CHI_ENUM.Suu, CHI_ENUM.Mui].includes(chiDay);
    if ([CHI_ENUM.Thin, CHI_ENUM.Tuat].includes(chiMonth)) return [CHI_ENUM.Than, CHI_ENUM.Dau].includes(chiDay);
    if ([CHI_ENUM.Ti, CHI_ENUM.Ngo, CHI_ENUM.Hoi].includes(chiMonth))
      return [CHI_ENUM.Dan, CHI_ENUM.Mao].includes(chiDay);
    return false;
  };
  if (isMauThuong()) catTinh.push(THAN_SAT_ENUM.MauThuong);
  const isDichMa = () => {
    if ([CHI_ENUM.Than, CHI_ENUM.Ty, CHI_ENUM.Thin].includes(chiMonth) && chiDay === CHI_ENUM.Dan) return true;
    if ([CHI_ENUM.Dan, CHI_ENUM.Ngo, CHI_ENUM.Tuat].includes(chiMonth) && chiDay === CHI_ENUM.Than) return true;
    if ([CHI_ENUM.Ti, CHI_ENUM.Dau, CHI_ENUM.Suu].includes(chiMonth) && chiDay === CHI_ENUM.Hoi) return true;
    if ([CHI_ENUM.Hoi, CHI_ENUM.Mao, CHI_ENUM.Mui].includes(chiMonth) && chiDay === CHI_ENUM.Ti) return true;
    return false;
  };
  if (isDichMa()) catTinh.push(THAN_SAT_ENUM.DichMa);
  const vangVongMap = [
    CHI_ENUM.Dan,
    CHI_ENUM.Ti,
    CHI_ENUM.Than,
  ...
  if (chiDay === vangVongMap[monthIdx]) hungTinh.push(THAN_SAT_ENUM.VangVong);
  const isDiaTac = () => {
    if ([CHI_ENUM.Dan, CHI_ENUM.Ngo, CHI_ENUM.Tuat].includes(chiMonth) && chiDay === CHI_ENUM.Suu) return true;
    if ([CHI_ENUM.Mao, CHI_ENUM.Mui, CHI_ENUM.Hoi].includes(chiMonth) && chiDay === CHI_ENUM.Ty) return true;
    if ([CHI_ENUM.Thin, CHI_ENUM.Than, CHI_ENUM.Ty].includes(chiMonth) && chiDay === CHI_ENUM.Hoi) return true;
    if ([CHI_ENUM.Ti, CHI_ENUM.Dau, CHI_ENUM.Suu].includes(chiMonth) && chiDay === CHI_ENUM.Tuat) return true;
    return false;
  };
  if (isDiaTac()) hungTinh.push(THAN_SAT_ENUM.DiaTac);
...
const resolveDayVerdict = (dayScore, affinity, processedBadStars) => {
...
const evaluatePersonalAffinity = (userYear, timeCan, timeChi) => {
...
const evaluateHourV2 = (hourChi, hourCan, dayChi, dayCan, monthChi, userProfile, userDungThan, hourZodiacOfficer) => {
  ...
  if (userProfile) {
    const affinityRes = evaluatePersonalAffinity(userProfile.year, hourCan, hourChi);
  ...
  if (hourZodiacOfficer) {
    if (hourZodiacOfficer.type > 0) {
      score += SCORING_CONFIG.MICRO.SCORES.HOANG_DAO;
      bonuses.push(`Giờ Hoàng Đạo (${hourZodiacOfficer.name})`);
    } else {
      score += SCORING_CONFIG.MICRO.SCORES.HAC_DAO;
      warnings.push(`Giờ Hắc Đạo (${hourZodiacOfficer.name})`);
    }
  }
  let rating = "Bình";
...
const generateAndScoreHours = (dayAttrs, dayScore, isCriticalBadDay, userContext) => {
  ...
  for (let h = 0; h < 12; h++) {
    ...
    const currentHourZodiacOfficer = zodiacOfficers.find((o) => o.branchIndex === h);
    const v2Result = evaluateHourV2(
      ...
      userProfile,
      userDungThan,
      currentHourZodiacOfficer ? { name: currentHourZodiacOfficer.starName, type: currentHourZodiacOfficer.type } : void 0
    );
    ...
    let finalCombinedScore = (hourScore - 50) * 1.5 + 50;
    finalCombinedScore = Math.max(0, Math.min(100, finalCombinedScore));
    ...
    const getDateForHour = (baseHour, shift) => {
      ...
      const totalMinutes = baseHour * 60 + shift;
...
const enrichRecommendationsWithHours = (recommendations, hours, isCriticalBadDay = false) => {
  return recommendations.map((action) => {
    ...
    const rankedHours = hours.map((h) => {
      ...
      const finalHourScore = action.score + (h.rawScore || 0) + actionBonus;
      return {
        chi: h.chi,
        can: h.can,
  ...
  static getRecommendations(dayAttrs, dayScoreResult) {
    ...
    ACTIONS_CONFIG.forEach((action) => {
      ...
      const specificGoodFactors = impacts.filter(
        ...
        // Significant boost over generic
      );
      ...
      let isGood = false;
      const hasHardVeto = specificBadFactors.some((i) => i.hasSpecificAdvice);
      const hasRescuedAvoid = impacts.some(
        (i) => i.hasSpecificAdvice && i.contextScore > -10 && i.contextScore <= 0
      );
      if (hasHardVeto) {
        shouldInclude = true;
        isGood = false;
      ...
      if (shouldInclude) {
        ...
        impacts.filter(
          (i) => i.contextScore < 0 && (i.isCritical || i.hasSpecificAdvice || i.isSpecific || i.contextScore <= -20) || i.hasSpecificAdvice && i.contextScore <= 0
        ).map((i) => i.factorName);
        const specificReasons = Array.from(
          new Set(
        ...
        const goodFactors = Array.from(
          new Set(
            impacts.filter((i) => i.contextScore > 0).sort((a, b) => b.contextScore - a.contextScore).map((i) => i.factorName)
          )
        );
        const badFactors = Array.from(
          new Set(
            impacts.filter((i) => i.contextScore < 0 || i.hasSpecificAdvice && i.contextScore <= 0).sort((a, b) => Math.abs(b.contextScore) - Math.abs(a.contextScore)).map((i) => {
              if (i.hasSpecificAdvice && i.contextScore === 0) return `${i.factorName} (Kỵ - đã giải)`;
              if (i.hasSpecificAdvice || i.isCritical) return `${i.factorName} (Kỵ)`;
              return i.factorName;
            })
          )
        );
    ...
    return activeBadStars.map((name) => {
      ...
      if (scoreDef && scoreDef.remedies && scoreDef.remedies.length > 0) {
        ...
        if (availableRemedies.length > 0) {
          const best = availableRemedies.reduce((prev, current) => prev.factor > current.factor ? prev : current);
          isRescued = true;
...
class ScoringEngine {
  static scoreDay(attrs, userContext) {
    ...
    const processedBadStars = RescueService.neutralize(
      [.../* @__PURE__ */ new Set([...badDays, ...thanSat.hung])],
      // Deduplicate bad stars
      thanSat.cat,
    ...
    if (userContext && userContext.baziChart) {
      ...
      const realAffinity = evaluatePersonalAffinity(userLunarYear, dayCanEnum, dayChiEnum);
...
const evaluateDay = (dateInput, latOrProfile, lon, userYearChi, userDob, userGender = 1, userProfileOverride) => {
  const { lat, long, validatedUserContext } = normalizeInput(
    latOrProfile,
    lon,
    userDob,
    userGender,
...
const MonthlyScoreCalendar = ({
  ...
  useEffect(() => {
    const fetchMonthData = async () => {
      ...
      try {
        ...
        const data = getMonthEvaluation(year, month, lat, lon, userYearChi, userDob, userGender);
        setMonthData(data);
      } catch (err) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-8 overflow-hidden rounded-2xl border border-stone-200 bg-white font-serif shadow-sm", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-stone-100 bg-gradient-to-r from-[#b91c1c] to-[#991b1b] px-6 py-4", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: prevMonth,
          className: "cursor-pointer rounded-full p-1 text-white/80 transition-colors hover:bg-white/10 hover:text-white",
          children: /* @__PURE__ */ jsx(ChevronLeft, { size: 28, strokeWidth: 2 })
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
        /* @__PURE__ */ jsx("span", { className: "mb-1 font-sans text-[10px] font-bold tracking-[0.2em] text-amber-200/90 uppercase", children: "Tháng Dương Lịch" }),
        /* @__PURE__ */ jsxs("time", { dateTime: viewDate.format("YYYY-MM"), className: "mt-0.5 text-2xl font-bold text-white uppercase", children: [
          "Tháng ",
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: nextMonth,
          className: "cursor-pointer rounded-full p-1 text-white/80 transition-colors hover:bg-white/10 hover:text-white",
          children: /* @__PURE__ */ jsx(ChevronRight, { size: 28, strokeWidth: 2 })
        }
      )
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-7 border-b border-stone-100 bg-stone-50", children: [
      { short: "T2", full: "Thứ 2" },
      { short: "T3", full: "Thứ 3" },
      { short: "T4", full: "Thứ 4" },
      { short: "T5", full: "Thứ 5" },
      ...
      "div",
      {
        className: "py-2 text-center font-sans text-[9px] font-bold tracking-wider text-stone-500 uppercase md:py-3 md:text-[10px]",
        children: [
          /* @__PURE__ */ jsx("span", { className: "md:hidden", children: d.short }),
          /* @__PURE__ */ jsx("span", { className: "hidden md:inline", children: d.full })
        ]
      },
      d.short
    )) }),
    /* @__PURE__ */ jsxs("div", { className: "relative grid auto-rows-[1fr] grid-cols-7 gap-px border-b border-stone-300 bg-stone-300", children: [
      ...
      blanks.map((_, i) => /* @__PURE__ */ jsx("div", { className: "min-h-[48px] bg-white md:min-h-[100px]" }, `blank-${i}`)),
      days.map((day) => {
        ...
        if (isSelected)
          cellStyle = {
            ...
            boxShadow: "inset 0 0 10px 1px #dda05bff",
            position: "relative",
            zIndex: 10
          };
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            style: cellStyle,
            className: `group relative flex min-h-[48px] cursor-pointer flex-col justify-between p-1 transition-all hover:brightness-95 md:min-h-[110px] md:p-3`,
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex h-full flex-col items-center justify-between md:hidden", children: [
                /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `font-serif text-sm leading-tight font-bold ${isToday ? "text-[#b91c1c]" : dateObj.day() === 0 ? "text-[#b91c1c]" : "text-stone-700"}`,
                    children: day
                  }
                ),
                isToday && /* @__PURE__ */ jsx("span", { className: "mt-0.5 h-1.5 w-1.5 rounded-full bg-red-500" }),
                /* @__PURE__ */ jsx("div", { className: "mt-0.5 flex flex-wrap justify-center gap-px", children: [...Array(stars)].map((_, i) => /* @__PURE__ */ jsx(Star, { size: 6, className: `${colors.star}`, fill: "currentColor", strokeWidth: 0 }, i)) }),
                holiday && /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `mt-0.5 line-clamp-1 w-full text-center text-[6px] leading-tight font-bold ${holiday.important ? "text-[#b91c1c]" : "text-stone-400"}`,
                    children: holiday.name
                  }
                ),
                evalData && /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `mt-auto text-[7px] leading-tight font-medium ${holiday && (holiday.important || holiday.type === "lunar") ? "text-[#b91c1c]" : "text-stone-400/70"}`,
                    children: lunarDayStr
                  }
                )
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "hidden h-full flex-col justify-between md:flex", children: [
                /* @__PURE__ */ jsx("div", { className: "flex w-full items-start justify-between", children: /* @__PURE__ */ jsxs(
                  "span",
                  {
                    className: `flex items-center gap-1 font-serif text-xl leading-none font-bold ${isToday ? "text-[#b91c1c]" : dateObj.day() === 0 ? "text-[#b91c1c]" : "text-stone-700"}`,
                    children: [
                      day,
                      day === 1 && /* @__PURE__ */ jsx("span", { className: "font-sans text-[9px] font-normal text-stone-400 uppercase", children: "DL" }),
                      isToday && /* @__PURE__ */ jsx("span", { className: "rounded bg-red-600 px-1 py-px font-sans text-[8px] font-bold tracking-tighter text-white uppercase", children: "Hôm nay" })
                    ]
                  }
                ) }),
                /* @__PURE__ */ jsxs("div", { className: "my-1 flex w-full flex-1 flex-col items-center justify-center gap-1 px-0.5", children: [
                  holiday && /* @__PURE__ */ jsx(
                    "span",
                    {
                      className: `w-full text-center text-[9px] font-bold break-words ${holiday.important ? "text-[#b91c1c]" : "text-stone-500"}`,
                      children: holiday.name
                    }
                  ),
                  /* @__PURE__ */ jsx("div", { className: "mt-0.5 flex gap-0.5 opacity-80 transition-opacity group-hover:opacity-100", children: [...Array(stars)].map((_, i) => /* @__PURE__ */ jsx(Star, { size: 10, className: `${colors.star}`, fill: "currentColor", strokeWidth: 0 }, i)) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "mt-auto flex w-full items-end justify-between", children: [
                  /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1" }),
                  evalData && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end", children: [
                    /* @__PURE__ */ jsx(
                      "span",
                      {
                        className: `text-[10px] font-bold ${holiday && (holiday.important || holiday.type === "lunar") ? "text-[#b91c1c]" : "text-stone-400/80"}`,
                        children: lunarDayStr
                      }
                    ),
                    (evalData.lunaInfo.d === 1 || evalData.lunaInfo.d === 15) && /* @__PURE__ */ jsxs("span", { className: "text-[8px] leading-none font-medium text-stone-500/70 uppercase", children: [
                      "Tháng ",
                      evalData.lunaInfo.m
                    ] })
                  ] })
...
const RecommendationCard = ({ rec, type }) => {
  const isGood = type === "good";
  const mainColor = isGood ? "text-[#15803d]" : "text-[#991b1b]";
  const borderColor = isGood ? "group-hover:border-[#15803d]/30" : "group-hover:border-[#991b1b]/30";
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: `group relative flex flex-col gap-3 rounded-lg border border-transparent p-4 ${borderColor} transition-colors hover:bg-gray-50/50`,
      children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-1 flex items-baseline justify-between border-b border-dashed border-[#e7e5e4] pb-2", children: [
          /* @__PURE__ */ jsx("h3", { className: `font-serif text-xl font-bold ${mainColor}`, children: rec.label }),
          /* @__PURE__ */ jsxs("span", { className: `font-serif text-xs font-bold tracking-widest uppercase opacity-70 ${mainColor}`, children: [
            rec.score,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm leading-relaxed", children: [
          rec.goodReason && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "min-w-[70px] shrink-0 font-bold text-[#15803d]", children: "Cát Thần:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: rec.goodReason })
          ] }),
          rec.badReason && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "min-w-[70px] shrink-0 font-bold text-[#b91c1c]", children: "Hung Thần:" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-700", children: rec.badReason })
          ] })
        ] }),
        rec.remedies && rec.remedies.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-1 rounded border border-green-100/50 bg-green-50/80 p-2 font-sans text-sm text-green-800 italic", children: [
          /* @__PURE__ */ jsx("span", { className: "mr-1 font-bold not-italic", children: "Hóa giải:" }),
          rec.remedies.map((r, idx) => /* @__PURE__ */ jsxs("span", { className: "mr-2", children: [
            /* @__PURE__ */ jsxs("span", { className: "font-semibold text-green-900", children: [
              r.star,
              ":"
            ] }),
            " ",
            r.remedy.toLowerCase(),
            idx < rec.remedies.length - 1 ? "." : ""
          ] }, idx))
        ] }),
        isGood && rec.bestHours && rec.bestHours.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-1 rounded border border-amber-100/50 bg-amber-50/50 p-2 font-serif text-sm text-gray-600", children: [
          /* @__PURE__ */ jsx("span", { className: "mr-1 font-bold text-[#b45309]", children: "Giờ tốt:" }),
...
const ActionRecommendations = ({ recommendations }) => {
  ...
  const badRecs = recommendations.filter((r) => !r.isGood).reverse();
  if (goodRecs.length === 0 && badRecs.length === 0) return null;
  return /* @__PURE__ */ jsx("div", { className: "mt-8 flex justify-center rounded-xl border border-gray-200 bg-white px-4 py-10 shadow-lg", children: /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative mb-8 text-center", children: [
      /* @__PURE__ */ jsx("span", { className: "relative z-10 bg-[#fdfbf7] px-6 font-serif text-xl font-bold tracking-[0.2em] text-[#8c3a3a] uppercase", children: "Lời Khuyên Hành Động" }),
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-0 h-px w-full bg-[#dca54c]/40" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-12", children: [
      goodRecs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsx("h4", { className: "flex items-center gap-2 border-b border-green-100 pb-2 font-serif text-lg font-bold tracking-widest text-[#15803d] uppercase", children: "Việc Nên Làm" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-x-12 gap-y-10 md:grid-cols-2", children: goodRecs.slice(0, 8).map((rec) => /* @__PURE__ */ jsx(RecommendationCard, { rec, type: "good" }, rec.id)) })
      ] }),
      badRecs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6", children: [
        /* @__PURE__ */ jsx("h4", { className: "flex items-center gap-2 border-b border-red-100 pb-2 font-serif text-lg font-bold tracking-widest text-[#b91c1c] uppercase", children: "Việc Cần Tránh" }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-x-12 gap-y-10 md:grid-cols-2", children: badRecs.slice(0, 6).map((rec) => /* @__PURE__ */ jsx(RecommendationCard, { rec, type: "bad" }, rec.id)) })
      ] })
    ] })
  ] }) });
};
...
const AgeClashSection = ({ clashingAges, userYearChi }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
    /* @__PURE__ */ jsx("h4", { className: "mb-3 inline-block border-b border-red-100 pb-1 font-serif text-sm font-bold tracking-wider text-[#b91c1c] uppercase", children: "Tuổi Xung Ngày (Nên Kiêng)" }),
    /* @__PURE__ */ jsx(
      "div",
      {
        className: `font-serif text-sm text-stone-700 ${clashingAges.length > 5 ? "columns-3 gap-x-6 md:columns-7" : "flex flex-wrap gap-x-4"}`,
        children: clashingAges.map((clash, idx) => {
          ...
          if (isUserMatch)
            className += "font-bold text-red-700 underline decoration-red-300 decoration-2 underline-offset-2";
...
const AgeHarmonySection = ({
  compatibleAges,
  userYearChi
}) => {
  if (!compatibleAges || compatibleAges.length === 0) return null;
  return /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
    /* @__PURE__ */ jsx("h4", { className: "mb-3 inline-block border-b border-green-100 pb-1 font-serif text-sm font-bold tracking-wider text-[#15803d] uppercase", children: "Tuổi Hợp Ngày (Cát Lợi)" }),
    /* @__PURE__ */ jsx(
      "div",
      {
        className: `font-serif text-sm text-stone-700 ${compatibleAges.length > 5 ? "columns-3 gap-x-6 md:columns-7" : "flex flex-wrap gap-x-4"}`,
        children: compatibleAges.map((harmony, idx) => {
          const isUserMatch = userYearChi && harmony.label.includes(userYearChi);
          const isStrong = harmony.score >= 5;
          let className = "break-inside-avoid py-0.5 ";
          if (isUserMatch)
            className += "font-bold text-green-700 underline decoration-green-300 decoration-2 underline-offset-2";
          else if (isStrong) className += "font-bold text-stone-900";
          else className += "text-stone-600";
...
const ZodiacHourClock = ({ hours, vocPeriods }) => {
    ...
    return /* @__PURE__ */ jsxs(
      "g",
      {
        ...
        children: [
          ...
          vocPeriods && vocPeriods.length > 0 && (() => {
            const clockHours = CHI_CLOCK_HOURS[index];
            const isVOC = clockHours.some((h) => vocPeriods.includes(`${h}:00`));
            if (!isVOC) return null;
            const dotPos = polarToCartesian(CENTER, CENTER, RADIUS - 12, startAngle + 15);
            return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("circle", { cx: dotPos.x, cy: dotPos.y, r: 4, fill: "#a855f7", stroke: "white", strokeWidth: 0 }) });
          })()
        ]
      },
      index
  ...
  const renderLabel = (index, angle, label, score, isHoangDao) => {
    ...
    return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
      "text",
      {
        ...
        className: `font-serif text-xs font-bold ${isHoangDao ? "fill-amber-700" : "fill-gray-600"}`,
        children: [
          label,
          isHoangDao && " ★"
        ]
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center", children: [
    /* @__PURE__ */ jsx("h3", { className: "text-md mb-4 font-bold tracking-wide text-gray-800 uppercase", children: "Giờ Hoàng Đạo" }),
    /* @__PURE__ */ jsx("div", { className: "relative", children: /* @__PURE__ */ jsxs("svg", { width: SIZE, height: SIZE, viewBox: `0 0 ${SIZE} ${SIZE}`, children: [
      ...
      hoveredIndex !== null ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs(
          ...
          {
            x: CENTER,
            y: hours[hoveredIndex].isHoangDao ? CENTER - 5 : CENTER,
            dominantBaseline: "middle",
            textAnchor: "middle",
            className: "fill-gray-800 text-sm font-bold uppercase",
            children: [
        ...
        hours[hoveredIndex].isHoangDao && /* @__PURE__ */ jsx(
          "text",
          {
            x: CENTER,
            y: CENTER + 12,
            textAnchor: "middle",
            className: "fill-amber-500 text-[9px] font-bold uppercase",
            children: "Hoàng Đạo"
          }
        )
      ] }) : /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx("div", { className: "mt-4 flex flex-col items-center gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center gap-2 text-[10px]", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 rounded-full bg-amber-300" }),
        " Bình Thường"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 rounded-full bg-orange-400" }),
        " Xấu"
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
      ...
      vocPeriods && vocPeriods.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 rounded-full bg-purple-500" }),
        " Moon VOC"
      ] })
    ] }) })
  ] });
...
const BaziDisplay = ({
  ...
  const renderPillar = (label, key) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center px-4 md:px-6", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-2 font-sans text-[10px] tracking-widest text-stone-400 uppercase", children: label }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
        /* @__PURE__ */ jsx("div", { className: `font-serif text-xl leading-none font-bold uppercase ${getElementTextColor(canEl)}`, children: canName }),
        /* @__PURE__ */ jsx("div", { className: `font-serif text-xl leading-none font-bold uppercase ${getElementTextColor(chiEl)}`, children: chiName })
      ] })
    ] }, key);
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-6 bg-transparent py-4", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        className: "group relative flex cursor-pointer items-center justify-center gap-2 rounded-lg py-5 transition-colors hover:bg-stone-50",
        onClick: onEdit,
        title: "Bấm để sửa ngày tháng năm sinh",
        children: [
          /* @__PURE__ */ jsx("h3", { className: "text-center font-serif text-lg font-bold text-[#1c1917] transition-colors group-hover:text-amber-700", children: "Bát Tự Mệnh Bàn" }),
          /* @__PURE__ */ jsx("span", { className: "-ml-1 text-xs text-stone-400 opacity-80 transition-opacity group-hover:opacity-50", children: "(Sửa)" })
        ]
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: "mb-3 grid grid-cols-4 divide-x divide-stone-200 border-b border-stone-100 pb-4", children: [
      renderPillar("Năm", "year"),
      renderPillar("Tháng", "month"),
      renderPillar("Ngày", "day"),
      renderPillar("Giờ", "hour")
    ] }),
    dungThan.dungThan !== void 0 && /* @__PURE__ */ jsxs("div", { className: "flex-warp flex flex-col items-center justify-center gap-2 font-serif text-sm", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex w-full justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-2 w-full px-8 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "mb-1 text-xs font-bold tracking-wide text-amber-700 uppercase", children: dungThan.pattern }),
        /* @__PURE__ */ jsx("div", { className: "text-[11px] leading-relaxed text-stone-500 italic", children: dungThan.description })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex w-full justify-center rounded-lg bg-orange-500/10 py-2 text-xs italic", children: [
        ...
        /* @__PURE__ */ jsx(
          "a",
          {
            ...
            target: "_blank",
            rel: "noreferrer",
            className: "ml-2 font-bold text-orange-600 transition-colors hover:text-orange-600",
            children: "Lá số tử vi & tứ trụ."
          }
        )
      ] })
    ] })
...
const isHourInVOC = (hourStartStr, vocPeriods) => {
  const match = hourStartStr.match(/(\d{2}):\d{2}$/);
  if (!match) return false;
  const h = parseInt(match[1], 10);
  return vocPeriods.includes(`${h}:00`) || vocPeriods.includes(`${h + 1}:00`);
};
const DailyHoursGrid = ({
  ...
  sao,
  astroWarnings,
  showAstroWarnings = false,
  showWesternWarnings = false
}) => {
  const saoName = typeof sao === "number" ? DATA.NHI_THAP_BAT_TU[sao] : sao;
  return /* @__PURE__ */ jsxs("div", { className: "prose prose-amber mx-auto mt-12 w-full max-w-none rounded-xl border border-gray-100 bg-white p-6 shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxs("p", { className: "mb-6 text-sm text-gray-500 italic", children: [
      "Giờ Tý bắt đầu từ 23h đêm hôm trước. Các giờ Hoàng Đạo được đánh dấu sao (",
      /* @__PURE__ */ jsx("span", { className: "text-amber-500", children: "★" }),
      ")."
    ] }),
    /* @__PURE__ */ jsx("div", { className: "grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-6", children: hours.map((h, idx) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          className: `rounded-xl border ${borderColor} ${bgColor} group relative flex flex-col gap-2 overflow-hidden p-3 transition-all hover:shadow-md`,
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxs("h4", { className: `font-serif text-base font-bold ${titleColor}`, children: [
                    "Giờ ",
                    h.can,
                    " ",
                    h.chi
                  ] }),
                  h.isHoangDao && /* @__PURE__ */ jsx("span", { className: "text-xs text-amber-500", title: "Hoàng Đạo", children: "★" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "mt-1", children: (() => {
                  ...
                  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
                    ...
                    isCrossDay && /* @__PURE__ */ jsxs("span", { className: "flex w-fit items-center gap-1 rounded border border-stone-200 bg-stone-100 px-1.5 py-0.5 text-xs text-stone-400", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-end gap-0.5", children: [
                /* @__PURE__ */ jsxs(
                  "span",
                  {
                    className: `text-[10px] font-bold tracking-wider uppercase ${h.score >= 50 ? "text-emerald-700" : "text-red-700"}`,
                    children: [
                      h.score,
                      "%"
                    ]
                ...
                /* @__PURE__ */ jsx("div", { className: "h-1 w-12 overflow-hidden rounded-full bg-gray-100", children: /* @__PURE__ */ jsx(
                  "div",
                  {
            ...
            /* @__PURE__ */ jsx("div", { className: `my-1 h-px w-full ${h.score >= 50 ? "bg-emerald-900/5" : "bg-red-900/5"}` }),
            /* @__PURE__ */ jsxs("ul", { className: "mt-0.5 space-y-0.5 pl-0", children: [
              h.tags.filter((t) => t !== "Hoàng Đạo" && t !== "Hắc Đạo").map((t, i) => {
                ...
                return /* @__PURE__ */ jsxs("li", { className: `flex items-center gap-1.5 text-xs leading-tight ${txtColor}`, children: [
                  /* @__PURE__ */ jsx("span", { className: `h-1 w-1 shrink-0 rounded-full ${dotColor}` }),
              ...
              (h.conflictDetails || []).map((d, i) => {
                ...
                const isNegativeKeyword = ["nhật phá", "xung", "kỵ", "hại", "hình", "sát", "tuyệt", "hắc đạo"].some(
                  (k) => lower.includes(k)
                );
                ...
                return /* @__PURE__ */ jsxs(
                  "li",
                  {
                    className: `flex items-center gap-1.5 text-xs leading-tight ${isPositive ? "text-emerald-700" : "text-red-700"}`,
                    children: [
                      /* @__PURE__ */ jsx(
                        "span",
                        {
                          className: `h-1 w-1 shrink-0 rounded-full ${isPositive ? "bg-emerald-500" : "bg-red-500"}`
                        }
                      ),
              ...
              astroWarnings && (() => {
                const warnings = [];
                const startTime = h.timeRange.split(" - ")[0];
                if (showAstroWarnings && astroWarnings.mr) {
                  warnings.push(
                    /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-1.5 text-xs leading-tight text-orange-600", children: [
                      /* @__PURE__ */ jsx("span", { className: "h-1 w-1 shrink-0 rounded-full bg-orange-500" }),
                      /* @__PURE__ */ jsx("span", { children: "☿ Thủy nghịch hành" })
                    ] }, "mr")
                  );
                }
                if (showAstroWarnings && astroWarnings.voc && astroWarnings.vp && astroWarnings.vp.length > 0) {
                  if (isHourInVOC(startTime, astroWarnings.vp)) {
                    warnings.push(
                      /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-1.5 text-xs leading-tight text-purple-600", children: [
                        /* @__PURE__ */ jsx("span", { className: "h-1 w-1 shrink-0 rounded-full bg-purple-500" }),
                        /* @__PURE__ */ jsx("span", { children: "Moon VOC" })
                      ] }, "voc")
                    );
                  }
                }
                if (showWesternWarnings && astroWarnings.f13) {
                  warnings.push(
                    /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-1.5 text-xs leading-tight text-rose-600", children: [
                      /* @__PURE__ */ jsx("span", { className: "h-1 w-1 shrink-0 rounded-full bg-rose-500" }),
                      /* @__PURE__ */ jsx("span", { children: "☠ Thứ 6 ngày 13" })
                    ] }, "f13")
                  );
                }
...
const LocationPanel = ({
  ...
  return /* @__PURE__ */ jsx("aside", { className: "fixed inset-y-0 left-0 z-50 w-full transform border-r border-gray-200 bg-white shadow-xl transition-transform ease-in-out md:w-[400px]", children: /* @__PURE__ */ jsxs("div", { className: "max-h-screen overflow-y-auto p-4 sm:p-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center justify-between", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold text-gray-900", children: "Chọn Địa Điểm" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: onClose,
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative z-[99] mb-4", children: [
      /* @__PURE__ */ jsx("label", { className: "text-md mb-2 block font-medium text-gray-700", children: "Tìm thành phố" }),
      /* @__PURE__ */ jsx(CitySearch, { onCitySelect: handleCitySelect, className: "" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "relative z-[10] mb-4", children: /* @__PURE__ */ jsx(
      MapPicker,
      {
        mapCenter,
        zoom,
...
const UserProfilePanel = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex justify-end", children: [
    ...
    /* @__PURE__ */ jsxs("aside", { className: "relative z-10 w-full max-w-md transform overflow-y-auto bg-white p-6 shadow-2xl transition-transform", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center justify-between border-b pb-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-gray-900", children: "Thông Tin Cá Nhân" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: onClose,
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "text-md mb-2 block font-bold text-gray-700", children: "Giới tính" }),
        ...
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
          DateTimePicker,
          {
            ...
            classNames: {
              ...
              label: "mb-2 block text-md font-bold text-gray-700"
            }
          }
        ) }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "text-md mb-2 block font-bold text-gray-700", children: "Nơi sinh (Quan trọng để tính Bát Tự)" }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [
            ...
            ] }) : /* @__PURE__ */ jsx("div", { className: "text-md mb-3 text-gray-500 italic", children: "Chưa chọn nơi sinh" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
                onClick: onPickLocation,
                className: "text-md flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 font-medium text-gray-700 hover:bg-gray-50",
                children: [
...
function NgayTotXauApp({
  ...
  const [filters, setFilters] = useState({
    ...
    showHours: true,
    showAdvice: true,
    showAgeConflicts: true,
    filterAstrology: true,
    filterWesternBadDays: true
  });
  const [astroData, setAstroData] = useState([]);
  const [currentDate, setCurrentDateTime] = useState(() => {
    if (initialDateStr) return dayjs(initialDateStr);
  ...
  useEffect(() => {
    ...
    fetch(`/astroinfo/astrology_${year}.json`).then((res) => {
      if (!res.ok) throw new Error("Not found");
      return res.json();
    }).then((data) => {
      setAstroData(data);
    }).catch((err) => {
      console.warn(`[NgayTotXauApp] No astrology data found for year ${year}`);
      setAstroData([]);
    });
  }, [currentDate.year()]);
  const dayInfo = useMemo(() => {
    return astroData.find((item) => item.d === currentDate.format("YYYY-MM-DD"));
  }, [currentDate, astroData]);
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && evaluation) {
      const displayDate2 = dayjs(evaluation.date).format("DD/MM/YYYY");
      const newTitle = `Lịch Vạn Niên ${displayDate2} - Xem Lịch Âm Dương, Giờ Tốt Xấu Ngày ${lunaInfo.d}/${lunaInfo.m}`;
      document.title = newTitle;
    }
  }, [evaluation, lunaInfo]);
  const energyColor = getEnergyColor(gaugeScore);
  const scorePercent = Math.min(100, Math.max(0, gaugeScore));
  const displayDate = dayjs(evaluation.date).format("DD/MM/YYYY");
  const dateStr = dayjs(evaluation.date).format("YYYY-MM-DD");
  return /* @__PURE__ */ jsxs(MantineProvider, { children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto min-h-screen w-full", children: [
      showHeader && /* @__PURE__ */ jsxs("div", { className: "mb-10 text-center", children: [
        /* @__PURE__ */ jsxs("h1", { className: "mb-4 text-3xl font-bold text-amber-800 md:text-4xl", children: [
          "Lịch Vạn Niên ",
          displayDate,
          " - Xem Ngày Giờ Tốt Xấu"
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "mx-auto max-w-2xl text-lg text-gray-600", children: [
          "Chi tiết ngày1 ",
          /* @__PURE__ */ jsx("time", { dateTime: dateStr, children: displayDate }),
          " (Âm lịch: ",
          lunaInfo.d,
          "/",
          lunaInfo.m,
          ") theo lịch vạn niên và tiết khí."
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "text-lg text-gray-600", children: [
          /* @__PURE__ */ jsx("strong", { children: "Kinh điển Đông Phương" }),
          ": Áp dụng hệ thống Hiệp Kỷ Biện Phương Thư, tính toán chuẩn theo tiết khí thực và tọa độ địa lý.",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("strong", { children: "Cá nhân hóa tuyệt đối" }),
          ": Tính năng cao cấp phân tích cát hung dựa trên giờ sinh riêng biệt của mỗi người.",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("strong", { children: "Bộ lọc Phương Tây" }),
          ": Tự động loại bỏ các ngày xấu theo Chiêm tinh (Sao Thủy nghịch hành, Moon Void of Course) và các ngày kiêng kỵ phương Tây (Thứ 6 ngày 13).",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("strong", { children: "Đồng bộ hệ thống" }),
          ": Cập nhật dữ liệu thời gian thực, đảm bảo độ chính xác tuyệt đối cho mọi quyết định đại sự.",
          /* @__PURE__ */ jsx("br", {})
        ] }),
        /* @__PURE__ */ jsxs("p", { className: "text-lg text-gray-600", children: [
          "Cách xem ngày giờ tốt xấu là ưu tiên xem từ Ngày trước, rồi đến Giờ. Nếu không có cơ hội chọn được ngày thì hãy ưu tiên chọn Giờ. ",
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("strong", { className: "text-md text-amber-800/80 italic", children: "Ngày tốt nhất là ngày bạn có sự chuẩn bị tốt nhất. Tuy nhiên, nếu biết kết hợp giữa nỗ lực cá nhân và nhịp điệu tự nhiên, bạn sẽ có thêm một luồng gió hỗ trợ." })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mx-auto mb-6 w-full rounded-xl border border-stone-200 bg-white p-5 shadow-sm", children: [
        /* @__PURE__ */ jsx("h3", { className: "mb-4 flex items-center gap-2 border-b border-stone-100 pb-2 font-serif text-lg font-bold text-amber-900", children: "Tùy Chọn Hiển Thị Cát Hung" }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3", children: [
          /* @__PURE__ */ jsxs("label", { className: "flex cursor-not-allowed items-center gap-2 opacity-70", children: [
            /* @__PURE__ */ jsx("input", { type: "checkbox", checked: filters.eastern, disabled: true, className: "h-4 w-4" }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-stone-700", children: "Bộ Lọc Phương Đông (Mặc định)" })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                onChange: (e) => setFilters({ ...filters, showHours: e.target.checked }),
                className: "h-4 w-4 accent-amber-600"
              }
            ),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-stone-700", children: "Chế Độ Xem Giờ" })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                checked: filters.showAdvice,
                onChange: (e) => setFilters({ ...filters, showAdvice: e.target.checked }),
                className: "h-4 w-4 accent-amber-600"
              }
            ),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-stone-700", children: "Hiện Lời Khuyên Hành Động" })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                checked: filters.showAgeConflicts,
                onChange: (e) => setFilters({ ...filters, showAgeConflicts: e.target.checked }),
                className: "h-4 w-4 accent-amber-600"
              }
            ),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-stone-700", children: "Hiện Tuổi Xung / Tuổi Hợp" })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                checked: filters.filterAstrology,
                onChange: (e) => setFilters({ ...filters, filterAstrology: e.target.checked }),
                className: "h-4 w-4 accent-amber-600"
              }
            ),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-stone-700", children: "Bộ Lọc Chiêm Tinh Học" })
          ] }),
          /* @__PURE__ */ jsxs("label", { className: "flex cursor-pointer items-center gap-2", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
                checked: filters.filterWesternBadDays,
                onChange: (e) => setFilters({ ...filters, filterWesternBadDays: e.target.checked }),
                className: "h-4 w-4 accent-amber-600"
              }
            ),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-stone-700", children: "Bộ Lọc Ngày Xấu Phương Tây" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx(
      ...
      (filters.filterAstrology || filters.filterWesternBadDays) && dayInfo && /* @__PURE__ */ jsxs("div", { className: "mx-auto mb-6 w-full space-y-3", children: [
        filters.filterAstrology && !!dayInfo.mr && /* @__PURE__ */ jsx("div", { className: "flex items-start gap-4 rounded-xl border border-orange-200 bg-orange-50 p-4 shadow-sm", children: /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-orange-900", children: "Cảnh báo: Sao Thủy Nghịch Hành (Mercury Retrograde)" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-sm leading-relaxed text-orange-800", children: "Giai đoạn này dễ xảy ra trục trặc về giao tiếp, thông tin liên lạc chậm trễ, sự cố công nghệ, thiết bị điện tử hoặc rắc rối trong việc ký kết hợp đồng. Cẩn trọng khi đưa ra quyết định bắt đầu dự án mới, chuyển việc hoặc mua sắm đồ vật có giá trị cao." }),
          /* @__PURE__ */ jsx("p", { className: "text-orange-500 italic", children: "Phần này kết hợp tránh cả thời gian xấu của chiêm tinh và phương tây, nếu bạn chỉ tránh ngày xấu phương đông có thể bỏ check ở trên." })
        ] }) }),
        filters.filterAstrology && !!dayInfo.voc && /* @__PURE__ */ jsx("div", { className: "flex items-start gap-4 rounded-xl border border-purple-200 bg-purple-50 p-4 shadow-sm", children: /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-purple-900", children: "Cảnh báo: Mặt Trăng Vô Hướng (Moon Void of Course) Moon VOC" }),
          /* @__PURE__ */ jsxs("p", { className: "mt-1.5 text-sm leading-relaxed text-purple-800", children: [
            "Ảnh hưởng trong các khoảng thời gian:",
            " ",
            /* @__PURE__ */ jsx("strong", { className: "rounded bg-purple-100 px-2 py-0.5", children: dayInfo.vp.join(", ") }),
            /* @__PURE__ */ jsx("br", {}),
            "Theo Chiêm tinh học, thời gian này mang năng lượng không định hướng, sự việc dễ đi chệch quỹ đạo. Không nên đưa ra quyết định quan trọng, bắt đầu việc mới hay ký kết hợp đồng. Đây là thời điểm thích hợp để nghỉ ngơi, dọn dẹp, nhìn nhận lại bản thân hoặc hoàn thiện các công việc đang dang dở."
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-orange-500 italic", children: "Phần này kết hợp tránh cả thời gian xấu của chiêm tinh và phương tây, nếu bạn chỉ tránh ngày xấu phương đông có thể bỏ check ở trên." })
        ] }) }),
        filters.filterWesternBadDays && !!dayInfo.f13 && /* @__PURE__ */ jsx("div", { className: "flex items-start gap-4 rounded-xl border border-rose-200 bg-[#fff1f2] p-4 shadow-sm", children: /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h4", { className: "text-base font-bold text-rose-900", children: "Kiêng Kỵ Phương Tây: Thứ 6 Ngày 13" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-sm leading-relaxed text-rose-800", children: "Ngày này gắn liền với nhiều sự tích, quan niệm xui xẻo trong văn hóa phương Tây. Tránh những hành động liều lĩnh, đầu tư mạo hiểm hoặc những bắt đầu mang tính rủi ro cao vào ngày hôm nay." }),
          /* @__PURE__ */ jsx("p", { className: "text-orange-500 italic", children: "Phần này kết hợp tránh cả thời gian xấu của chiêm tinh và phương tây, nếu bạn chỉ tránh ngày xấu phương đông có thể bỏ check ở trên." })
        ] }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mx-auto mb-2 w-full py-5", children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-lg", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col items-start justify-start md:flex-row", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col border-r border-stone-100 bg-white md:w-5/12", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative flex items-center justify-between overflow-hidden bg-[#b91c1c] px-3 py-3 text-white", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => handleDateChange(currentDate.subtract(1, "day")),
                className: "rounded-full p-1 transition-colors hover:bg-black/10",
                children: /* @__PURE__ */ jsx(ChevronLeft, { size: 24 })
              }
            ),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-[0.2em] text-amber-100 uppercase opacity-80", children: "Lịch Vạn Sự" }),
              /* @__PURE__ */ jsx("div", { className: "font-serif text-lg font-bold tracking-widest text-white uppercase", children: dayOfWeek })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => handleDateChange(currentDate.add(1, "day")),
                className: "rounded-full p-1 transition-colors hover:bg-black/10",
                children: /* @__PURE__ */ jsx(ChevronRight, { size: 24 })
              }
            )
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col items-center justify-start px-6 pt-8 pb-4", children: [
            /* @__PURE__ */ jsx(
              "time",
              {
                className: `font-serif text-[8rem] leading-[0.8] font-bold tracking-tighter ${evaluation.date.getDay() === 0 || score < 40 ? "text-[#b91c1c]" : "text-stone-800"}`,
                children: evaluation.date.getDate()
              }
            ),
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-8 w-full px-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-1 flex items-end justify-between", children: [
                /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-xs font-bold tracking-widest text-stone-400 uppercase", children: [
                ...
                /* @__PURE__ */ jsxs(
                  "span",
                  {
                    className: `font-serif text-2xl font-bold ${gaugeScore >= 50 ? "text-stone-700" : "text-red-600"}`,
                    children: [
                      gaugeScore,
                      "%"
                    ]
              ...
              /* @__PURE__ */ jsx("div", { className: "h-3 w-full overflow-hidden rounded-full bg-stone-100 shadow-inner", children: /* @__PURE__ */ jsx(
                "div",
                {
                  className: `h-full transition-all duration-700 ease-out ${energyColor}`,
                  style: { width: `${scorePercent}%` }
                }
              ) }),
              /* @__PURE__ */ jsxs("div", { className: "mt-1 flex justify-between text-[10px] font-bold text-stone-300 uppercase", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "mt-6 flex gap-3", children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: "flex cursor-pointer items-center gap-1.5 rounded-full border border-stone-200 bg-stone-100 px-3 py-1.5 text-xs font-medium text-stone-600 transition-colors hover:bg-amber-100",
                  children: [
              ...
              /* @__PURE__ */ jsxs(
                "button",
                {
                  ...
                  className: `flex cursor-pointer items-center gap-1.5 rounded-full border border-stone-200 px-3 py-1.5 text-xs font-medium transition-colors ${userDob ? "bg-amber-100 text-amber-800" : "bg-stone-100 text-stone-600 hover:bg-amber-50"}`,
                  children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "border-t border-b border-dashed border-stone-200 bg-[#fffdfa] p-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-5 flex flex-col items-center", children: [
              /* @__PURE__ */ jsxs("span", { className: "mb-1 font-serif text-xs font-bold tracking-widest text-stone-400 uppercase", children: [
                "Âm Lịch năm ",
                /* @__PURE__ */ jsx("span", { className: getCanColor(lunaInfo.ycc[0]), children: lunaInfo.ycc[0] }),
                " ",
                /* @__PURE__ */ jsx("span", { className: getChiColor(lunaInfo.ycc[1]), children: lunaInfo.ycc[1] })
              ...
              (() => {
                ...
                if (holiday) {
                  return /* @__PURE__ */ jsxs(
                    "div",
                    {
                      className: `mt-3 rounded-lg px-3 py-2 text-center ${holiday.important ? "border border-red-100 bg-red-50" : "border border-amber-100 bg-amber-50"}`,
                      children: [
                        /* @__PURE__ */ jsx(
                          "div",
                          {
                            className: `mb-0.5 text-sm font-bold tracking-wide uppercase ${holiday.important ? "text-red-700" : "text-amber-800"}`,
                            children: holiday.name
                          }
                        ),
                        holiday.description && /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-[180px] text-[10px] leading-snug text-stone-600 opacity-90", children: holiday.description })
                      ]
                    }
                  );
                }
            ...
            /* @__PURE__ */ jsx("div", { className: "mb-4 h-px w-full bg-stone-100" }),
            (() => {
              ...
              if (isMismatch) {
                return /* @__PURE__ */ jsx("div", { className: "mb-4 rounded-lg border border-amber-100/50 bg-amber-50/50 p-3", children: /* @__PURE__ */ jsxs("p", { className: "text-center font-serif text-[11px] leading-relaxed text-stone-500", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-2 text-center", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-wider text-stone-300 uppercase", children: "Năm" }),
                /* @__PURE__ */ jsxs("span", { className: "font-serif text-lg font-bold", children: [
                  /* @__PURE__ */ jsx("span", { className: getCanColor(lunaInfo.stcc.ycc[0]), children: lunaInfo.stcc.ycc[0] }),
                  " ",
                  /* @__PURE__ */ jsx("span", { className: getChiColor(lunaInfo.stcc.ycc[1]), children: lunaInfo.stcc.ycc[1] })
                ] })
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-wider text-stone-300 uppercase", children: "Tháng" }),
                /* @__PURE__ */ jsxs("span", { className: "font-serif text-lg font-bold", children: [
                  /* @__PURE__ */ jsx("span", { className: getCanColor(lunaInfo.stcc.mcc[0]), children: lunaInfo.stcc.mcc[0] }),
                  " ",
                  /* @__PURE__ */ jsx("span", { className: getChiColor(lunaInfo.stcc.mcc[1]), children: lunaInfo.stcc.mcc[1] })
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold tracking-wider text-stone-300 uppercase", children: "Ngày" }),
                /* @__PURE__ */ jsxs("span", { className: "font-serif text-lg font-bold", children: [
                  /* @__PURE__ */ jsx("span", { className: getCanColor(lunaInfo.dcc[0]), children: lunaInfo.dcc[0] }),
                  " ",
                  /* @__PURE__ */ jsx("span", { className: getChiColor(lunaInfo.dcc[1]), children: lunaInfo.dcc[1] })
          ...
          /* @__PURE__ */ jsx("div", { className: "flex justify-center bg-stone-50 py-10", children: /* @__PURE__ */ jsx(
            ZodiacHourClock,
            {
              hours,
              vocPeriods: filters.filterAstrology && dayInfo?.vp ? dayInfo.vp : void 0
            }
          ) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col gap-5 bg-[#fdfbf7] p-8 max-md:p-4 md:w-7/12", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center gap-3", children: [
              /* @__PURE__ */ jsx(
                "h2",
                {
                  className: `font-serif text-4xl font-bold ${score >= 50 ? score >= 80 ? "text-emerald-700" : "text-green-700" : score >= 30 ? "text-[#b91c1c]" : "text-red-800"}`,
                  children: score >= 80 ? "Vượng Khí" : score >= 65 ? "Sinh Khí" : score >= 50 ? "Bình Hòa" : score >= 35 ? "Suy Khí" : "Hư Hao"
                }
              ),
              /* @__PURE__ */ jsxs("span", { className: "rounded bg-stone-100 px-2 py-1 text-xs font-bold tracking-wider text-stone-500 uppercase", children: [
                score,
                " điểm"
              ] })
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "font-serif text-lg text-stone-600 italic", children: [
              '"',
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-8", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "mb-1 font-serif text-xs font-bold tracking-widest text-stone-400 uppercase", children: "TRỰC" }),
              /* @__PURE__ */ jsx("div", { className: "mb-1 font-serif text-2xl font-bold text-[#1c1917]", children: evaluation.truc }),
              /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed text-stone-600", children: evaluation.trucMeaning })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "mb-1 font-serif text-xs font-bold tracking-widest text-stone-400 uppercase", children: "NHỊ THẬP BÁT TÚ" }),
              /* @__PURE__ */ jsx("div", { className: "mb-1 font-serif text-2xl font-bold text-[#1c1917]", children: DATA.NHI_THAP_BAT_TU[evaluation.sao] }),
              /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed text-stone-600", children: evaluation.saoMeaning })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-8 pt-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "mb-1 border-b border-green-100 pb-1 font-serif text-lg font-bold text-[#166534]", children: "Cát Tinh (Sao Tốt)" }),
              evaluation.thanSat.cat.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-3", children: evaluation.thanSat.cat.map((s) => /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "block font-serif text-base font-bold text-gray-800", children: s }),
                /* @__PURE__ */ jsx("div", { className: "mt-0.5 text-sm leading-tight text-stone-500 italic", children: THAN_SAT_MEANING[s] })
              ] }, s)) }) : /* @__PURE__ */ jsx("div", { className: "text-sm text-stone-400 italic", children: "Không có sao tốt nổi bật" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "mb-1 border-b border-red-100 pb-1 font-serif text-lg font-bold text-[#991b1b]", children: "Hung Tinh (Sao Xấu)" }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            userDob && affinity && /* @__PURE__ */ jsxs("div", { className: "mb-8 font-serif", children: [
              /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "text-sm font-bold tracking-widest text-stone-400 uppercase", children: [
                  "Dự báo tuổi ",
                ...
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    className: `font-serif text-lg font-bold ${score >= (baseScore || score) ? "text-emerald-700" : "text-red-700"}`,
                    children: [
                      Math.round(score),
                      "%"
                    ]
              ...
              /* @__PURE__ */ jsx("div", { className: "mb-5 h-1.5 w-full overflow-hidden rounded-full bg-stone-100", children: /* @__PURE__ */ jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsx(
                "h3",
                {
                  className: `mb-4 font-serif text-3xl font-bold ${affinity.score >= 0 ? "text-emerald-800" : "text-red-800"}`,
                  children: affinity.status
                }
              ),
              /* @__PURE__ */ jsxs("div", { className: "mb-6 rounded-xl border border-stone-100 bg-stone-50/80 p-5", children: [
                /* @__PURE__ */ jsx("h4", { className: "mb-2 font-sans text-xs font-bold tracking-widest text-stone-400 uppercase", children: "Lời bàn" }),
                /* @__PURE__ */ jsxs("div", { className: "space-y-3 font-serif leading-relaxed text-stone-700", children: [
                  affinity.warning && /* @__PURE__ */ jsxs("p", { className: "text-[15px] text-red-800 italic", children: [
                    /* @__PURE__ */ jsx("span", { className: "mr-1.5 font-bold text-red-700 not-italic", children: "Lưu ý:" }),
                    affinity.warning
                  ] }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "space-y-4 border-stone-200 pl-4", children: [
                affinity.tags && affinity.tags.filter((t) => t.type === "good").length > 0 && /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "mb-1 block font-bold text-emerald-700", children: "Những điểm thuận lợi:" }),
                  /* @__PURE__ */ jsx("ul", { className: "space-y-1 text-stone-700", children: affinity.tags.filter((t) => t.type === "good").map((tag, idx) => /* @__PURE__ */ jsxs("li", { children: [
                    /* @__PURE__ */ jsx("span", { className: "font-medium", children: tag.label }),
                    tag.description && /* @__PURE__ */ jsxs("span", { className: "font-sans text-sm text-stone-500", children: [
                      " — ",
                      tag.description
                    ] })
                  ] }, idx)) })
                ...
                affinity.tags && affinity.tags.filter((t) => t.type === "bad").length > 0 && /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "mb-1 block font-bold text-red-700", children: "Những điều cần lưu tâm:" }),
                  /* @__PURE__ */ jsx("ul", { className: "space-y-1 text-stone-700", children: affinity.tags.filter((t) => t.type === "bad").map((tag, idx) => /* @__PURE__ */ jsxs("li", { children: [
                    /* @__PURE__ */ jsx("span", { className: "font-medium", children: tag.label }),
                    tag.description && /* @__PURE__ */ jsxs("span", { className: "font-sans text-sm text-stone-500", children: [
                      " — ",
                      tag.description
              ...
              dungThan && /* @__PURE__ */ jsx(
                BaziDisplay,
                {
                  dungThan,
                  userDob,
                  userBirthLocation,
                  onEdit: () => setShowUserPanel(true)
                }
              )
            ] }),
            !userDob && /* @__PURE__ */ jsx("div", { className: "py-8 text-center", children: /* @__PURE__ */ jsxs(
              "button",
              {
                onClick: () => setShowUserPanel(true),
                className: "mx-auto mb-4 flex cursor-pointer items-center justify-center gap-2 rounded-full bg-amber-100 px-4 py-2 font-sans !font-semibold font-bold text-stone-500 transition-colors select-none hover:bg-amber-200 hover:text-amber-600",
                children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "", children: filters.showAgeConflicts && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(AgeClashSection, { clashingAges }),
            /* @__PURE__ */ jsx(AgeHarmonySection, { compatibleAges })
          ] }) })
        ] })
      ] }) }) }),
      filters.showAdvice && /* @__PURE__ */ jsx(ActionRecommendations, { recommendations }),
      filters.showHours && /* @__PURE__ */ jsx(
        DailyHoursGrid,
        {
          hours,
          ...
          sao: evaluation.sao,
          astroWarnings: dayInfo,
          showAstroWarnings: filters.filterAstrology,
          showWesternWarnings: filters.filterWesternBadDays
        }
      )
    ] }),
