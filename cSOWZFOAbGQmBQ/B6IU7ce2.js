...
import { C as CHI } from './CpcYxhgG.js';
import { b as createAstro, c as createComponent, m as maybeRenderHead, e as addAttribute, a as renderTemplate } from './F_Fel0yb.js';
import 'piccolore';
import 'clsx';
...
function BaseGame({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `p-4 max-md:p-2 ${className}`, children: [
    gameState.showTimeoutPopup && gameState.gameMode === GameMode.CHALLENGE && /* @__PURE__ */ jsx("div", { className: "bg-opacity-50 animate-fadeIn fixed inset-0 z-50 flex items-center justify-center bg-black", children: /* @__PURE__ */ jsx("div", { className: "animate-scaleIn relative mx-4 w-full max-w-md transform rounded-xl bg-white p-8 transition-all duration-300 ease-out", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-6 animate-pulse text-3xl font-bold text-red-500", children: "Thất bại!" }),
      /* @__PURE__ */ jsx("div", { className: "mb-8 text-xl leading-relaxed text-gray-800", children: "Hết thời gian. Bạn cần luyện tập thêm bên phần HỌC TẬP!" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: handleTimeoutClose,
          className: "transform animate-bounce rounded-full bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-2 md:px-8 md:py-3 text-base md:text-lg font-bold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-orange-600 hover:to-orange-700 hover:shadow-xl",
    ...
    gameState.showModeSelection || !gameState.gameStarted && gameState.gameMode !== GameMode.LEARNING ? /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-8 flex flex-wrap justify-center gap-4", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `rounded-lg px-6 py-3 font-medium transition-all duration-200 ${gameState.gameMode === GameMode.LEARNING ? "bg-blue-500 text-white ring-2 ring-blue-500 ring-offset-2" : "bg-gray-100 text-gray-800 hover:bg-gray-200"}`,
              children: "Học Tập"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `rounded-lg px-6 py-3 font-medium transition-all duration-200 ${gameState.gameMode === GameMode.CHALLENGE ? "bg-orange-500 text-white ring-2 ring-orange-500 ring-offset-2" : "bg-gray-100 text-gray-800 hover:bg-gray-200"}`,
              children: "Thử Thách"
            }
          )
        ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap justify-center gap-2", children: questionPacks.map((pack) => /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: `rounded-lg px-4 py-2 transition-all duration-200 ${gameState.selectedPack === pack.id ? "bg-orange-500 text-white ring-2 ring-orange-500 ring-offset-2" : "bg-gray-100 text-gray-800 hover:bg-gray-200"}`,
              children: pack.name
            },
            pack.id
          )) })
        ] })
      ] }) : /* @__PURE__ */ jsx("div", { className: "mb-8", children: /* @__PURE__ */ jsxs("p", { className: "text-gray-600", children: [
      ...
      !gameState.showConfirmation || gameState.gameMode === GameMode.LEARNING ? /* @__PURE__ */ jsx(
        ...
        {
          onClick: startGame,
          className: "mb-6 transform rounded-full bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-2 md:px-8 md:py-3 text-base md:text-lg font-bold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:from-orange-600 hover:to-orange-700 hover:shadow-xl",
          children: gameState.gameMode === GameMode.LEARNING ? "Bắt đầu học" : "Bắt đầu thử thách"
        }
      ) : /* @__PURE__ */ jsxs("div", { className: "mx-auto mt-4 mb-6 max-w-md rounded-lg bg-white p-6 shadow-lg", children: [
        /* @__PURE__ */ jsxs("p", { className: "mb-4 text-lg", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-4", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: "transform rounded-full bg-gradient-to-r from-green-500 to-green-600 px-6 py-2 font-bold text-white shadow-md transition-all duration-200 hover:scale-105 hover:from-green-600 hover:to-green-700 hover:shadow-lg",
              children: "Sẵn sàng!"
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: "transform rounded-full bg-gray-100 px-6 py-2 font-bold text-gray-800 transition-all duration-200 hover:scale-105 hover:bg-gray-200",
              children: "Chỉnh lại"
            }
          )
        ] })
    ...
    gameState.isActive && gameState.gameMode === GameMode.CHALLENGE && /* @__PURE__ */ jsxs("div", { className: "mb-4 text-lg", children: [
      "Đúng: ",
    ...
    gameState.isFinished && gameState.gameMode === GameMode.CHALLENGE && /* @__PURE__ */ jsxs("div", { className: "mt-4 rounded bg-gray-100 p-4 text-center", children: [
      /* @__PURE__ */ jsx("h3", { className: "mb-2 text-xl font-bold", children: "Kết quả" }),
      /* @__PURE__ */ jsxs("p", { className: "", children: [
        "Đúng: ",
        /* @__PURE__ */ jsx("span", { className: "font-bold text-green-600", children: gameState.correctAnswers }),
        " câu"
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "", children: [
        "Sai: ",
        /* @__PURE__ */ jsx("span", { className: "font-bold text-red-600", children: gameState.wrongAnswers }),
        " câu"
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "", children: [
        "Tổng thời gian hoàn thành:",
        " ",
        /* @__PURE__ */ jsx("span", { className: "font-bold text-blue-600", children: formatTime(gameState.elapsedTime) })
      ] })
    ] })
  ] });
}
...
function BaseHistoryChart({
  ...
  chartContainerClass = "rounded-lg border border-gray-200 bg-white p-6 shadow-sm",
  ...
  return /* @__PURE__ */ jsxs("div", { ref: fullComponentRef, className: "w-full", children: [
    /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-4 flex flex-col items-center justify-between gap-4 sm:flex-row", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-center text-xl font-bold", children: title }),
      ...
      achievementLayout === "grid" ? /* @__PURE__ */ jsx("div", { className: "mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3", children: achievements.map((achievement, index) => /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: achievement.label }),
              /* @__PURE__ */ jsx("div", { className: "text-lg font-semibold", children: achievement.value })
            ] })
          ] })
        },
        index
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "ml-1 font-semibold", children: achievement.value })
          ]
        },
        index
      )) })
    ...
    /* @__PURE__ */ jsxs("div", { className: chartContainerClass, children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-4 flex flex-col items-center justify-between gap-4 sm:flex-row", children: [
        /* @__PURE__ */ jsx("h4", { className: "text-lg font-semibold", children: "Biểu đồ chi tiết từng câu" }),
...
const CUNG_POSITIONS = [
  { name: "Tý", position: "bottom-0 left-[50%]" },
  { name: "Sửu", position: "bottom-0 left-[25%]" },
  { name: "Dần", position: "bottom-0 left-0" },
  { name: "Mão", position: "top-[50%] left-0" },
  { name: "Thìn", position: "top-[25%] left-0" },
  { name: "Tị", position: "top-0 left-0" },
  { name: "Ngọ", position: "top-0 left-[25%]" },
  { name: "Mùi", position: "top-0 left-[50%]" },
  { name: "Thân", position: "top-0 right-0" },
  { name: "Dậu", position: "top-[25%] right-0" },
  { name: "Tuất", position: "top-[50%] right-0" },
  { name: "Hợi", position: "bottom-0 right-0" }
];
...
const createCungColors = (bgTheme) => ({
  Tị: { bg: bgTheme, text: "text-red-500" },
  Ngọ: { bg: bgTheme, text: "text-red-600" },
  Mùi: { bg: bgTheme, text: "text-yellow-500" },
  Thân: { bg: bgTheme, text: "text-gray-600" },
  Thìn: { bg: bgTheme, text: "text-yellow-500" },
  Dậu: { bg: bgTheme, text: "text-gray-600" },
  Mão: { bg: bgTheme, text: "text-green-600" },
  Tuất: { bg: bgTheme, text: "text-yellow-600" },
  Dần: { bg: bgTheme, text: "text-green-500" },
  Sửu: { bg: bgTheme, text: "text-yellow-600" },
  Tý: { bg: bgTheme, text: "text-blue-600" },
  Hợi: { bg: bgTheme, text: "text-blue-500" }
});
const THEME_VARIANTS = {
  SLATE: "bg-slate-100",
  ORANGE: "bg-orange-50"
};
const CHART_CONTAINER_CLASSES = "relative mx-auto mb-6 aspect-[4/5] md:aspect-square w-full max-w-[700px] border-2 border-slate-700 bg-white shadow-xl";
const QUESTION_PANEL_CLASSES = "w-full max-w-[250px] rounded-xl border border-blue-200 bg-gradient-to-br from-white to-blue-50 p-1 md:p-2 font-medium shadow-xl backdrop-blur-sm overflow-hidden";
const createGetCungClassName = (colors) => (cung, isActive, currentCung, hasContent = false) => {
  const baseClasses = `absolute w-[25%] h-[25%] ${colors[cung].bg} p-1 md:p-3 border border-slate-400 transition-all duration-300`;
  const activeClasses = isActive && cung === currentCung ? "ring-2 ring-orange-500 bg-orange-50 z-50" : "z-10";
  const contentClasses = hasContent ? "bg-yellow-100" : "";
  return `${baseClasses} ${activeClasses} ${contentClasses}`;
};
const createGetCungClassNameClickable = (colors) => (cung, hasStars) => {
  const baseClasses = `absolute w-[25%] h-[25%] border border-slate-400 ${colors[cung].bg} p-1 md:p-3 transition-all duration-300 cursor-pointer hover:bg-yellow-50 active:bg-yellow-100`;
  const activeClasses = hasStars ? "z-40 bg-yellow-100" : "z-10";
