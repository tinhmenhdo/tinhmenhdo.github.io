...
</span> <div class="flex mt-4 space-x-5 sm:justify-center md:mt-0 rtl:space-x-reverse"> ${n?.length?renderTemplate`<ul class="flex mb-4 -ml-2 md:order-1 md:ml-4 md:mb-0 rtl:ml-0 rtl:-mr-2 rtl:md:ml-0 rtl:md:mr-4"> ${n.map((({ariaLabel:t,href:i,title:a,icon:n})=>renderTemplate`<li> <a class="text-muted dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 inline-flex items-center"${addAttribute(t,"aria-label")}${addAttribute(i,"href")} target="_blank"${addAttribute(a,"title")}> ${renderComponent(e,"LucideIconCp",LucideIconCp,{name:n,className:"w-5 h-5","client:load":!0,"client:component-hydration":"load","client:component-path":"~/components/LucideIconCp","client:component-export":"default"})} ${renderComponent(e,"Fragment",Fragment$1,{},{default:e=>renderTemplate`${unescapeHTML(a)}`})} </a> </li>`))} </ul>`:""} </div> </div> </div> </div> </footer> <!-- <footer
...
</footer> -->`}),"/root/code/tmd_astro/src/components/widgets/Footer.astro",void 0),$$Astro=createAstro("https://tinhmenhdo.com"),$$PageLayout=createComponent(((e,t,i)=>{const a=e.createAstro($$Astro,t,i);a.self=$$PageLayout;const{metadata:n={}}=a.props;return renderTemplate`${renderComponent(e,"Layout",$$Layout,{metadata:n},{default:e=>renderTemplate` ${maybeRenderHead()}<main class="flex min-h-screen justify-center flex-wrap"> ${renderComponent(e,"Sidebar",$$Sidebar,{})} <div id="main-content" class="w-full"> <!-- <slot name="announcement" /> --> <!-- <slot name="header">
          <div class="hidden"><Header {...headerData} isSticky={false} showRssFeed showToggleTheme /></div>
        </slot> --> ${renderSlot(e,i.default)} ${renderSlot(e,i.footer,renderTemplate` ${renderComponent(e,"Footer",$$Footer,{links:footerData.links,secondaryLinks:footerData.secondaryLinks,socialLinks:footerData.socialLinks,footNote:footerData.footNote})} `)} </div> </main> `})}`}),"/root/code/tmd_astro/src/layouts/PageLayout.astro",void 0);export{$$PageLayout as $};