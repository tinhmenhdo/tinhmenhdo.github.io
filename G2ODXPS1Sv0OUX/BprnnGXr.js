import{c as createAstro,a as createComponent,m as maybeRenderHead,r as renderComponent,b as renderTemplate,g as addAttribute,F as Fragment$1,u as unescapeHTML,d as renderSlot,f as renderScript}from"./PnL3lD9h.js";import"kleur/colors";import*as LucideIcons from"lucide-react";import{Menu,X}from"lucide-react";import{jsx,Fragment}from"react/jsx-runtime";import{S as SITE,d as getHomePermalink,e as getAsset,a as getPermalink}from"./DKIPqkLp.js";import{$ as $$Layout}from"./S34onycn.js";import{clsx}from"clsx";import{twMerge}from"tailwind-merge";const logo=new Proxy({src:"/G2ODXPS1Sv0OUX/tinh-menh-do.BlFNv_SQ.png",width:512,height:512,format:"png"},{get:(e,t,i)=>"clone"===t?structuredClone(e):"fsPath"===t?"/root/code/tmd_astro/src/assets/favicons/android-chrome-512x512.png":(void 0!==e[t]&&globalThis.astroAsset&&globalThis.astroAsset?.referencedImages.add("/root/code/tmd_astro/src/assets/favicons/android-chrome-512x512.png"),e[t])});function LucideIconCp({name:e,...t}){if(void 0===LucideIcons[e])return jsx(Fragment,{});const i=LucideIcons[e]||LucideIcons.Home;return jsx(i,{...t})}const $$Astro$2=createAstro("https://tinhmenhdo.com"),$$Sidebar=createComponent(((e,t,i)=>(e.createAstro($$Astro$2,t,i).self=$$Sidebar,renderTemplate`${maybeRenderHead()}<header class="relative h-12 bg-[var(--sidebar-bg)] z-40 flex items-center px-4 w-full"> <div class="bgInset h-full absolute top-0 left-0 w-full z-[-1]"> <div class="bgInsetInner !h-full w-full"></div> </div> <button id="mobile-menu-toggle" class="text-[hsl(var(--sidebar-fg))]"> ${renderComponent(e,"Menu",Menu,{className:"w-6 h-6"})} </button> <div class="flex justify-center flex-1"> <!-- <a href='/' title='Tinh Mệnh Đồ - Công cụ lấy lá số nhanh, chuẩn, hàng đầu!'>
