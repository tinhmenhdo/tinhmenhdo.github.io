...
import { A as AstroError, D as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, G as renderUniqueStylesheet, H as renderScriptElement, J as createHeadAndContent, r as renderComponent } from './Cf7UXZdW.js';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./DUEiBcjt.js');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "BUILD_VERSION": "1768641256320", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tinhmenhdo.github.io", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./BhynNW6S.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./iMqAAYtf.js');
