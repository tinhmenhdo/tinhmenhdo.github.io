import { d as createAstro, c as createComponent, b as addAttribute, h as renderScript, a as renderTemplate, f as defineScriptVars, s as spreadAttributes, r as renderComponent, m as maybeRenderHead, e as Fragment, u as unescapeHTML, n as defineStyleVars, p as renderHead, g as renderSlot } from './Cf7UXZdW.js';
/* empty css         */
import 'piccolore';
import 'clsx';
import { A as ANALYTICS, U as UI, b as getAsset, g as getCanonical, I as I18N, S as SITE, M as METADATA } from './Cccj9IsO.js';
import { escape } from 'html-escaper';
import merge from 'lodash.merge';
import { g as getImage } from './BhynNW6S.js';
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")}${addAttribute(initialLayout, "data-layout")}${addAttribute($$definedVars, "style")}> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}${renderComponent($$result, "ClientRouter", $$ClientRouter, { "fallback": "animate" })}${renderTemplate`${renderScript($$result, "/root/code/tmd_astro/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")}`}${renderHead()}</head> <body class="min-h-screen bg-background font-sans antialiased overflow-x-hidden"${addAttribute($$definedVars, "style")}> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})} ${renderComponent($$result, "VersionChecker", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "~/components/common/VersionChecker", "client:component-export": "default" })}  </body> </html>`;
